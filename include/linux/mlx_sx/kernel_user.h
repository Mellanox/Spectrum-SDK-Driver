...
#include "auto_registers/kernel_cmd_access_auto.h"
    ...
    CTRL_CMD_ACCESS_REG_MAX = CTRL_CMD_ACCESS_REG_IBSNI  /**< Maximum enum value */
};
...
struct ku_mpat_reg {
    ...
    uint8_t                              pc; /**< Mirror header V1/V2 padding count */
};
...
typedef enum sxd_pprr_range_type {
    SXD_PPRR_RANGE_TYPE_L4_PORT_E         = 0,
    SXD_PPRR_RANGE_TYPE_IP_LENGTH_E       = 1,
    SXD_PPRR_RANGE_TYPE_TTL_E             = 2,
    SXD_PPRR_RANGE_TYPE_CUSTOM_BYTE_SET_E = 3,
    SXD_PPRR_RANGE_TYPE_UTC_29_14_E       = 5,
} sxd_pprr_range_type_t;
...
enum sxd_health_fatal_failure_detect_cmd_e {
    ...
    SXD_HEALTH_FATAL_FAILURE_ADD_SDK_THREAD_FAILURE_E
};
...
enum sxd_thread_severity_e {
    SXD_THREAD_SEVERITY_FATAL_E   = SXD_HEALTH_SEVERITY_FATAL,
    SXD_THREAD_SEVERITY_ERR_E     = SXD_HEALTH_SEVERITY_ERR,
    SXD_THREAD_SEVERITY_WARNING_E = SXD_HEALTH_SEVERITY_WARN,
    SXD_THREAD_SEVERITY_MAX_E
};
...
typedef struct sdk_threads_info {
    ...
    enum sxd_thread_severity_e severity;
...
struct ku_map_memory {
    uint8_t               dev_id; /**< dev_id - device id */
    uint8_t               mem_size; /**< Size of memory to map: total = (mem_size * 4K) */
...
typedef enum ku_accuflow_counters_params_op {
    ...
    KU_ACCUFLOW_COUNTERS_PARAMS_OP_FREE_E,
    KU_ACCUFLOW_COUNTERS_PARAMS_OP_MIN_E = KU_ACCUFLOW_COUNTERS_PARAMS_OP_INIT_E,
    KU_ACCUFLOW_COUNTERS_PARAMS_OP_MAX_E = KU_ACCUFLOW_COUNTERS_PARAMS_OP_FREE_E,
...
typedef struct ku_accuflow_counters_params_data_free {
    uint32_t prm_counter_idx;
    uint32_t num_of_counters;
    uint64_t tid;
} ku_accuflow_counters_params_data_free_t;
...
typedef union ku_accuflow_counters_params_data {
    ...
    ku_accuflow_counters_params_data_free_t           free_data;
