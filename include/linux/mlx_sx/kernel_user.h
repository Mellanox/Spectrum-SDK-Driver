...
typedef enum thread_monitoring_status {
    THREAD_MONITOR_ACTIVE_E     = 0x0,
    THREAD_MONITOR_DISCONNECT_E = 0x1,
    THREAD_MONITOR_RECONNECT_E  = 0x2,
} thread_monitoring_status_e;
...
#define SDK_THREAD_MONITOR_BITMAP_SIZE 64
...
#define SXD_ACL_KEY_BLOCK_FLEX2_MAC_5C            0x1D
#define SXD_ACL_KEY_BLOCK_FLEX2_MAC_6             0x16
#define SXD_ACL_KEY_BLOCK_FLEX2_MAC_6B            0x1B
#define SXD_ACL_KEY_BLOCK_FLEX2_MAC_6C            0x1E
...
#define SXD_ACL_KEY_BLOCK_FLEX2_MAC_8C            0x1F
#define SXD_ACL_KEY_BLOCK_FLEX2_MAC_9             0x19
#define SXD_ACL_KEY_BLOCK_FLEX2_MAC_9B            0x25
...
#define SXD_ACL_KEY_BLOCK_FLEX2_IPV4_1C           0x49
#define SXD_ACL_KEY_BLOCK_FLEX2_IPV4_1C_SYMM      0x49
...
#define SXD_ACL_KEY_BLOCK_FLEX2_IPV4_4C           0x4A
#define SXD_ACL_KEY_BLOCK_FLEX2_IPV4_5            0x3D
#define SXD_ACL_KEY_BLOCK_FLEX2_IPV4_5B           0x36
#define SXD_ACL_KEY_BLOCK_FLEX2_IPV4_5C           0x48
#define SXD_ACL_KEY_BLOCK_FLEX2_IPV4_6B           0x37
#define SXD_ACL_KEY_BLOCK_FLEX2_IPV4_6C           0x4B
...
#define SXD_ACL_KEY_BLOCK_FLEX2_IPV6_2C           0x4C
...
#define SXD_ACL_KEY_BLOCK_FLEX2_IPV6_2C_SYMM      0x4C
...
#define SXD_ACL_KEY_BLOCK_FLEX2_MISC_0B       0xBB
...
#define SXD_ACL_KEY_BLOCK_FLEX2_MISC_2C       0xBC
...
#define SXD_ACL_KEY_BLOCK_FLEX2_PORT_LIST_11B 0xEE
...
#define SXD_ACL_KEY_BLOCK_FLEX2_PORT_LIST_15B 0xEF
#define SXD_ACL_KEY_BLOCK_FLEX2_PORT_LIST_16  0xF0
#define SXD_ACL_KEY_BLOCK_FLEX2_PORT_LIST_17  0xF1
#define SXD_ACL_KEY_BLOCK_FLEX2_PORT_LIST_18  0xF2
#define SXD_ACL_KEY_BLOCK_FLEX2_PORT_LIST_19  0xF3
#define SXD_ACL_KEY_BLOCK_FLEX2_PORT_LIST_20  0xF4
#define SXD_ACL_KEY_BLOCK_FLEX2_PORT_LIST_21  0xF5
#define SXD_ACL_KEY_BLOCK_FLEX2_PORT_LIST_22  0xF6
#define SXD_ACL_KEY_BLOCK_FLEX2_PORT_LIST_23  0xF7
#define SXD_ACL_KEY_BLOCK_FLEX2_PORT_LIST_24  0xF8
#define SXD_ACL_KEY_BLOCK_FLEX2_PORT_LIST_25  0xF9
#define SXD_ACL_KEY_BLOCK_FLEX2_PORT_LIST_26  0xFA
#define SXD_ACL_KEY_BLOCK_FLEX2_PORT_LIST_27  0xFB
#define SXD_ACL_KEY_BLOCK_FLEX2_PORT_LIST_28  0xFC
#define SXD_ACL_KEY_BLOCK_FLEX2_PORT_LIST_29  0xFD
#define SXD_ACL_KEY_BLOCK_FLEX2_PORT_LIST_30  0xFE
#define SXD_ACL_KEY_BLOCK_FLEX2_PORT_LIST_31  0xFF
...
#define MAX_PHYPORT_NUM            516
#define MAX_LAG_NUM                512
...
#define SXD_COS_ELEPHANT_PORT_MASK_NUM       (16)    /* SXD_MOCS_PORT_MASK_NUM */
...
/**
 * Converts bytes length (num of bytes) to dword length (num of dwords)
 */

#define BYTE_TO_DWORD_LEN(byte_len) (((byte_len + 3) / 4) + 1)
...
enum ku_ctrl_cmd {
    ...
    CTRL_CMD_SET_PCI_PROFILE, /**< Set the PCI profile - cmd_body should be of struct sx_pci_profile */
    ...
    CTRL_CMD_RESET, /**< System reset - cmd_body should be long (dev_id) */
    CTRL_CMD_PCI_DEVICE_RESTART, /**< PCI device restart */
    CTRL_CMD_RAISE_EVENT, /**< Raise an event */
    CTRL_CMD_ENABLE_SWID, /**< Enable a swid - cmd_body should be of struct ku_swid_details */
    CTRL_CMD_DISABLE_SWID, /**< Disable a swid - cmd_body should be of struct ku_swid_details */
    ...
    CTRL_CMD_GET_SYNDROME_STATUS, /**< Get syndrome status */
    ...
    CTRL_CMD_ADD_DEV_PATH, /**< Add a device path to the DPT - cmd_body should be of struct ku_dpt_path_add */
    CTRL_CMD_REMOVE_DEV_PATH, /**< Remove a device path from the DPT - cmd_body should be of struct ku_dpt_path_add */
    CTRL_CMD_REMOVE_DEV, /**< Remove a device from the DPT - cmd_body should be of struct ku_dpt_path_add */
    CTRL_CMD_SET_CMD_PATH, /**< Set a device's command interface path in the DPT - cmd_body should be of struct ku_dpt_path_modify */
    CTRL_CMD_SET_EMAD_PATH, /**< Set a device's emad path in the DPT - cmd_body should be of struct ku_dpt_path_modify */
    CTRL_CMD_SET_MAD_PATH, /**< Set a device's mad path in the DPT - cmd_body should be of struct ku_dpt_path_modify */
    CTRL_CMD_SET_CR_ACCESS_PATH, /**< Set a device's CR access path in the DPT - cmd_body should be of struct ku_dpt_path_modify */
    CTRL_CMD_GET_PCI_PROFILE, /**< Get the PCI profile - cmd_body should be of struct ku_get_pci_profile*/
    ...
    CTRL_CMD_SET_SW_IB_NODE_DESC, /**< set SW IB node description - cmd_body should be of struct ku_ib_node_description */
    ...
    CTRL_CMD_BULK_CNTR_BUFFER_STATS_SET, /**< Account bulk counter shared memory allocation and free.*/
    CTRL_CMD_BULK_CNTR_BUFFER_INFO_GET, /**< Retrieve bulk counter shared memory usage.*/
    CTRL_CMD_BULK_CNTR_BUFFER_INFO_SET, /**< Set bulk counter maximum memory usage. */
    ...
    CTRL_CMD_SET_MMAP_MEM_ALLOC_SCHEME, /**< Dictate memory allocation scheme (vmalloc or kmalloc) for memory mapping. */
    CTRL_CMD_SET_SYSFS_SNIFFER,
    CTRL_CMD_SET_OWNER, /* calling process that opened an fd via SDK is now announcing ownership of it */
    CTRL_CMD_MIN_VAL = CTRL_CMD_GET_CAPABILITIES, /**< Minimum enum value */
    CTRL_CMD_MAX_VAL = CTRL_CMD_SET_OWNER, /**< Maximum enum value */
...
enum {
    ...
    IFLA_SX_NETDEV_SWID,
    IFLA_SX_NETDEV_PORT,
    IFLA_SX_NETDEV_PIPELINE,
    __IFLA_SX_NETDEV_MAX
};
#define IFLA_SX_NETDEV_MAX (__IFLA_SX_NETDEV_MAX - 1)

enum {
    SX_NETDEV_PIPELINE_ADAPTIVE,
    SX_NETDEV_PIPELINE_BYPASS,
    SX_NETDEV_PIPELINE_MAX
};
...
typedef enum sxd_chip_types {
    ...
    SXD_CHIP_TYPE_SPECTRUM5   = 15,
    SXD_CHIP_TYPE_QUANTUM4    = 16,
    SXD_CHIP_TYPES_MAX        = SXD_CHIP_TYPE_QUANTUM4,
...
enum ku_ext_fwd_mode {
    SX_EXT_FWD_MODE_REGULAR_AND_MIRROR_AGENT = 1,   /**< output twice: (1) regular, (2) as mirror_agent */
    SX_EXT_FWD_MODE_MIRROR_AGENT             = 2    /**< output only as mirror_agent */
};
...
struct span_oob_data {
    uint8_t ext_fwd_mode;           /**< Extended Forwarding Mode according enum ku_ext_fwd_mode , enables the host_based_mirror */
    uint8_t mirror_reason_id;       /**< host_based_mirror_reason_id valid values  1-3*/
    uint8_t span_session_id;        /**< span session id when ext_fwd_mode is regular or mirror_agent */
};
...
struct ku_read_multi_params {
    uint32_t        buffer_count;                               /**< INOUT: number of provided buffers, if 0 - count of ready buffers requested*/
    enum SX_FILE_OP file_op;
    uint8_t       * buffer_list[READ_MULTI_BUFFS_MAX];          /**< IN: list of buffers for a packets */
    uint32_t        buffer_size_list[READ_MULTI_BUFFS_MAX];     /**< INOUT: size of buffers for a packets */
};
...
enum {
    ...
    SX_CR_DUMP_OP_START_REDUCED_FLAT = 5,
    SX_CR_DUMP_OP_CANCEL             = 15,

    /* Non PRM values */
    SX_CR_DUMP_OP_START_WAIT         = 100,
    SX_CR_DUMP_OP_CONT_WAIT          = 101,
    SX_CR_DUMP_OP_GET_GDB_DUMP_LIMIT = 102,
...
typedef enum sxd_module_master_mode {
    SXD_MODULE_MASTER_MODE_FW_CONTROL_E                     = 0,
    SXD_MODULE_MASTER_MODE_SW_CONTROL_E                     = 1,
    SXD_MODULE_MASTER_MODE_SW_CONTROL_NO_I2C_CONNECTIVITY_E = 2,
    SXD_MODULE_MASTER_MODE_MIN_E                            = SXD_MODULE_MASTER_MODE_FW_CONTROL_E,
    SXD_MODULE_MASTER_MODE_MAX_E                            = SXD_MODULE_MASTER_MODE_SW_CONTROL_NO_I2C_CONNECTIVITY_E,
} sxd_module_master_mode_e;
...
struct ku_query_fw {
    ...
    sxd_module_master_mode_e             fw_cap_mod_support; /* fw module support capability (dependent, independent or standalone) */
    uint8_t                              dev_id; /**< dev_id - device id */
    ...
    uint32_t                             cap_dump_host_size_reduced_flat;
...
struct ku_access_qpcr_reg {
    ...
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_qpcr_reg __attribute__((aligned(8))) qpcr_reg; /**< qpcr_reg - qpcr register tlv */
};
...
struct ku_access_qhll_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_qhll_reg __attribute__((aligned(8))) qhll_reg; /**< qhll_reg - QHLL register tlv */
};
/**
...
#define SXD_ACL_EXTRACTION_POINT_START_OF_PACKET        0x0
#define SXD_ACL_EXTRACTION_POINT_MAC_HEADER             0x1
...
#define SXD_ACL_EXTRACTION_POINT_PTP                    0x15
#define SXD_ACL_EXTRACTION_POINT_GRE_HEADER             0x19
#define SXD_ACL_EXTRACTION_POINT_GRE_PAYLOLAD           0x1A
#define SXD_ACL_EXTRACTION_POINT_FCOE_VFT               0x1B
#define SXD_ACL_EXTRACTION_POINT_FCOE_IFR               0x1C
#define SXD_ACL_EXTRACTION_POINT_FCOE_ENC               0x1D
#define SXD_ACL_EXTRACTION_POINT_FCOE_CONFIGURABLE      0x1E
#define SXD_ACL_EXTRACTION_POINT_FCOE_FRAME_HEADER      0x1F
#define SXD_ACL_EXTRACTION_POINT_FCOE_PAYLOAD           0x20
...
#define SXD_ACL_EXTRACTION_POINT_INNER_MPLS_HEADER      0x30
...
#define SXD_ACL_EXTRACTION_POINT_IPV6_HBH               0x60
#define SXD_ACL_EXTRACTION_POINT_IPV6_DESTINATION       0x61
#define SXD_ACL_EXTRACTION_POINT_IPV6_ROUTING           0x62
#define SXD_ACL_EXTRACTION_POINT_IPV6_FRAGMENT          0x63
#define SXD_ACL_EXTRACTION_POINT_IPV6_MOBILITY          0x66
#define SXD_ACL_EXTRACTION_POINT_INNER_IPV6_HBH         0x68
#define SXD_ACL_EXTRACTION_POINT_INNER_IPV6_DESTINATION 0x69
#define SXD_ACL_EXTRACTION_POINT_INNER_IPV6_ROUTING     0x6A
#define SXD_ACL_EXTRACTION_POINT_INNER_IPV6_FRAGMENT    0x6B
#define SXD_ACL_EXTRACTION_POINT_INNER_IPV6_MOBILITY    0x6E
...
/**
 * The ARN encapsulation header type
 */
typedef enum sxd_arn_encap_header_type {
    SXD_ARN_ENCAP_HEADER_TYPE_IPV4_E = 0,
    SXD_ARN_ENCAP_HEADER_TYPE_IPV6_E = 1,
} sxd_arn_encap_header_type_e;

/**
 * ARN Encapsulation Adjacency Parameters Layout
 */
typedef struct ku_arn_encap_adj_parameters {
    sxd_arn_encap_header_type_e dip_type;
    uint8_t                     tqos_profile;
    uint16_t                    uirif;
    uint32_t                    ipv4_udip;
    uint32_t                    ipv6_ptr;
...
typedef union ku_adj_parameters {
    ...
    ku_arn_encap_adj_parameters_t        arn_encap_adj_parameters;
} ku_adj_parameters_t;
...
struct ku_access_rdpm_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_rdpm_reg __attribute__((aligned(8))) rdpm_reg; /**< rdpm_reg - rdpm register tlv */
};
...
#define SXD_MGIR_HW_DEV_ID_QUANTUM4    0xd2f8
...
#define SXD_MGIR_HW_DEV_ID_SPECTRUM5   0xcf82
...
struct ku_mcia_reg {
    ...
    uint8_t  pnv; /**< pnv - Page Number Valid. 0: write page number. 1: don't write page number. Valid only if module is in SW control */
 ...
 * transport type
 */
#define SXD_FOREACH_OBJECT_TRANSPORT_TYPE(TRANSPORT_TYPE)      \
    TRANSPORT_TYPE(SXD_TRANSPORT_TYPE_MAD, = 0, "MAD")         \
    TRANSPORT_TYPE(SXD_TRANSPORT_TYPE_EMAD, = 1, "EMAD")       \
    TRANSPORT_TYPE(SXD_TRANSPORT_TYPE_CMD_IFC, = 2, "CMD-IFC") \
    TRANSPORT_TYPE(SXD_TRANSPORT_TYPE_CR_ACCESS, = 3, "CR")    \

typedef enum sxd_transport_type {
    SXD_FOREACH_OBJECT_TRANSPORT_TYPE(SXD_GENERATE_ENUM)
} sxd_transport_type_t;
...
struct ku_access_slrg_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_slrg_reg __attribute__((aligned(8))) slrg_reg; /**< slrg_reg - slrg register tlv */
};
...
struct ku_access_slrp_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_slrp_reg __attribute__((aligned(8))) slrp_reg; /**< slrp_reg - slrp register tlv */
};
...
struct ku_access_peucg_reg {
    struct ku_operation_tlv                         op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                         dev_id; /**< dev_id - device id */
    struct ku_peucg_reg __attribute__((aligned(8))) peucg_reg; /**< peucg_reg - peucg register tlv */
};
...
struct ku_access_ppll_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_ppll_reg __attribute__((aligned(8))) ppll_reg; /**< ppll_reg - ppll register tlv */
};
...
struct ku_access_slcr_v2_reg {
    struct ku_operation_tlv                           op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                           dev_id; /**< dev_id - device id */
    struct ku_slcr_v2_reg __attribute__((aligned(8))) slcr_v2_reg; /**< ku_slcr_v2_reg - slcr_v2 register tlv */
};
...
struct ku_access_sfn_reg {
    struct ku_operation_tlv                       op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                       dev_id; /**< dev_id - device id */
    struct ku_sfn_reg __attribute__((aligned(8))) sfn_reg; /**< ku_sfn_reg - sfn register tlv */
};
...
struct ku_access_spvtr_reg {
    struct ku_operation_tlv                         op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                         dev_id; /**< dev_id - device id */
    struct ku_spvtr_reg __attribute__((aligned(8))) spvtr_reg; /**< ku_spvtr_reg - spvtr register tlv */
};
...
struct ku_access_pspa_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_pspa_reg __attribute__((aligned(8))) pspa_reg; /**< pspa_reg - pspa register tlv */
};
...
struct ku_access_pmlp_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_pmlp_reg __attribute__((aligned(8))) pmlp_reg; /**< pmlp_reg - pmlp register tlv */
};
...
struct ku_access_plib_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_plib_reg __attribute__((aligned(8))) plib_reg; /**< plib_reg - plib register tlv */
};
...
struct ku_access_ppaos_reg {
    struct ku_operation_tlv                         op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                         dev_id; /**< dev_id - device id */
    struct ku_ppaos_reg __attribute__((aligned(8))) ppaos_reg; /**< ppaos_reg - ppaos register tlv */
};
...
struct ku_access_pplm_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_pplm_reg __attribute__((aligned(8))) pplm_reg; /**< pplm_reg - pplm register tlv */
};
...
struct ku_access_plpc_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_plpc_reg __attribute__((aligned(8))) plpc_reg; /**< plpc_reg - plpc register tlv */
};
...
struct ku_access_pmpc_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_pmpc_reg __attribute__((aligned(8))) pmpc_reg; /**< pmpc_reg - pmpc register tlv */
};
...
struct ku_access_pmpr_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_pmpr_reg __attribute__((aligned(8))) pmpr_reg; /**< pmpr_reg - pmpr register tlv */
};
...
struct ku_access_pcnr_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_pcnr_reg __attribute__((aligned(8))) pcnr_reg; /**< ku_pcnr_reg - pcnr register tlv */
};
...
struct ku_access_pfsc_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_pfsc_reg __attribute__((aligned(8))) pfsc_reg; /**< ku_pfsc_reg - pfsc register tlv */
};
...
struct ku_access_mfsc_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_mfsc_reg __attribute__((aligned(8))) mfsc_reg; /**< mfsc_reg - mfsc register tlv */
};
...
struct ku_access_mfsm_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_mfsm_reg __attribute__((aligned(8))) mfsm_reg; /**< mfsm_reg - mfsm register tlv */
};
...
struct ku_access_mfsl_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_mfsl_reg __attribute__((aligned(8))) mfsl_reg; /**< mfsl_reg - mfsl register tlv */
};
...
struct ku_access_mjtag_reg {
    struct ku_operation_tlv                         op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                         dev_id; /**< dev_id - device id */
    struct ku_mjtag_reg __attribute__((aligned(8))) mjtag_reg; /**< mjtag_reg - mjtag register tlv */
};
...
struct ku_access_ppsc_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_ppsc_reg __attribute__((aligned(8))) ppsc_reg;   /**< ppsc_reg- ppsc register tlv */
};
...
struct ku_access_pelc_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_pelc_reg __attribute__((aligned(8))) pelc_reg; /**< pelc_reg - pelc register tlv */
};
...
struct ku_access_pvlc_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_pvlc_reg __attribute__((aligned(8))) pvlc_reg; /**< pvlc_reg - pvlc register tlv */
};
...
struct ku_access_mcia_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_mcia_reg __attribute__((aligned(8))) mcia_reg; /**< mcia_reg - mcia register tlv */
};
...
struct ku_access_fore_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_fore_reg __attribute__((aligned(8))) fore_reg; /**< fore_reg - fore register tlv */
};
...
struct ku_access_mtbr_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_mtbr_reg __attribute__((aligned(8))) mtbr_reg; /**< mtbr_reg - mtbr register tlv */
};
...
struct ku_access_mmdio_reg {
    struct ku_operation_tlv                         op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                         dev_id; /**< dev_id - device id */
    struct ku_mmdio_reg __attribute__((aligned(8))) mmdio_reg; /**< mmdio_reg - mmdio register tlv */
};
...
struct ku_access_mmia_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_mmia_reg __attribute__((aligned(8))) mmia_reg; /**< mmia_reg - mmia register tlv */
};
...
struct ku_access_mfpa_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_mfpa_reg __attribute__((aligned(8))) mfpa_reg; /**< mfpa_reg - mfpa register tlv */
};
...
struct ku_access_mfbe_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_mfbe_reg __attribute__((aligned(8))) mfbe_reg; /**< mfbe_reg - mfbe register tlv */
};
...
struct ku_access_mfba_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_mfba_reg __attribute__((aligned(8))) mfba_reg; /**< mfba_reg - mfba register tlv */
};
...
struct ku_access_raw_reg {
    struct ku_operation_tlv                       op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                       dev_id; /**< dev_id - device id */
    struct ku_raw_reg __attribute__((aligned(8))) raw_reg; /**< raw_reg - raw_reg register tlv */
};
...
struct ku_access_hcap_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_hcap_reg __attribute__((aligned(8))) hcap_reg; /**< hcap_reg - hcap register tlv */
};
...
struct ku_access_hdrt_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_hdrt_reg __attribute__((aligned(8))) hdrt_reg; /**< hdrt_reg - hdrt register tlv */
};
...
struct ku_access_hctr_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_hctr_reg __attribute__((aligned(8))) hctr_reg; /**< hctr_reg - hctr register tlv */
};
...
struct ku_access_mfcr_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_mfcr_reg __attribute__((aligned(8))) mfcr_reg; /**< mfcr_reg - mfcr register tlv */
};
...
struct ku_access_mfm_reg {
    struct ku_operation_tlv                       op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                       dev_id; /**< dev_id - device id */
    struct ku_mfm_reg __attribute__((aligned(8))) mfm_reg; /**< mfm_reg - hpkt register tlv */
};
...
struct ku_access_sspr_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_sspr_reg __attribute__((aligned(8))) sspr_reg; /**< mfm_reg - hpkt register tlv */
};
...
struct ku_access_spmcr_reg {
    struct ku_operation_tlv                         op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                         dev_id; /**< dev_id - device id */
    struct ku_spmcr_reg __attribute__((aligned(8))) spmcr_reg; /**< mfm_reg - hpkt register tlv */
};
...
struct ku_access_sbmm_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_sbmm_reg __attribute__((aligned(8))) sbmm_reg; /**< mfm_reg - hpkt register tlv */
};
...
struct ku_access_smid_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_smid_reg __attribute__((aligned(8))) smid_reg; /**< smid_reg - smid register tlv */
};
...
struct ku_access_spms_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_spms_reg __attribute__((aligned(8))) spms_reg; /**< mfm_reg - hpkt register tlv */
};
...
struct ku_access_sver_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_sver_reg __attribute__((aligned(8))) sver_reg; /**< mfm_reg - hpkt register tlv */
};
...
struct ku_access_spvc_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_spvc_reg __attribute__((aligned(8))) spvc_reg; /**< mfm_reg - hpkt register tlv */
};
...
struct ku_access_qpbr_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_qpbr_reg __attribute__((aligned(8))) qpbr_reg; /**< mfm_reg - hpkt register tlv */
};
...
struct ku_access_qpem_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_qpem_reg __attribute__((aligned(8))) qpem_reg; /**< qpem_reg - qpem register tlv */
};
...
struct ku_access_plbf_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_plbf_reg __attribute__((aligned(8))) plbf_reg; /**< plbf_reg - plbf register tlv */
};
...
struct ku_access_msci_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_msci_reg __attribute__((aligned(8))) msci_reg; /**< msci_reg - msci register tlv */
};
...
struct ku_access_mrsr_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_mrsr_reg __attribute__((aligned(8))) mrsr_reg; /**< mrsr_reg - mrsr register tlv */
};
...
struct ku_access_mpsc_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_mpsc_reg __attribute__((aligned(8))) mpsc_reg; /**< mpsc_reg - mpsc register tlv */
};
...
struct ku_access_mlcr_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_mlcr_reg __attribute__((aligned(8))) mlcr_reg; /**< mlcr_reg - mlcr register tlv */
};
...
struct ku_access_ptce3_reg {
    struct ku_operation_tlv                         op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                         dev_id; /**< dev_id - device id */
    struct ku_ptce3_reg __attribute__((aligned(8))) ptce3_reg; /**< ptce3_reg - ptce3 register tlv */
};
...
struct ku_access_mrrr_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_mrrr_reg __attribute__((aligned(8))) mrrr_reg;       /**< ku_mrrr_reg - mrrr register tlv */
};
...
struct ku_access_mdri_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_mdri_reg __attribute__((aligned(8))) mdri_reg; /**< mdri_reg - mdri register tlv */
};
...
struct ku_access_mpgcr_reg {
    struct ku_operation_tlv                         op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                         dev_id; /**< dev_id - device id */
    struct ku_mpgcr_reg __attribute__((aligned(8))) mpgcr_reg; /**< mpgcr_reg - mpgcr register tlv */
};
...
struct ku_access_mpilm_reg {
    struct ku_operation_tlv                         op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                         dev_id; /**< dev_id - device id */
    struct ku_mpilm_reg __attribute__((aligned(8))) mpilm_reg; /**< mpilm_reg - mpilm register tlv */
};
...
struct ku_access_slrip_reg {
    struct ku_operation_tlv                         op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                         dev_id; /**< dev_id - device id */
    struct ku_slrip_reg __attribute__((aligned(8))) slrip_reg; /**< slrip_reg - slrip register tlv */
};
...
struct ku_access_cwtp_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_cwtp_reg __attribute__((aligned(8))) cwtp_reg; /**< ku_cwtp_reg - cwtp register tlv */
};
...
struct ku_access_pfcc_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_pfcc_reg __attribute__((aligned(8))) pfcc_reg; /**< ku_pfcc_reg - pfcc register tlv */
};
...
struct ku_access_qppm_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_qppm_reg __attribute__((aligned(8))) qppm_reg; /**< ku_qppm_reg - qppm register tlv */
};
...
struct ku_access_slecr_reg {
    struct ku_operation_tlv                         op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                         dev_id; /**< dev_id - device id */
    struct ku_slecr_reg __attribute__((aligned(8))) slecr_reg; /**< ku_slecr_reg - slecr register tlv */
};
...
struct ku_access_rgcr_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_rgcr_reg __attribute__((aligned(8))) rgcr_reg; /**< rgcr_reg - rgcr register tlv */
};
...
struct ku_access_rtps_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_rtps_reg __attribute__((aligned(8))) rtps_reg; /**< rtps_reg - rtps register tlv */
};
...
struct ku_access_rtca_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_rtca_reg __attribute__((aligned(8))) rtca_reg; /**< rtca_reg - rtca register tlv */
};
...
struct ku_access_ruft_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_ruft_reg __attribute__((aligned(8))) ruft_reg; /**< ruft_reg - ruft register tlv */
};
...
struct ku_access_sbhbr_reg {
    struct ku_operation_tlv                         op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                         dev_id; /**< dev_id - device id */
    struct ku_sbhbr_reg __attribute__((aligned(8))) sbhbr_reg;  /**< sbhbr_reg - sbhbr register tlv */
};
...
struct ku_access_sbhrr_reg {
    struct ku_operation_tlv                         op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                         dev_id; /**< dev_id - device id */
    struct ku_sbhrr_reg __attribute__((aligned(8))) sbhrr_reg;  /**< sbhrr_reg - sbhrr register tlv */
};
...
struct ku_access_sbdcc_reg {
    struct ku_operation_tlv                         op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                         dev_id; /**< dev_id - device id */
    struct ku_sbdcc_reg __attribute__((aligned(8))) sbdcc_reg;  /**< sbdcc_reg - sbdcc register tlv */
};
...
struct ku_access_sbdcm_reg {
    struct ku_operation_tlv                         op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                         dev_id; /**< dev_id - device id */
    struct ku_sbdcm_reg __attribute__((aligned(8))) sbdcm_reg;  /**< sbdcm_reg - sbdcm register tlv */
};
...
struct ku_access_sbctc_reg {
    struct ku_operation_tlv                         op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                         dev_id; /**< dev_id - device id */
    struct ku_sbctc_reg __attribute__((aligned(8))) sbctc_reg;  /**< sbctc_reg - sbctc register tlv */
};
...
struct ku_access_ppbmi_reg {
    struct ku_operation_tlv                         op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                         dev_id; /**< dev_id - device id */
    struct ku_ppbmi_reg __attribute__((aligned(8))) ppbmi_reg; /**< ku_ppbmi_reg - ppbmi register tlv */
};
...
struct ku_access_htac_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_htac_reg __attribute__((aligned(8))) htac_reg; /**< htac_reg - htac register tlv */
};
...
struct ku_profile {
    ...
    uint8_t                              ib_mad_gen; /**< ib_mad_gen - IB MAD Protocol */
    uint16_t                             max_pkey; /**< max_pkey - Maximum per port pkey table size (for pkey enforcement) */
    ...
    uint8_t                              module_master_fw_default; /**< Module Master FW Default. 0 - FW control, 1 - SW control, 2 - SW control (no I2C connectivity) */
};
...
struct ku_access_mhsr_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_mhsr_reg __attribute__((aligned(8))) mhsr_reg; /**< mhsr_reg - mhsr register tlv */
};
...
struct ku_access_mtpppc_reg {
    struct ku_operation_tlv                          op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                          dev_id; /**< dev_id - device id */
    struct ku_mtpppc_reg __attribute__((aligned(8))) mtpppc_reg; /**< mtpppc_reg - mtpppc register tlv */
};
...
struct ku_access_mtptpt_reg {
    struct ku_operation_tlv                          op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                          dev_id; /**< dev_id - device id */
    struct ku_mtptpt_reg __attribute__((aligned(8))) mtptpt_reg; /**< mtptpt_reg - mtptpt register tlv */
};
...
struct ku_access_mtpptr_reg {
    struct ku_operation_tlv                          op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                          dev_id; /**< dev_id - device id */
    struct ku_mtpptr_reg __attribute__((aligned(8))) mtpptr_reg; /**< mtpptr_reg - mtptpt register tlv */
};
...
struct ku_access_ppbmp_reg {
    struct ku_operation_tlv                         op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                         dev_id; /**< dev_id - device id */
    struct ku_ppbmp_reg __attribute__((aligned(8))) ppbmp_reg; /**< ppbmp_reg - ppbmp register tlv */
};
...
struct ku_access_ppbmc_reg {
    struct ku_operation_tlv                         op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                         dev_id; /**< dev_id - device id */
    struct ku_ppbmc_reg __attribute__((aligned(8))) ppbmc_reg; /**< ppbmc_reg - ppbmc register tlv */
};
...
struct ku_access_perpt_reg {
    struct ku_operation_tlv                         op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                         dev_id; /**< dev_id - device id */
    struct ku_perpt_reg __attribute__((aligned(8))) perpt_reg; /**< perpt_reg - perpt register tlv */
};
...
struct ku_access_percr_reg {
    struct ku_operation_tlv                         op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                         dev_id; /**< dev_id - device id */
    struct ku_percr_reg __attribute__((aligned(8))) percr_reg; /**< percr_reg - percr register tlv */
};
...
struct ku_access_pererp_reg {
    struct ku_operation_tlv                         op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                         dev_id; /**< dev_id - device id */
    struct ku_percr_reg __attribute__((aligned(8))) pererp_reg; /**< pererp_reg - pererp register tlv */
};
...
struct ku_access_qpsc_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_qpsc_reg __attribute__((aligned(8))) qpsc_reg; /**< qpsc_reg - qpsc register tlv */
};
...
struct ku_access_peabfe_reg {
    struct ku_operation_tlv                          op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                          dev_id; /**< dev_id - device id */
    struct ku_peabfe_reg __attribute__((aligned(8))) peabfe_reg; /**< peabfe_reg - peabfe register tlv */
};
...
typedef enum sxd_trap_id {
    ...
    SXD_TRAP_ID_IBISSU          = 0x25,
    SXD_TRAP_ID_PPIR            = 0x26,
    SXD_TRAP_ID_ACCU_FLOW_INC   = 0x27,
    SXD_TRAP_ID_PLLP            = 0x2A,
    SXD_TRAP_ID_MFCDR           = 0x2B,
    SXD_TRAP_ID_SPZR            = 0xE7,
    ...
    SXD_TRAP_ID_ARN_RECEIVE_OK         = 0xe3,
    ...
    SXD_TRAP_ID_SYSFS_SNIFFER                   = 0x437,

    SXD_TRAP_ID_MIN = SXD_TRAP_ID_GENERAL_FDB,
    SXD_TRAP_ID_MAX = SXD_TRAP_ID_SYSFS_SNIFFER,
} sxd_trap_id_t;
...
#define SXD_FOREACH_OBJECT_HEALTH_CAUSE(SXD_HEALTH_TYPE)                                 \
    ...
    SXD_HEALTH_TYPE(SXD_HEALTH_CAUSE_FW, , "FW health")                                  \
    SXD_HEALTH_TYPE(SXD_HEALTH_CAUSE_GO_BIT, , "Go-bit not cleared")                     \
    SXD_HEALTH_TYPE(SXD_HEALTH_CAUSE_NO_CMDIFC_COMPLETION, , "CmdIfc timeout")           \
    SXD_HEALTH_TYPE(SXD_HEALTH_CAUSE_EMAD_TIMEOUT, , "EMAD timeout")                     \
    SXD_HEALTH_TYPE(SXD_HEALTH_CAUSE_CATAS, , "FW CATAS event")                          \
    ...
    SXD_HEALTH_TYPE(SXD_HEALTH_CAUSE_RDQ, , "RDQ is stuck")                              \
    SXD_HEALTH_TYPE(SXD_HEALTH_CAUSE_SDQ, , "SDQ is stuck")                              \
    SXD_HEALTH_TYPE(SXD_HEALTH_CAUSE_SDK_THREADS, , "SDK thread issue")                  \
    SXD_HEALTH_TYPE(SXD_HEALTH_CAUSE_KERNEL_THREADS, , "Kernel thread error")            \
    SXD_HEALTH_TYPE(SXD_HEALTH_CAUSE_SDK_WD, , "SDK watchdog")                           \
    SXD_HEALTH_TYPE(SXD_HEALTH_CAUSE_FW_HETT, , "HETT timeout")                          \
    SXD_HEALTH_TYPE(SXD_HEALTH_CAUSE_STATEFUL_DB_ORDERING_E, , "Flex stateful HW error") \
    SXD_HEALTH_TYPE(SXD_HEALTH_CAUSE_ECC_E, , "ECC event(s)")                            \
    SXD_HEALTH_TYPE(SXD_HEALTH_CAUSE_GENERIC_E, , "Generic issue")                       \
...
/* this structure is accessible by NOS (included in health event metadata) */
...
typedef struct sxd_event_health_notification {
    ...
    uint8_t                 irisc_id; /*< which IRISC triggered the event, in case the event is SDK and not FW should be DBG_ALL_IRISCS  */
...
typedef enum sxd_health_fatal_failure_detect_cmd {
...
} sxd_health_fatal_failure_detect_cmd_e;
...
#define SXD_FOREACH_OBJECT_HEALTH_THREAD_FAILURE_ID(SXD_HEALTH_THREAD_FAILURE_ID)                           \
    ...
    SXD_HEALTH_THREAD_FAILURE_ID(SXD_HEALTH_THREAD_ASYNC_ROUTER_E, , "AsyncRouter thread error")            \
    SXD_HEALTH_THREAD_FAILURE_ID(SXD_HEALTH_THREAD_REG_BULK_E, , "RegBulk thread error")                    \
    SXD_HEALTH_THREAD_FAILURE_ID(SXD_HEALTH_THREAD_CORE_ASYNC_E, , "CoreAsync thread error")                \
    SXD_HEALTH_THREAD_FAILURE_ID(SXD_HEALTH_THREAD_LINEAR_MANAGER_E, , "Linear_Manager thread error")       \
    SXD_HEALTH_THREAD_FAILURE_ID(SXD_HEALTH_THREAD_FDB_UPDATE_E, , "FdbUpdate thread error")                \
    SXD_HEALTH_THREAD_FAILURE_ID(SXD_HEALTH_THREAD_UC_ROUTE_SET_E, , "UcRouteSet thread error")             \
    SXD_HEALTH_THREAD_FAILURE_ID(SXD_HEALTH_THREAD_SNIFFER_E, , "Sniffer thread error")                     \
    SXD_HEALTH_THREAD_FAILURE_ID(SXD_HEALTH_THREAD_TD_WORKER_E, , "TD worker thread error")                 \
...
typedef struct ku_thread_status_changed {
    uint32_t bit_index;
    char     name[THREAD_NAME_SIZE];
    uint64_t thread_id;
    /* if cmd TRUE is new thread else its a thread that removed*/
    sxd_boolean_t cmd;
    /* last_update_time contain time in jiffies units*/
    unsigned long last_update_time;
    /* time_passed_from_last_update contain time in seconds units*/
    unsigned long time_passed_from_last_update;
    unsigned long time_of_creation;
    unsigned long max_expected_thread_duration_sec;
} ku_thread_status_changed_t;


typedef struct threads_monitor_info {
    uint64_t                   last_sent_threads_existing;
    uint64_t                   running_threads_status;
    thread_monitoring_status_e thread_monitoring_status;
} threads_monitor_info_t;

typedef union sdk_threads_info {
    ku_thread_status_changed_t thread_status_changed;
    threads_monitor_info_t     threads_monitor_info;
} sdk_threads_info_u;

typedef struct emad_timeout_info {
    uint16_t reg_id;
    uint32_t usecs;
} emad_timeout_info_t;

typedef struct ku_dbg_health_check_params {
    sxd_health_fatal_failure_detect_cmd_e sxd_health_fatal_failure_detect_cmd;
    uint8_t                               dev_id;
    union {
        tg_params_t         tg_params;
        sampling_params_t   sampling_params;
        sdk_threads_info_u  sdk_threads_info;
        emad_timeout_info_t emad_timeout_info;
    } params;
...
/**
 * This event is generated by the SDK to notify the sdk process about a new sysfs access to be recorded by sx api sniffer.
 * Supported devices: SPC1/2/3/4
 */

#define SXD_SYSFS_CB_NAME_MAX   64
#define SXD_SYSFS_FILE_PATH_MAX 256

typedef enum sxd_sysfs_sniffer_mode {
    SXD_SYSFS_SNIFFER_NONE_E,
    SXD_SYSFS_SNIFFER_WRITE_ONLY_E,
    SXD_SYSFS_SNIFFER_READ_WRITE_E,
} sxd_sysfs_sniffer_mode_e;

typedef struct ku_sysfs_sniffer_params {
    sxd_sysfs_sniffer_mode_e sysfs_sniffer_mode;
} ku_sysfs_sniffer_params_t;

typedef struct sxd_sysfs_access_sniffer_notification {
    uint8_t            device_id;
    uint8_t            func_name[SXD_SYSFS_CB_NAME_MAX];
    uint8_t            file_path[SXD_SYSFS_FILE_PATH_MAX];
    uint32_t           len;                        /**< write buffer len */
    struct ku_timespec timestamp;
    uint8_t            buf[0];                        /**< store buffer */
    /*todo add timestamp */
} sxd_sysfs_access_sniffer_notification_t;
...
enum sxd_bulk_cntr_key_type_e {
    ...
    SXD_BULK_CNTR_KEY_TYPE_HFT_E,
    SXD_BULK_CNTR_KEY_TYPE_ARN_FLOW_E,
...
typedef enum sxd_bulk_cntr_port_grp {
    SXD_BULK_CNTR_PORT_GRP_IEEE_802_DOT_3_E  = (1 << 0),
    SXD_BULK_CNTR_PORT_GRP_RFC_2863_E        = (1 << 1),
    SXD_BULK_CNTR_PORT_GRP_RFC_2819_E        = (1 << 2),
    SXD_BULK_CNTR_PORT_GRP_RFC_3635_E        = (1 << 3),
    SXD_BULK_CNTR_PORT_GRP_PRIO_E            = (1 << 4),
    SXD_BULK_CNTR_PORT_GRP_TC_E              = (1 << 5),
    SXD_BULK_CNTR_PORT_GRP_BUFF_E            = (1 << 6),
    SXD_BULK_CNTR_PORT_GRP_PERF_E            = (1 << 7),
    SXD_BULK_CNTR_PORT_GRP_DISCARD_E         = (1 << 8),
    SXD_BULK_CNTR_PORT_GRP_PHY_LAYER_E       = (1 << 9),
    SXD_BULK_CNTR_PORT_GRP_PHY_LAYER_STATS_E = (1 << 10),
    SXD_BULK_CNTR_PORT_GRP_IB_PACKETS_E      = (1 << 11),
    SXD_BULK_CNTR_PORT_GRP_PLR_E             = (1 << 12),
    SXD_BULK_CNTR_PORT_GRP_RS_FEC_E          = (1 << 14),
    SXD_BULK_CNTR_PORT_GRP_IB_EXT_E          = (1 << 15),
    SXD_BULK_CNTR_PORT_GRP_IB_GENERAL_E      = (1 << 16),
    SXD_BULK_CNTR_PORT_GRP_MAX_E             = SXD_BULK_CNTR_PORT_GRP_IB_GENERAL_E
...
typedef struct sxd_port_cntr_phy_layer {
    ...
    sxd_port_cntr_t   rs_fec_corrected_symbols_lane4;
    sxd_port_cntr_t   rs_fec_corrected_symbols_lane5;
    sxd_port_cntr_t   rs_fec_corrected_symbols_lane6;
    sxd_port_cntr_t   rs_fec_corrected_symbols_lane7;
...
typedef struct sxd_port_cntr_phy_layer_statistics {
    ...
    sxd_port_cntr_t fc_zero_hist;
    sxd_port_cntr_t symbol_ber_magnitude;
    sxd_port_cntr_t symbol_ber_coef;
    sxd_port_cntr_t raw_ber_magnitude_lane0;
    sxd_port_cntr_t raw_ber_coef_lane0;
    sxd_port_cntr_t raw_ber_magnitude_lane1;
    sxd_port_cntr_t raw_ber_coef_lane1;
    sxd_port_cntr_t raw_ber_magnitude_lane2;
    sxd_port_cntr_t raw_ber_coef_lane2;
    sxd_port_cntr_t raw_ber_magnitude_lane3;
    sxd_port_cntr_t raw_ber_coef_lane3;
    sxd_port_cntr_t raw_ber_magnitude_lane4;
    sxd_port_cntr_t raw_ber_coef_lane4;
    sxd_port_cntr_t raw_ber_magnitude_lane5;
    sxd_port_cntr_t raw_ber_coef_lane5;
    sxd_port_cntr_t raw_ber_magnitude_lane6;
    sxd_port_cntr_t raw_ber_coef_lane6;
    sxd_port_cntr_t raw_ber_magnitude_lane7;
    sxd_port_cntr_t raw_ber_coef_lane7;
    sxd_port_cntr_t phy_effective_errors;
...
typedef struct sxd_port_cntr_infiniband_packets {
    sxd_port_cntr_t time_since_last_clear;
    sxd_port_cntr_t port_unicast_xmit_pkts;
    sxd_port_cntr_t port_unicast_rcv_pkts;
    sxd_port_cntr_t sync_header_error_counter;
    sxd_port_cntr_t port_local_physical_errors;
    sxd_port_cntr_t port_malformed_packet_errors;
    sxd_port_cntr_t port_buffer_overrun_errors;
    sxd_port_cntr_t port_dlid_mapping_errors;
    sxd_port_cntr_t port_vl_mapping_errors;
    sxd_port_cntr_t port_looping_errors;
    sxd_port_cntr_t port_inactive_discards;
    sxd_port_cntr_t port_neighbor_mtu_discards;
    sxd_port_cntr_t port_llu_rx_icrc_error;
    sxd_port_cntr_t port_tx_parity_error;
} __attribute__((packed)) sxd_port_cntr_infiniband_packets_t;

typedef struct sxd_port_cntr_plr {
    sxd_port_cntr_t plr_rcv_codes;
    sxd_port_cntr_t plr_rcv_code_err;
    sxd_port_cntr_t plr_rcv_uncorrectable_code;
    sxd_port_cntr_t plr_xmit_codes;
    sxd_port_cntr_t plr_xmit_retry_codes;
    sxd_port_cntr_t plr_xmit_retry_events;
    sxd_port_cntr_t plr_sync_events;
    sxd_port_cntr_t plr_codes_loss;
    sxd_port_cntr_t plr_xmit_retry_events_within_t_sec_max;
    sxd_port_cntr_t time_since_last_clear;
} __attribute__((packed)) sxd_port_cntr_plr_t;

#define PPCNT_RS_FEC_HIST_NUM 21

typedef struct sxd_port_cntr_rs_fec {
    sxd_port_cntr_t hist[PPCNT_RS_FEC_HIST_NUM];
} __attribute__((packed)) sxd_port_cntr_rs_fec_t;

typedef struct sxd_port_cntr_ib_ext {
    sxd_port_cntr_t symbol_error_counter;
    sxd_port_cntr_t link_error_recovery_counter;
    sxd_port_cntr_t link_downed_counter;
    sxd_port_cntr_t port_rcv_errors;
    sxd_port_cntr_t port_rcv_remote_physical_errors;
    sxd_port_cntr_t port_rcv_switch_relay_errors;
    sxd_port_cntr_t port_xmit_discards;
    sxd_port_cntr_t port_xmit_constraint_errors;
    sxd_port_cntr_t port_rcv_constraint_errors;
    sxd_port_cntr_t local_link_integrity_errors;
    sxd_port_cntr_t excessive_buffer_overrun_errors;
    sxd_port_cntr_t vl_15_dropped;
    sxd_port_cntr_t port_xmit_data;
    sxd_port_cntr_t port_rcv_data;
    sxd_port_cntr_t port_xmit_pkts;
    sxd_port_cntr_t port_rcv_pkts;
    sxd_port_cntr_t port_xmit_wait;
    sxd_port_cntr_t qp1_dropped;
    sxd_port_cntr_t port_unicast_xmit_pkts;
    sxd_port_cntr_t port_multicast_xmit_pkts;
    sxd_port_cntr_t port_unicast_rcv_pkts;
    sxd_port_cntr_t port_multicast_rcv_pkts;
} __attribute__((packed)) sxd_port_cntr_ib_ext_t;

typedef struct sxd_port_cntr_ib_general {
    sxd_port_cntr_t port_rcv_data_qword;
    sxd_port_cntr_t port_xmit_data_qword;
    sxd_port_cntr_t rq_general_error;
    sxd_port_cntr_t port_xmit_ebp;
    sxd_port_cntr_t port_sw_hoq_lifetime_limit_discards;
    sxd_port_cntr_t dqs2llu_xmit_wait_arb_global;
    sxd_port_cntr_t grxb_fecn_mark;
    sxd_port_cntr_t general_transmit_discard_external_contain;
    sxd_port_cntr_t general_receive_discard_external_contain;
    sxd_port_cntr_t port_receive_poison;
} __attribute__((packed)) sxd_port_cntr_ib_general_t;
...
typedef struct sxd_port_cntr_composition {
    ...
    sxd_port_cntr_infiniband_packets_t   infiniband_packets;
    sxd_port_cntr_plr_t                  plr;
    sxd_port_cntr_rs_fec_t               rs_fec;
    sxd_port_cntr_ib_ext_t               ib_ext;
    sxd_port_cntr_ib_general_t           ib_general;
...
/**
 * SXD_BULK_CNTR_HFT_SAMPLE_INFO_TYPE_COUNT defines the maximal information categories in a sample.
 */
#define SXD_BULK_CNTR_HFT_SAMPLE_INFO_TYPE_COUNT 3
/**
 * SXD_BULK_CNTR_HFT_SAMPLE_PER_INFO_SUBTYPE_COUNT_MAX defines the maximal info within a given type in a sample.
 */
#define SXD_BULK_CNTR_HFT_SAMPLE_PER_INFO_SUBTYPE_COUNT_MAX 20

#define SXD_BULK_CNTR_HFT_SIZE_32  4
#define SXD_BULK_CNTR_HFT_SIZE_64  8
#define SXD_BULK_CNTR_HFT_SIZE_128 16

#define SXD_BULK_CNTR_HFT_SAMPLE_METADATA_TIME_STAMP_SECS_SAMPLE_POS_E      0
#define SXD_BULK_CNTR_HFT_SAMPLE_METADATA_TIME_STAMP_NANO_SECS_SAMPLE_POS_E 1

#define SXD_BULK_CNTR_HFT_SAMPLE_COUNTER_PORT_BYTE_TRANSMIT_OK_SAMPLE_POS_E \
    0
#define SXD_BULK_CNTR_HFT_SAMPLE_COUNTER_PORT_BYTE_RECEIVED_OK_SAMPLE_POS_E \
    1
#define SXD_BULK_CNTR_HFT_SAMPLE_COUNTER_PORT_PACKET_TRANSMITTED_OK_SAMPLE_POS_E \
    2
#define SXD_BULK_CNTR_HFT_SAMPLE_COUNTER_PORT_PACKET_RECEIVED_OK_SAMPLE_POS_E \
    3
#define SXD_BULK_CNTR_HFT_SAMPLE_COUNTER_PORT_RFC_2863_GROUP_IF_IN_DISCARDS_SAMPLE_POS_E \
    4
#define SXD_BULK_CNTR_HFT_SAMPLE_COUNTER_PORT_RFC_802_3_GROUP_PAUSE_MAC_CTRL_FRAMES_TRANSMITTED_SAMPLE_POS_E \
    5
#define SXD_BULK_CNTR_HFT_SAMPLE_COUNTER_PORT_RFC_802_3_GROUP_PAUSE_MAC_CTRL_FRAMES_RECEIVED_SAMPLE_POS_E \
    6
#define SXD_BULK_CNTR_HFT_SAMPLE_COUNTER_PORT_PER_PRIO_GROUP_TX_PAUSE_SAMPLE_POS_E \
    7
#define SXD_BULK_CNTR_HFT_SAMPLE_COUNTER_PORT_PER_PRIO_GROUP_RX_PAUSE_SAMPLE_POS_E \
    8
#define SXD_BULK_CNTR_HFT_SAMPLE_COUNTER_PORT_PER_PRIO_GROUP_RX_OCTETS_SAMPLE_POS_E \
    9
#define SXD_BULK_CNTR_HFT_SAMPLE_COUNTER_PORT_PER_TRAFFIC_CLASS_TX_OCTETS_SAMPLE_POS_E \
    10
#define SXD_BULK_CNTR_HFT_SAMPLE_COUNTER_PORT_ETH_TRAFFIC_CLASS_CONG_ECN_MARKED_SAMPLE_POS_E \
    11
#define SXD_BULK_CNTR_HFT_SAMPLE_COUNTER_INGRESS_PORT_PRIORITY_GROUP_HEADROOM_BUFFER_WATERMARK_SAMPLE_POS_E \
    12
#define \
    SXD_BULK_CNTR_HFT_SAMPLE_COUNTER_INGRESS_PORT_PRIORITY_GROUP_HEADROOM_BUFFER_CURRENT_OCCUPANCY_SAMPLE_POS_E 13
#define SXD_BULK_CNTR_HFT_SAMPLE_COUNTER_EGRESS_PORT_TRAFFIC_CLASS_BUFFER_WATERMARK_SAMPLE_POS_E \
    14
#define SXD_BULK_CNTR_HFT_SAMPLE_COUNTER_EGRESS_PORT_TRAFFIC_CLASS_BUFFER_CURRENT_OCCUPANCY_SAMPLE_POS_E \
    15
#define SXD_BULK_CNTR_HFT_SAMPLE_COUNTER_INGRESS_PORT_PRIORITY_GROUP_BUFFER_WATERMARK_SAMPLE_POS_E \
    16
#define SXD_BULK_CNTR_HFT_SAMPLE_COUNTER_INGRESS_PORT_PRIORITY_GROUP_BUFFER_OCCUPANCY_SAMPLE_POS_E \
    17
#define SXD_BULK_CNTR_HFT_SAMPLE_COUNTER_PORT_AR_GRADE_LOW_SAMPLE_POS_E \
    18
#define SXD_BULK_CNTR_HFT_SAMPLE_COUNTER_PORT_AR_GRADE_HIGH_SAMPLE_POS_E \
    19

#define SXD_BULK_CNTR_HFT_SAMPLE_COUNTER_GLOBAL_FLOW_COUNTER_BASE0 0
#define SXD_BULK_CNTR_HFT_SAMPLE_COUNTER_GLOBAL_FLOW_COUNTER_BASE1 1

#define SXD_BULK_CNTR_HFT_SAMPLE_METADATA_COUNT       2
#define SXD_BULK_CNTR_HFT_SAMPLE_PORT_COUNTER_COUNT   20
#define SXD_BULK_CNTR_HFT_SAMPLE_GLOBAL_COUNTER_COUNT 2
#define SXD_BULK_CNTR_HFT_SAMPLE_FLOW_COUNTER_COUNT   2

/*TODO - Move this once adabe is updated. */
#define SXD_MOFTC_SAMPLE_METADATA_TIME_STAMP_SECS_OFFSET_E                                              0
#define SXD_MOFTC_SAMPLE_METADATA_TIME_STAMP_NANO_SECS_OFFSET_E                                         1
#define SXD_MOFTC_SAMPLE_GLOBAL_FLOW_COUNTER_PACKETS_AND_BYTES_BASE_0_OFFSET_E                          0
#define SXD_MOFTC_SAMPLE_GLOBAL_FLOW_COUNTER_PACKETS_AND_BYTES_BASE_1_OFFSET_E                          1
#define SXD_MOFTC_SAMPLE_COUNTER_PORT_BYTE_TRANSMIT_OK_OFFSET_E                                         0
#define SXD_MOFTC_SAMPLE_COUNTER_PORT_BYTE_RECEIVED_OK_OFFSET_E                                         1
#define SXD_MOFTC_SAMPLE_COUNTER_PORT_PACKET_TRANSMITTED_OK_OFFSET_E                                    2
#define SXD_MOFTC_SAMPLE_COUNTER_PORT_PACKET_RECEIVED_OK_OFFSET_E                                       3
#define SXD_MOFTC_SAMPLE_COUNTER_PORT_RFC_2863_GROUP_IF_IN_DISCARDS_OFFSET_E                            4
#define SXD_MOFTC_SAMPLE_COUNTER_PORT_RFC_802_3_GROUP_PAUSE_MAC_CTRL_FRAMES_TRANSMITTED_OFFSET_E        5
#define SXD_MOFTC_SAMPLE_COUNTER_PORT_RFC_802_3_GROUP_PAUSE_MAC_CTRL_FRAMES_RECEIVED_OFFSET_E           6
#define SXD_MOFTC_SAMPLE_COUNTER_PORT_PER_PRIO_GROUP_TX_PAUSE_OFFSET_E                                  15
#define SXD_MOFTC_SAMPLE_COUNTER_PORT_PER_PRIO_GROUP_RX_PAUSE_OFFSET_E                                  16
#define SXD_MOFTC_SAMPLE_COUNTER_PORT_PER_PRIO_GROUP_RX_OCTETS_OFFSET_E                                 7
#define SXD_MOFTC_SAMPLE_COUNTER_PORT_PER_TRAFFIC_CLASS_TX_OCTETS_OFFSET_E                              8
#define SXD_MOFTC_SAMPLE_COUNTER_PORT_PER_TRAFFIC_CLASS_CONG_ECN_MARKED_OFFSET_E                        9
#define SXD_MOFTC_SAMPLE_COUNTER_INGRESS_PORT_PRIORITY_GROUP_HEADROOM_BUFFER_WATERMARK_OFFSET_E         10
#define SXD_MOFTC_SAMPLE_COUNTER_INGRESS_PORT_PRIORITY_GROUP_HEADROOM_BUFFER_CURRENT_OCCUPANCY_OFFSET_E 11
#define SXD_MOFTC_SAMPLE_COUNTER_EGRESS_PORT_TRAFFIC_CLASS_BUFFER_WATERMARK_OFFSET_E                    12
#define SXD_MOFTC_SAMPLE_COUNTER_EGRESS_PORT_TRAFFIC_CLASS_BUFFER_CURRENT_OCCUPANCY_OFFSET_E            13
#define SXD_MOFTC_SAMPLE_COUNTER_INGRESS_PORT_PRIORITY_GROUP_BUFFER_WATERMARK_OFFSET_E                  14
#define SXD_MOFTC_SAMPLE_COUNTER_INGRESS_PORT_PRIORITY_GROUP_BUFFER_OCCUPANCY_OFFSET_E                  17
#define SXD_MOFTC_SAMPLE_COUNTER_PORT_AR_GRADE_LOW_OFFSET_E                                             18
#define SXD_MOFTC_SAMPLE_COUNTER_PORT_AR_GRADE_HIGH_OFFSET_E                                            19
#define SXD_MOCS_MIN_ITER_TIME_UNITS                                                                    50 /* units in 50 usecs. */

#define SXD_MOFTD_ENTRY_SIZE 4
#define SXD_MAX_HFT_ENTRIES_SINGLE_EMAD(max_packet_size) \
    ((max_packet_size - (offsetof(struct ku_moftd_reg, entry))) / SXD_MOFTD_ENTRY_SIZE)

typedef struct sxd_bulk_cntr_buffer_layout_hft_port_map {
    uint16_t port_index_map[SXD_BULK_CNTR_PORT_INDEX_MAP_SIZE];                           /**< Filtering */
    uint16_t sample_port_index_map[SXD_BULK_CNTR_PORT_INDEX_MAP_SIZE];                    /**< Actual port list to index mapping. */
    uint16_t sample_port_list_map[SXD_BULK_CNTR_PORT_INDEX_MAP_SIZE];                     /**< Actual port index to port mapping. */
    uint16_t port_counter_list[SXD_BULK_CNTR_HFT_SAMPLE_PORT_COUNTER_COUNT];              /**< list of counters belonging to port. */
    uint16_t port_counter_list_size;                                                      /**< port counter list size. */
    uint16_t if_out_octets_offset;                                                        /**< port counter RFC 2863 group, interface out octets 64bits */
    uint16_t if_in_octets_offset;                                                         /**< port counter RFC 2863 group, interface in octets 64bits */
    uint16_t a_frames_received_ok_offset;                                                 /**< port counter RFC 802.3 group, frames transmitted successfully but not including pause frames, 64 bits */
    uint16_t a_frames_transmitted_ok_offset;                                              /**< port counter RFC 802.3 group, frames received successfully 64 bits */
    uint16_t if_in_discards_offset;                                                       /**< port counter RFC 2863 group, ingress discard 64 bits */
    uint16_t a_pause_mac_ctrl_frames_transmitted_offset;                                  /**< port counter group RFC 2863, pause frame transmitted, 64 bits */
    uint16_t a_pause_mac_ctrl_frames_received_offset;                                     /**< port counter group RFC 2863, pause frame received, 64 bits */
    uint16_t tx_pause_per_prio_list_offset;                                               /**< port PRIO counter list, egress pause frames, 64 bits */
    uint16_t rx_pause_per_prio_list_offset;                                               /**< port PRIO counter list, ingress pause frames, 64 bits */
    uint16_t rx_octets_list_offset;                                                       /**< port PRIO counter list, ingress bytes, 64 bits */
    uint16_t tx_octets_list_offset;                                                       /**< port TC egress bytes counter list, 64 bits */
    uint16_t ecn_marked_tc_list_offset;                                                   /**< port TC ecn marked packets counter list, 64 bits */
    uint16_t headroom_watermark_list_offset;                                              /**< port PG headroom max occupancy list, units in cells, 32 bits */
    uint16_t headroom_curr_occupancy_list_offset;                                         /**< port PG headroom current occupancy list, units in cells, 32 bits */
    uint16_t tc_watermark_list_offset;                                                    /**< port per TC shared buffer max occupancy list, units in cells, 64 bits */
    uint16_t tc_curr_occupancy_list_offset;                                               /**< port per TC shared buffer occupancy list, units in cells, 32 bits */
    uint16_t pg_watermark_list_offset;                                                    /**< port per PG shared buffer max occupancy list, units in cells, 64 bits */
    uint16_t pg_curr_occupancy_list_offset;                                               /**< port per PG shared buffer occupancy list, units in cells, 32 bits */
    uint16_t ar_grades_low_offset;                                                        /**< AR grades for TC0..TC7 4 bits */
    uint16_t ar_grades_high_offset;                                                       /**< AR grades for TC8..TC15 4 bits */
    uint32_t prio_list_cnt;                                                               /**< port PRIO list count. */
    uint32_t tc_list_cnt;                                                                 /**< port TC list count. */
    uint32_t pg_list_cnt;                                                                 /**< port PG list count. */
    uint32_t reserved1;
    uint16_t port_counter_buffer_size;
    uint16_t count_port_expected;                                                      /**< port count expected in the current sample. */
    uint16_t count_port_received;                                                      /**< port count received in the current  sample. */
    uint16_t reserved2;
} sxd_bulk_cntr_buffer_layout_hft_port_map_t;

typedef struct sxd_bulk_cntr_buffer_layout_hft_metadata_map {
    uint16_t start_ts_secs_offset;                                                         /**< hardware timestamp, UTC in seconds 32 bits */
    uint16_t start_ts_nsecs_offset;                                                         /**< hardware timestamp, UTC in nano seconds 32 bits */
    uint16_t metadata_buffer_size;
    uint16_t reserved1;
    uint16_t metadata_info_expected;
    uint16_t metadata_info_received;
    uint32_t reserved2;
} sxd_bulk_cntr_buffer_layout_hft_metadata_map_t;

typedef struct sxd_bulk_cntr_buffer_layout_hft_flow_map_info {
    uint32_t base_counter_id;    /**< base counter ID of the range of flow counters */
    uint32_t flow_counter_buffer_size;
    uint32_t flow_counter_type;
    uint16_t counter_received;
    uint16_t counter_number;
} sxd_bulk_cntr_buffer_layout_hft_flow_map_info_t;

typedef struct sxd_bulk_cntr_buffer_layout_hft_global_map {
    uint32_t                                        flow_counter_base_0_offset;
    uint32_t                                        flow_counter_base_1_offset;
    uint32_t                                        global_counter_buffer_size;
    uint32_t                                        flow_counter_type_count;
    sxd_bulk_cntr_buffer_layout_hft_flow_map_info_t flow_info[SXD_BULK_CNTR_HFT_SAMPLE_FLOW_COUNTER_COUNT];
} sxd_bulk_cntr_buffer_layout_hft_global_map_t;

typedef struct sxd_bulk_cntr_buffer_layout_hft {
    sxd_bulk_cntr_buffer_layout_common_t           common;
    sxd_bulk_cntr_buffer_layout_hft_port_map_t     port_map;
    sxd_bulk_cntr_buffer_layout_hft_metadata_map_t metadata_map;
    sxd_bulk_cntr_buffer_layout_hft_global_map_t   global_map;
    uint32_t                                       sample_buffer_size;
    uint32_t                                       samples_expected;
    uint32_t                                       buffer_idx;
    uint32_t                                       samples_received;
    uint64_t                                       moftd_max_entries;
    uint8_t                                       *moftd_reg_buf;
    uint8_t                                        buffer[0];
} sxd_bulk_cntr_buffer_layout_hft_t;
...
typedef struct sxd_bulk_cntr_params_hft {
    sxd_bulk_cntr_buffer_layout_hft_port_map_t     port_map;
    sxd_bulk_cntr_buffer_layout_hft_metadata_map_t metadata_map;
    sxd_bulk_cntr_buffer_layout_hft_global_map_t   global_map;
    uint32_t                                       sample_buffer_size;
    uint32_t                                       samples_expected;
} sxd_bulk_cntr_params_hft_t;
...
union sxd_bulk_cntr_transaction_params {
    ...
    struct sxd_bulk_cntr_params_hft             hft_params;
};
...
/**
 * ku_bulk_cntr_buffer_info_t is used to set and get bulk counter buffer limits and utilization(RO)
 */

typedef struct ku_bulk_cntr_buffer_info {
    uint32_t max_size;                  /* size of maximum shared memory allocated in MB */
    uint64_t current_utilization;       /* Readonly, current utilization in bytes. */
} ku_bulk_cntr_buffer_info_t;


/**
 * ku_bulk_cntr_buffer_stats_t is used to update buffer allocations and free for accounting.
 */

typedef struct ku_bulk_cntr_buffer_stats {
    sxd_boolean_t is_allocated;           /* Is bulk counter memory allocated or freed in bytes. */
    uint64_t      size;                   /* size of allocation or deallocation. */
    pid_t         pid;                    /* the PID of the mmap() caller */
    unsigned long user_ptr;               /* user-space pointer of mmap() */
} ku_bulk_cntr_buffer_stats_t;
...
typedef enum ku_mmap_mem_alloc_scheme {
    KU_MMAP_MEM_ALLOC_SCHEME_VMALLOC = 0x0, /**< Default memory allocation scheme is vmalloc, hence value is set 0.*/
    KU_MMAP_MEM_ALLOC_SCHEME_KMALLOC = 0x1
} ku_mmap_mem_alloc_scheme_e;

typedef struct ku_mmap_mem_alloc_data {
    ku_mmap_mem_alloc_scheme_e alloc_scheme;
} ku_mmap_mem_alloc_data_t;
...
struct ku_ibsni_reg {
    ...
    sxd_ibsni_ipv4_record_t ipv4_record_port2[SXD_IBSNI_IPV4_RECORD_NUM];
    sxd_ibsni_ipv6_record_t ipv6_record_port2[SXD_IBSNI_IPV6_RECORD_NUM];
};
...
struct ku_access_ibsni_reg {
    struct ku_operation_tlv                         op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                         dev_id; /**< dev_id - device id */
    struct ku_ibsni_reg __attribute__((aligned(8))) ibsni_reg; /**< ibsni_reg - ibsni register tlv */
};
...
struct ku_access_slcr_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_slcr_reg __attribute__((aligned(8))) slcr_reg; /**< slcr_reg - slcr register tlv */
};
...
struct ku_access_mopir_v2_reg {
    struct ku_operation_tlv                            op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                            dev_id; /**< dev_id - device id */
    struct ku_mopir_v2_reg __attribute__((aligned(8))) mopir_v2_reg; /**< mopir_v2_reg - mopir_v2 register tlv */
};
...
struct ku_access_mopr_reg {
    struct ku_operation_tlv                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                        dev_id; /**< dev_id - device id */
    struct ku_mopr_reg __attribute__((aligned(8))) mopr_reg; /**< mopr_reg - mopr register tlv */
};
...
struct ku_access_mnvda_nv_switch_conf_reg {
    struct ku_operation_tlv                                        op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                                                        dev_id; /**< dev_id - device id */
    struct ku_mnvda_nv_switch_conf_reg __attribute__((aligned(8))) mnvda_nv_switch_conf_reg;    /**< mnvda_nv_switch_conf_reg - mnvda_nv_switch_conf register tlv */
};
...
#define SX_DEV_INFO_F_DEV_PROFILE_SET   (1ULL << 0)
#define SX_DEV_INFO_F_PCI_PROFILE_SET   (1ULL << 1)
#define SX_DEV_INFO_F_PCI_PROBE_FAILURE (1ULL << 2)
...
struct ku_access_common {
    struct ku_operation_tlv             op_tlv; /**< op_tlv - operation tlv struct */
    uint8_t                             dev_id; /**< dev_id - device id */
    uint8_t __attribute__((aligned(8))) comm_reg[]; /**< comm_reg - common register tlv */
};
