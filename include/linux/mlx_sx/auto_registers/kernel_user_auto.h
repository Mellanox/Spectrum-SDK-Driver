...
struct ku_mcc_reg {
    ...
    uint8_t component_specific_err_code;
};
...
struct ku_msgcr_reg {
    ...
    uint8_t lport_1_valid;
    uint16_t inter_asic_block_fmm_lport_1;
    uint8_t lport_0_valid;
    uint16_t inter_asic_block_fmm_lport_0;
};
...
/**
 * ku_access_moftd_reg structure is used to store the access register MOFTD command parameters
 */
struct ku_access_moftd_reg {
    struct ku_operation_tlv op_tlv; /**< op_tlv - operation tlv struct */
    struct ku_moftd_reg         moftd_reg; /**< moftd_reg - moftd register tlv */
    uint8_t                     dev_id; /**< dev_id - device id */
};
...
typedef enum sxd_pcam_feature_cap_mask {
    ...
    SXD_PCAM_FEATURE_CAP_MASK_MAX = SXD_PCAM_FEATURE_CAP_MASK_SLRG_ALL_LANES_SUPPORTED_E
