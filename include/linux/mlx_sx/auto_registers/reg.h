...
uint8_t mlxsw_reg_mcc_component_specific_err_code_get(const char *buf);
...
uint8_t mlxsw_reg_mgir_cfiv_get(const char *buf);

uint8_t mlxsw_reg_mgir_chassis_module_id_get(const char *buf);

uint8_t mlxsw_reg_mgir_chassis_slot_index_get(const char *buf);
...
uint8_t mlxsw_reg_msgcr_lport_1_valid_get(const char *buf);

void mlxsw_reg_msgcr_lport_1_valid_set(char *buf, uint8_t val);

uint16_t mlxsw_reg_msgcr_inter_asic_block_fmm_lport_1_get(const char *buf);

void mlxsw_reg_msgcr_inter_asic_block_fmm_lport_1_set(char *buf, uint16_t val);

uint8_t mlxsw_reg_msgcr_lport_0_valid_get(const char *buf);

void mlxsw_reg_msgcr_lport_0_valid_set(char *buf, uint8_t val);

uint16_t mlxsw_reg_msgcr_inter_asic_block_fmm_lport_0_get(const char *buf);

void mlxsw_reg_msgcr_inter_asic_block_fmm_lport_0_set(char *buf, uint16_t val);
...
uint32_t mlxsw_reg_moftd_entry_get(const char *buf);
...
uint8_t mlxsw_reg_ppcnt_phys_layer_stat_cntrs_fc_zero_hist_get(const char *buf);
