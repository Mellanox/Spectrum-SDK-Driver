...
uint8_t mlxsw_reg_htec_ver_new_get(const char *buf);

void mlxsw_reg_htec_ver_new_set(char *buf, uint8_t val);
...
uint8_t mlxsw_reg_htec_ver_agg_get(const char *buf);

void mlxsw_reg_htec_ver_agg_set(char *buf, uint8_t val);
...
uint8_t mlxsw_reg_mcgi_cfiv_get(const char *buf);
...
uint8_t mlxsw_reg_msgcr_error_injection_en_get(const char *buf);

void mlxsw_reg_msgcr_error_injection_en_set(char *buf, uint8_t val);
...
uint32_t mlxsw_reg_moftc_port_bitmask_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_moftc_port_bitmask_set(char *buf, unsigned short outer_index, unsigned short index, uint32_t val);

uint32_t mlxsw_reg_moftc_port_bitmask_actual_get(const char *buf, unsigned short outer_index, unsigned short index);
...
uint32_t mlxsw_reg_ptys_ext_ib_proto_cap_get(const char *buf);

uint32_t mlxsw_reg_ptys_ext_ib_proto_admin_get(const char *buf);

void mlxsw_reg_ptys_ext_ib_proto_admin_set(char *buf, uint32_t val);

uint32_t mlxsw_reg_ptys_ext_ib_proto_oper_get(const char *buf);
...
uint16_t mlxsw_reg_pemi_tx_bias_lane0_get(const char *buf);

uint16_t mlxsw_reg_pemi_tx_bias_lane1_get(const char *buf);

uint16_t mlxsw_reg_pemi_tx_bias_lane2_get(const char *buf);

uint16_t mlxsw_reg_pemi_tx_bias_lane3_get(const char *buf);

uint16_t mlxsw_reg_pemi_tx_bias_lane4_get(const char *buf);

uint16_t mlxsw_reg_pemi_tx_bias_lane5_get(const char *buf);

uint16_t mlxsw_reg_pemi_tx_bias_lane6_get(const char *buf);

uint16_t mlxsw_reg_pemi_tx_bias_lane7_get(const char *buf);
...
uint16_t mlxsw_reg_pemi_lasers_temp_get(const char *buf);
...
uint16_t mlxsw_reg_pemi_tx_bias_high_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_tx_bias_low_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_tx_bias_high_warning_get(const char *buf);

uint16_t mlxsw_reg_pemi_tx_bias_low_warning_get(const char *buf);
