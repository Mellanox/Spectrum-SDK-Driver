...
uint8_t mlxsw_reg_hgcr_regtlve_get(const char *buf);

void mlxsw_reg_hgcr_regtlve_set(char *buf, uint8_t val);
...
uint8_t mlxsw_reg_hgcr_tac_ver_get(const char *buf);

void mlxsw_reg_hgcr_tac_ver_set(char *buf, uint8_t val);
...
uint8_t mlxsw_reg_htec_dummy_get(const char *buf);

void mlxsw_reg_htec_dummy_set(char *buf, uint8_t val);
 ...
 *
 */
#define MLXSW_HTHM_ID 0x7091
#define MLXSW_HTHM_LEN 0x8

uint16_t mlxsw_reg_hthm_trap_id_get(const char *buf);

void mlxsw_reg_hthm_trap_id_set(char *buf, uint16_t val);

uint8_t mlxsw_reg_hthm_vld_get(const char *buf);

uint16_t mlxsw_reg_hthm_hw_trap_id_get(const char *buf);

/* htgt
 * ----
 *
 */
#define MLXSW_HTGT_ID 0x7002
#define MLXSW_HTGT_LEN 0x44

uint8_t mlxsw_reg_htgt_swid_get(const char *buf);

void mlxsw_reg_htgt_swid_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_htgt_type_get(const char *buf);

void mlxsw_reg_htgt_type_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_htgt_trap_group_get(const char *buf);

void mlxsw_reg_htgt_trap_group_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_htgt_pide_get(const char *buf);

void mlxsw_reg_htgt_pide_set(char *buf, uint8_t val);

uint16_t mlxsw_reg_htgt_pid_get(const char *buf);

void mlxsw_reg_htgt_pid_set(char *buf, uint16_t val);

uint8_t mlxsw_reg_htgt_mirror_action_get(const char *buf);

void mlxsw_reg_htgt_mirror_action_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_htgt_mirror_agent_get(const char *buf);

void mlxsw_reg_htgt_mirror_agent_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_htgt_priority_get(const char *buf);

void mlxsw_reg_htgt_priority_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_htgt_cpu_tclass_get(const char *buf);

void mlxsw_reg_htgt_cpu_tclass_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_htgt_rdq_get(const char *buf);

void mlxsw_reg_htgt_rdq_set(char *buf, uint8_t val);

uint32_t mlxsw_reg_htgt_mirror_probability_rate_get(const char *buf);

void mlxsw_reg_htgt_mirror_probability_rate_set(char *buf, uint32_t val);

/* hpkt
 * ----
 *
 */
#define MLXSW_HPKT_ID 0x7003
#define MLXSW_HPKT_LEN 0x10

uint8_t mlxsw_reg_hpkt_source_get(const char *buf);

void mlxsw_reg_hpkt_source_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_hpkt_ack_get(const char *buf);

void mlxsw_reg_hpkt_ack_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_hpkt_action_get(const char *buf);

void mlxsw_reg_hpkt_action_set(char *buf, uint8_t val);

uint32_t mlxsw_reg_hpkt_trap_group_get(const char *buf);

void mlxsw_reg_hpkt_trap_group_set(char *buf, uint32_t val);

uint16_t mlxsw_reg_hpkt_trap_id_get(const char *buf);

void mlxsw_reg_hpkt_trap_id_set(char *buf, uint16_t val);

uint8_t mlxsw_reg_hpkt_ctrl_get(const char *buf);

void mlxsw_reg_hpkt_ctrl_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_hpkt_tr_prof_get(const char *buf);

void mlxsw_reg_hpkt_tr_prof_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_hpkt_tr_en_get(const char *buf);

void mlxsw_reg_hpkt_tr_en_set(char *buf, uint8_t val);
...
uint8_t mlxsw_reg_mspi_clk_dev_get(const char *buf);

void mlxsw_reg_mspi_clk_dev_set(char *buf, uint8_t val);
 ...
 *
 */
#define MLXSW_MGPCB_ID 0x9096
#define MLXSW_MGPCB_RECORD_BASE_LEN 0x10 /* base length, without records */
#define MLXSW_MGPCB_RECORD_REC_LEN 0x10 /* record length */
#define MLXSW_MGPCB_RECORD_REC_MAX_COUNT 64
#define MLXSW_MGPCB_LEN 0x410

uint32_t mlxsw_reg_mgpcb_counter_index_base_get(const char *buf);

void mlxsw_reg_mgpcb_counter_index_base_set(char *buf, uint32_t val);

uint8_t mlxsw_reg_mgpcb_num_rec_get(const char *buf);

void mlxsw_reg_mgpcb_num_rec_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_mgpcb_opcode_get(const char *buf);

void mlxsw_reg_mgpcb_opcode_set(char *buf, uint8_t val);

uint64_t mlxsw_reg_mgpcb_byte_counter_get(const char *buf, unsigned short outer_index, unsigned short index);

uint64_t mlxsw_reg_mgpcb_packet_counter_get(const char *buf, unsigned short outer_index, unsigned short index);
...
uint8_t mlxsw_reg_mgpir_num_of_modules_per_system_get(const char *buf);
...
uint16_t mlxsw_reg_mtmp_temperature_critical_threshold_hi_get(const char *buf);

void mlxsw_reg_mtmp_temperature_critical_threshold_hi_set(char *buf, uint16_t val);

uint16_t mlxsw_reg_mtmp_temperature_critical_threshold_low_get(const char *buf);

void mlxsw_reg_mtmp_temperature_critical_threshold_low_set(char *buf, uint16_t val);
...
uint8_t mlxsw_reg_mvcr_i_get(const char *buf);

void mlxsw_reg_mvcr_i_set(char *buf, uint8_t val);
...
uint16_t mlxsw_reg_mvcr_current_sensor_value_msb_get(const char *buf);
...
uint32_t mlxsw_reg_mcc_component_specific_err_code_get(const char *buf);
...
uint8_t mlxsw_reg_mgir_ib_mad_gen_get(const char *buf);
...
uint8_t mlxsw_reg_mgir_development_get(const char *buf);

uint8_t mlxsw_reg_mgir_chip_type_get(const char *buf);

uint8_t mlxsw_reg_mgir_ga_get(const char *buf);

void mlxsw_reg_mgir_manufacturing_base_mac_memcpy_from(const char *buf, char *dst);

uint32_t mlxsw_reg_mgir_device_ticks_per_msec_get(const char *buf);
...
uint8_t mlxsw_reg_mgir_fw_info_pds_get(const char *buf);

uint8_t mlxsw_reg_mgir_fw_info_issu_able_get(const char *buf);

uint8_t mlxsw_reg_mgir_fw_info_life_cycle_msb_get(const char *buf);
...
uint32_t mlxsw_reg_mini_fused_out_ports_bitmap_get(const char *buf, unsigned short outer_index, unsigned short index);
 ...
 *
 */
#define MLXSW_MMAM_ID 0x9170
#define MLXSW_MMAM_LEN 0x10

uint8_t mlxsw_reg_mmam_module_get(const char *buf);

void mlxsw_reg_mmam_module_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_mmam_ga_get(const char *buf);

uint8_t mlxsw_reg_mmam_local_module_get(const char *buf);

uint8_t mlxsw_reg_mmam_module_type_get(const char *buf);

/* mcgi
 * ----
 *
 */
#define MLXSW_MCGI_ID 0x917c
#define MLXSW_MCGI_LEN 0x34

uint8_t mlxsw_reg_mcgi_tray_index_get(const char *buf);

uint8_t mlxsw_reg_mcgi_chassis_slot_index_get(const char *buf);

uint32_t mlxsw_reg_mcgi_chassis_id_get(const char *buf, unsigned short outer_index, unsigned short index);

uint8_t mlxsw_reg_mcgi_chassis_topology_id_get(const char *buf);
 ...
 *
 */
#define MLXSW_MFCDR_ID 0x9178
#define MLXSW_MFCDR_LEN 0x8

uint8_t mlxsw_reg_mfcdr_local_port_get(const char *buf);

void mlxsw_reg_mfcdr_local_port_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_mfcdr_lp_msb_get(const char *buf);

void mlxsw_reg_mfcdr_lp_msb_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_mfcdr_status_get(const char *buf);

/* msgcr
 * -----
 *
 */
#define MLXSW_MSGCR_ID 0x9179
#define MLXSW_MSGCR_LEN 0x8

uint8_t mlxsw_reg_msgcr_fake_cable_detect_en_get(const char *buf);

void mlxsw_reg_msgcr_fake_cable_detect_en_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_msgcr_support_error_injection_get(const char *buf);

uint8_t mlxsw_reg_msgcr_support_inter_asic_block_get(const char *buf);

uint8_t mlxsw_reg_msgcr_support_perst_gpio_get(const char *buf);
...
#define MLXSW_MPCIR_LEN 0x20

uint8_t mlxsw_reg_mpcir_all_get(const char *buf);

void mlxsw_reg_mpcir_all_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_mpcir_mads_get(const char *buf);

void mlxsw_reg_mpcir_mads_set(char *buf, uint8_t val);
...
uint8_t mlxsw_reg_mpcir_mads_stat_get(const char *buf);
...
#define MLXSW_MMCR_LEN 0x50

uint32_t mlxsw_reg_mmcr_next_module_control_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_mmcr_next_module_control_set(char *buf, unsigned short outer_index, unsigned short index, uint32_t val);
...
uint32_t mlxsw_reg_mmcr_curr_module_control_get(const char *buf, unsigned short outer_index, unsigned short index);
...
uint32_t mlxsw_reg_mfri_num_normals_get(const char *buf);
...
uint16_t mlxsw_reg_mogcr_e2e_time_scale_get(const char *buf);

void mlxsw_reg_mogcr_e2e_time_scale_set(char *buf, uint16_t val);
...
uint8_t mlxsw_reg_mogcr_local_toc_fmt_get(const char *buf);

void mlxsw_reg_mogcr_local_toc_fmt_set(char *buf, uint8_t val);
 ...
 *
 */
#define MLXSW_MMGCR_ID 0x90e9
#define MLXSW_MMGCR_LEN 0x4

uint32_t mlxsw_reg_mmgcr_device_uid_get(const char *buf);

void mlxsw_reg_mmgcr_device_uid_set(char *buf, uint32_t val);
 ...
 *
 */
#define MLXSW_MONI_ID 0x90f4
#define MLXSW_MONI_LEN 0x8

uint8_t mlxsw_reg_moni_local_port_get(const char *buf);

void mlxsw_reg_moni_local_port_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_moni_lp_msb_get(const char *buf);

void mlxsw_reg_moni_lp_msb_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_moni_en_get(const char *buf);

void mlxsw_reg_moni_en_set(char *buf, uint8_t val);
...
#define MLXSW_MOCS_MOCS_PPCNT_PORT_MASK_BASE_LEN 0x20 /* base length, without records */
#define MLXSW_MOCS_MOCS_PPCNT_GRP_MASK_BASE_LEN 0x60 /* base length, without records */
#define MLXSW_MOCS_MOCS_PPCNT_GRP_PRF_BASE_LEN 0x80 /* base length, without records */
#define MLXSW_MOCS_MOCS_PPCNT_V2_GRP_MASK_BASE_LEN 0x40 /* base length, without records */
#define MLXSW_MOCS_MOCS_PPCNT_V2_GRP_PRF_BASE_LEN 0x60 /* base length, without records */
#define MLXSW_MOCS_MOCS_PPCNT_V2_PORT_MASK_BASE_LEN 0xe4 /* base length, without records */
#define MLXSW_MOCS_MOCS_PBSR_PORT_MASK_BASE_LEN 0x20 /* base length, without records */
#define MLXSW_MOCS_MOCS_PBSR_V2_PORT_MASK_BASE_LEN 0x30 /* base length, without records */
#define MLXSW_MOCS_MOCS_CEER_PORT_MASK_BASE_LEN 0x20 /* base length, without records */
#define MLXSW_MOCS_MOCS_USACN_PORT_MASK_BASE_LEN 0x20 /* base length, without records */
#define MLXSW_MOCS_MOCS_UTCC_PORT_MASK_BASE_LEN 0x20 /* base length, without records */
#define MLXSW_MOCS_MOCS_UPCNT_PORT_MASK_BASE_LEN 0x20 /* base length, without records */
#define MLXSW_MOCS_MOCS_MOFRB_FLOW_ESTIMATOR_RECORD_BASE_LEN 0x20 /* base length, without records */
#define MLXSW_MOCS_MOCS_RARFTBR_JOB_BASE_LEN 0x24 /* base length, without records */
...
#define MLXSW_MOCS_JOB_REC_LEN 0x04 /* record length */
#define MLXSW_MOCS_JOB_REC_MAX_COUNT 1
#define MLXSW_MOCS_LEN 0xe8
...
uint8_t mlxsw_reg_mocs_iter_mode_get(const char *buf);

void mlxsw_reg_mocs_iter_mode_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_mocs_min_iter_time_get(const char *buf);

void mlxsw_reg_mocs_min_iter_time_set(char *buf, uint8_t val);

uint16_t mlxsw_reg_mocs_num_of_iter_get(const char *buf);

void mlxsw_reg_mocs_num_of_iter_set(char *buf, uint16_t val);

uint8_t mlxsw_reg_mocs_metadata_get(const char *buf);

void mlxsw_reg_mocs_metadata_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_mocs_iter_md_op_get(const char *buf);

void mlxsw_reg_mocs_iter_md_op_set(char *buf, uint8_t val);
...
uint32_t mlxsw_reg_mocs_mocs_ppcnt_v2_grp_mask_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_mocs_mocs_ppcnt_v2_grp_mask_set(char *buf, unsigned short outer_index, unsigned short index, uint32_t val);

uint32_t mlxsw_reg_mocs_mocs_ppcnt_v2_tc_mask_get(const char *buf);

void mlxsw_reg_mocs_mocs_ppcnt_v2_tc_mask_set(char *buf, uint32_t val);

uint16_t mlxsw_reg_mocs_mocs_ppcnt_v2_prio_mask_get(const char *buf);

void mlxsw_reg_mocs_mocs_ppcnt_v2_prio_mask_set(char *buf, uint16_t val);

uint16_t mlxsw_reg_mocs_mocs_ppcnt_v2_rx_buffer_mask_get(const char *buf);

void mlxsw_reg_mocs_mocs_ppcnt_v2_rx_buffer_mask_set(char *buf, uint16_t val);

uint32_t mlxsw_reg_mocs_mocs_ppcnt_v2_grp_prf_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_mocs_mocs_ppcnt_v2_grp_prf_set(char *buf, unsigned short outer_index, unsigned short index, uint32_t val);

uint8_t mlxsw_reg_mocs_mocs_ppcnt_v2_port_bitmap_size_get(const char *buf);

void mlxsw_reg_mocs_mocs_ppcnt_v2_port_bitmap_size_set(char *buf, uint8_t val);

uint32_t mlxsw_reg_mocs_mocs_ppcnt_v2_port_mask_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_mocs_mocs_ppcnt_v2_port_mask_set(char *buf, unsigned short outer_index, unsigned short index, uint32_t val);
...
uint8_t mlxsw_reg_mocs_mocs_pbsr_v2_bitmap_size_get(const char *buf);

void mlxsw_reg_mocs_mocs_pbsr_v2_bitmap_size_set(char *buf, uint8_t val);

uint32_t mlxsw_reg_mocs_mocs_pbsr_v2_port_mask_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_mocs_mocs_pbsr_v2_port_mask_set(char *buf, unsigned short outer_index, unsigned short index, uint32_t val);
...
uint64_t mlxsw_reg_mocs_user_cookie_get(const char *buf);

void mlxsw_reg_mocs_user_cookie_set(char *buf, uint64_t val);

uint16_t mlxsw_reg_mocs_num_job_get(const char *buf);

void mlxsw_reg_mocs_num_job_set(char *buf, uint16_t val);

uint8_t mlxsw_reg_mocs_num_rec_log_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_mocs_num_rec_log_set(char *buf, unsigned short outer_index, unsigned short index, uint8_t val);

uint32_t mlxsw_reg_mocs_arft_index_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_mocs_arft_index_set(char *buf, unsigned short outer_index, unsigned short index, uint32_t val);
...
#define MLXSW_MAFBI_MAFBI_ENTRY_TYPE0_RECORD_BASE_LEN 0x08 /* base length, without records */
 ...
 *
 */
#define MLXSW_MOPCT_ID 0x90e1
#define MLXSW_MOPCT_LEN 0x38

uint8_t mlxsw_reg_mopct_cnt_grp_id_get(const char *buf);

void mlxsw_reg_mopct_cnt_grp_id_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_mopct_entry_index_get(const char *buf);

void mlxsw_reg_mopct_entry_index_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_mopct_num_active_counters_get(const char *buf);

void mlxsw_reg_mopct_num_active_counters_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_mopct_op_get(const char *buf);

void mlxsw_reg_mopct_op_set(char *buf, uint8_t val);

uint16_t mlxsw_reg_mopct_hw_unit_id_get(const char *buf);

void mlxsw_reg_mopct_hw_unit_id_set(char *buf, uint16_t val);

uint8_t mlxsw_reg_mopct_force_get(const char *buf);

void mlxsw_reg_mopct_force_set(char *buf, uint8_t val);

uint16_t mlxsw_reg_mopct_enabled_counters_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_mopct_enabled_counters_set(char *buf, unsigned short outer_index, unsigned short index, uint16_t val);

/* mopcs
 * -----
 *
 */
#define MLXSW_MOPCS_ID 0x90ea
#define MLXSW_MOPCS_LEN 0x1c

uint8_t mlxsw_reg_mopcs_local_port_get(const char *buf);

void mlxsw_reg_mopcs_local_port_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_mopcs_lp_msb_get(const char *buf);

void mlxsw_reg_mopcs_lp_msb_set(char *buf, uint8_t val);

uint16_t mlxsw_reg_mopcs_dcp_index_get(const char *buf);

uint16_t mlxsw_reg_mopcs_kvc_index_get(const char *buf);

uint16_t mlxsw_reg_mopcs_plu_index_get(const char *buf);

uint16_t mlxsw_reg_mopcs_dcm_index_get(const char *buf);

uint16_t mlxsw_reg_mopcs_ptb_index_get(const char *buf);

uint16_t mlxsw_reg_mopcs_llu_index_get(const char *buf);

uint16_t mlxsw_reg_mopcs_tile_index_get(const char *buf);

uint16_t mlxsw_reg_mopcs_tile_plt_index_get(const char *buf);

uint16_t mlxsw_reg_mopcs_dcp_sub_index_get(const char *buf);

uint16_t mlxsw_reg_mopcs_dcm_sub_index_get(const char *buf);

uint16_t mlxsw_reg_mopcs_ptb_sub_index_get(const char *buf);

uint16_t mlxsw_reg_mopcs_llu_sub_index_get(const char *buf);

/* mopgcr
 * ------
 *
 */
#define MLXSW_MOPGCR_ID 0x90e0
#define MLXSW_MOPGCR_LEN 0x8

uint32_t mlxsw_reg_mopgcr_perf_cnt_interval_get(const char *buf);

void mlxsw_reg_mopgcr_perf_cnt_interval_set(char *buf, uint32_t val);

/* moftc
 * -----
 *
 */
#define MLXSW_MOFTC_ID 0x9400
#define MLXSW_MOFTC_LEN 0x108

uint8_t mlxsw_reg_moftc_clear_mbo_get(const char *buf);

void mlxsw_reg_moftc_clear_mbo_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_moftc_prio_bitmask_get(const char *buf);

void mlxsw_reg_moftc_prio_bitmask_set(char *buf, uint8_t val);

uint32_t mlxsw_reg_moftc_tc_bitmask_get(const char *buf);

void mlxsw_reg_moftc_tc_bitmask_set(char *buf, uint32_t val);

uint16_t mlxsw_reg_moftc_pg_bitmask_get(const char *buf);

void mlxsw_reg_moftc_pg_bitmask_set(char *buf, uint16_t val);

uint32_t mlxsw_reg_moftc_metadata_bitmask_get(const char *buf);

void mlxsw_reg_moftc_metadata_bitmask_set(char *buf, uint32_t val);

uint32_t mlxsw_reg_moftc_global_counters_bitmask_get(const char *buf);

void mlxsw_reg_moftc_global_counters_bitmask_set(char *buf, uint32_t val);

uint64_t mlxsw_reg_moftc_port_counters_bitmask_get(const char *buf);

void mlxsw_reg_moftc_port_counters_bitmask_set(char *buf, uint64_t val);

uint32_t mlxsw_reg_moftc_flow_counter_base_0_get(const char *buf);

void mlxsw_reg_moftc_flow_counter_base_0_set(char *buf, uint32_t val);

uint16_t mlxsw_reg_moftc_flow_counter_num_0_get(const char *buf);

void mlxsw_reg_moftc_flow_counter_num_0_set(char *buf, uint16_t val);

uint32_t mlxsw_reg_moftc_flow_counter_base_1_get(const char *buf);

void mlxsw_reg_moftc_flow_counter_base_1_set(char *buf, uint32_t val);

uint16_t mlxsw_reg_moftc_flow_counter_num_1_get(const char *buf);

void mlxsw_reg_moftc_flow_counter_num_1_set(char *buf, uint16_t val);

uint8_t mlxsw_reg_moftc_bitmap_size_get(const char *buf);

void mlxsw_reg_moftc_bitmap_size_set(char *buf, uint8_t val);

uint32_t mlxsw_reg_moftc_moftc_bitmap512_port_bitmask_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_moftc_moftc_bitmap512_port_bitmask_set(char *buf, unsigned short outer_index, unsigned short index, uint32_t val);

uint32_t mlxsw_reg_moftc_moftc_bitmap512_port_bitmask_actual_get(const char *buf, unsigned short outer_index, unsigned short index);

uint32_t mlxsw_reg_moftc_moftc_bitmap544_port_bitmask_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_moftc_moftc_bitmap544_port_bitmask_set(char *buf, unsigned short outer_index, unsigned short index, uint32_t val);

uint32_t mlxsw_reg_moftc_moftc_bitmap544_port_bitmask_actual_get(const char *buf, unsigned short outer_index, unsigned short index);

/* moftd
 * -----
 *
 */
#define MLXSW_MOFTD_ID 0x9401
#define MLXSW_MOFTD_LEN 0x24

uint16_t mlxsw_reg_moftd_num_rec_get(const char *buf);

uint16_t mlxsw_reg_moftd_itr_index_get(const char *buf);

uint32_t mlxsw_reg_moftd_num_entries_in_itr_get(const char *buf);

uint32_t mlxsw_reg_moftd_entry_index_get(const char *buf);

uint16_t mlxsw_reg_moftd_first_port_in_chunk_get(const char *buf);

uint16_t mlxsw_reg_moftd_num_entries_per_port_get(const char *buf);

uint64_t mlxsw_reg_moftd_user_cookie_get(const char *buf);

uint32_t mlxsw_reg_moftd_entry_get(const char *buf, unsigned short outer_index, unsigned short index);
...
uint8_t mlxsw_reg_mtpcpc_egr_phbw_get(const char *buf);

void mlxsw_reg_mtpcpc_egr_phbw_set(char *buf, uint8_t val);
...
uint16_t mlxsw_reg_mtpcpc_ptp_pkey_get(const char *buf);

void mlxsw_reg_mtpcpc_ptp_pkey_set(char *buf, uint16_t val);
...
uint8_t mlxsw_reg_mfgd_immediate_interface_release_on_timeout_get(const char *buf);

void mlxsw_reg_mfgd_immediate_interface_release_on_timeout_set(char *buf, uint8_t val);
 ...
 *
 */
#define MLXSW_MIFGD_ID 0x90fa
#define MLXSW_MIFGD_LEN 0x28

uint8_t mlxsw_reg_mifgd_rif_cache_add_flow_disable_get(const char *buf);

void mlxsw_reg_mifgd_rif_cache_add_flow_disable_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_mifgd_rif_cache_update_flow_disable_get(const char *buf);

void mlxsw_reg_mifgd_rif_cache_update_flow_disable_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_mifgd_rif_cache_phase_update_get(const char *buf);

void mlxsw_reg_mifgd_rif_cache_phase_update_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_mifgd_rif_cache_phase_get(const char *buf);

void mlxsw_reg_mifgd_rif_cache_phase_set(char *buf, uint8_t val);

void mlxsw_reg_mifgd_trigger_emad_pipeline_jam_set(char *buf, uint8_t val);

void mlxsw_reg_mifgd_trigger_stack_ovf_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_mifgd_caches_flush_get(const char *buf);

void mlxsw_reg_mifgd_caches_flush_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_mifgd_code_cache_cnt_disable_get(const char *buf);

void mlxsw_reg_mifgd_code_cache_cnt_disable_set(char *buf, uint8_t val);

void mlxsw_reg_mifgd_tcr_debug_enable_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_mifgd_caches_enable_get(const char *buf);

void mlxsw_reg_mifgd_caches_enable_set(char *buf, uint8_t val);

void mlxsw_reg_mifgd_port_init_single_cpu_set(char *buf, uint8_t val);

void mlxsw_reg_mifgd_restore_acl_group_elements_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_mifgd_enable_invalid_fatal_cause_event_get(const char *buf);

void mlxsw_reg_mifgd_enable_invalid_fatal_cause_event_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_mifgd_atcam_bf_enable_get(const char *buf);

void mlxsw_reg_mifgd_atcam_bf_enable_set(char *buf, uint8_t val);

uint16_t mlxsw_reg_mifgd_blocks_egress_enable_get(const char *buf);

void mlxsw_reg_mifgd_blocks_egress_enable_set(char *buf, uint16_t val);

uint32_t mlxsw_reg_mifgd_fw_init_total_time_get(const char *buf);

uint32_t mlxsw_reg_mifgd_fw_init_open_ports_time_get(const char *buf);

uint32_t mlxsw_reg_mifgd_boot_time_get(const char *buf);

uint32_t mlxsw_reg_mifgd_init_tiles_time_get(const char *buf);

uint32_t mlxsw_reg_mifgd_init_phy_power_time_get(const char *buf);

uint32_t mlxsw_reg_mifgd_init_usr_algo_time_get(const char *buf);

uint32_t mlxsw_reg_mifgd_init_gearbox_time_get(const char *buf);

uint8_t mlxsw_reg_mifgd_boot_mode_get(const char *buf);
...
uint8_t mlxsw_reg_mfde_crspace_timeout_tile_v_get(const char *buf);

uint8_t mlxsw_reg_mfde_crspace_timeout_tile_index_get(const char *buf);
...
uint64_t mlxsw_reg_mfde_mepc_get(const char *buf);

uint64_t mlxsw_reg_mfde_mcause_get(const char *buf);

uint64_t mlxsw_reg_mfde_mtval_get(const char *buf);
...
uint16_t mlxsw_reg_iicr_clear_acl_group_ids_value_get(const char *buf);

void mlxsw_reg_iicr_clear_acl_group_ids_value_set(char *buf, uint16_t val);

uint16_t mlxsw_reg_iicr_clear_acl_group_ids_mask_get(const char *buf);

void mlxsw_reg_iicr_clear_acl_group_ids_mask_set(char *buf, uint16_t val);

uint16_t mlxsw_reg_iicr_clear_acl_group_elements_value_get(const char *buf);

void mlxsw_reg_iicr_clear_acl_group_elements_value_set(char *buf, uint16_t val);

uint16_t mlxsw_reg_iicr_clear_acl_group_elements_mask_get(const char *buf);

void mlxsw_reg_iicr_clear_acl_group_elements_mask_set(char *buf, uint16_t val);
...
uint8_t mlxsw_reg_smpeb_type_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_smpeb_type_set(char *buf, unsigned short outer_index, unsigned short index, uint8_t val);
...
uint32_t mlxsw_reg_spzr_v_key_h_get(const char *buf);

void mlxsw_reg_spzr_v_key_h_set(char *buf, uint32_t val);

uint32_t mlxsw_reg_spzr_v_key_l_get(const char *buf);

void mlxsw_reg_spzr_v_key_l_set(char *buf, uint32_t val);
...
uint8_t mlxsw_reg_spzr_infrastructure_ip_type_get(const char *buf);

uint32_t mlxsw_reg_spzr_infrastructure_ip_get(const char *buf);
 ...
 *
 */
#define MLXSW_IBISSU_ID 0x6006
#define MLXSW_IBISSU_LEN 0x4

uint8_t mlxsw_reg_ibissu_sm_approve_get(const char *buf);

uint8_t mlxsw_reg_ibissu_req_to_sm_get(const char *buf);

void mlxsw_reg_ibissu_req_to_sm_set(char *buf, uint8_t val);

/* pcam
 * ----
 *
 */
#define MLXSW_PCAM_ID 0x507f
#define MLXSW_PCAM_LEN 0x50

uint8_t mlxsw_reg_pcam_feature_group_get(const char *buf);

void mlxsw_reg_pcam_feature_group_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pcam_pl_op_get(const char *buf);

void mlxsw_reg_pcam_pl_op_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pcam_access_reg_group_get(const char *buf);

void mlxsw_reg_pcam_access_reg_group_set(char *buf, uint8_t val);

uint32_t mlxsw_reg_pcam_port_access_reg_cap_mask_get(const char *buf, unsigned short outer_index, unsigned short index);

uint32_t mlxsw_reg_pcam_feature_cap_mask_get(const char *buf, unsigned short outer_index, unsigned short index);
...
uint8_t mlxsw_reg_ptys_dis_optic_neg_admin_get(const char *buf);

void mlxsw_reg_ptys_dis_optic_neg_admin_set(char *buf, uint8_t val);
...
uint32_t mlxsw_reg_ptys_ext_ib_proto_cap_ptys_ext_proto_ib_ext_proto_ib_get(const char *buf);

uint32_t mlxsw_reg_ptys_ext_ib_proto_cap_ext_proto_nvlink_get(const char *buf);

uint32_t mlxsw_reg_ptys_ext_ib_proto_admin_ptys_ext_proto_ib_ext_proto_ib_get(const char *buf);

uint32_t mlxsw_reg_ptys_ext_ib_proto_admin_ext_proto_nvlink_get(const char *buf);

uint32_t mlxsw_reg_ptys_ext_ib_proto_oper_ptys_ext_proto_ib_ext_proto_ib_get(const char *buf);

uint32_t mlxsw_reg_ptys_ext_ib_proto_oper_ext_proto_nvlink_get(const char *buf);
 ...
 *
 */
#define MLXSW_PLTC_ID 0x5046
#define MLXSW_PLTC_LEN 0x10

uint8_t mlxsw_reg_pltc_local_port_get(const char *buf);

void mlxsw_reg_pltc_local_port_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pltc_pnat_get(const char *buf);

void mlxsw_reg_pltc_pnat_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pltc_lp_msb_get(const char *buf);

void mlxsw_reg_pltc_lp_msb_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pltc_lane_mask_get(const char *buf);

void mlxsw_reg_pltc_lane_mask_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pltc_gray_rx_cap_get(const char *buf);

uint8_t mlxsw_reg_pltc_gray_tx_cap_get(const char *buf);

uint8_t mlxsw_reg_pltc_ph_pol_rx_cap_get(const char *buf);

uint8_t mlxsw_reg_pltc_ph_pol_tx_cap_get(const char *buf);

uint8_t mlxsw_reg_pltc_precoding_cap_mask_get(const char *buf);

uint8_t mlxsw_reg_pltc_gray_rx_admin_get(const char *buf);

void mlxsw_reg_pltc_gray_rx_admin_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pltc_gray_tx_admin_get(const char *buf);

void mlxsw_reg_pltc_gray_tx_admin_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pltc_ph_pol_rx_admin_get(const char *buf);

uint8_t mlxsw_reg_pltc_ph_pol_tx_admin_get(const char *buf);

uint8_t mlxsw_reg_pltc_local_rx_precoding_admin_get(const char *buf);

void mlxsw_reg_pltc_local_rx_precoding_admin_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pltc_local_tx_precoding_admin_get(const char *buf);

void mlxsw_reg_pltc_local_tx_precoding_admin_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pltc_gray_rx_oper_get(const char *buf);

uint8_t mlxsw_reg_pltc_gray_tx_oper_get(const char *buf);

uint8_t mlxsw_reg_pltc_local_rx_precoding_oper_get(const char *buf);

uint8_t mlxsw_reg_pltc_local_tx_precoding_oper_get(const char *buf);
...
uint8_t mlxsw_reg_ppcnt_counters_cap_get(const char *buf);

void mlxsw_reg_ppcnt_counters_cap_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_ppcnt_plane_ind_get(const char *buf);

void mlxsw_reg_ppcnt_plane_ind_set(char *buf, uint8_t val);
...
uint32_t mlxsw_reg_ppcnt_egress_link_down_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_egress_link_down_low_get(const char *buf);
...
uint32_t mlxsw_reg_ppcnt_phys_layer_cntrs_rs_fec_total_blocks_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_phys_layer_cntrs_rs_fec_total_blocks_low_get(const char *buf);
...
uint16_t mlxsw_reg_ppcnt_phys_layer_stat_cntrs_fc_zero_hist_get(const char *buf);
...
uint8_t mlxsw_reg_ppcnt_phys_layer_stat_cntrs_estimated_effective_ber_magnitude_get(const char *buf);

uint8_t mlxsw_reg_ppcnt_phys_layer_stat_cntrs_estimated_effective_ber_coef_float_get(const char *buf);

uint8_t mlxsw_reg_ppcnt_phys_layer_stat_cntrs_estimated_effective_ber_coef_get(const char *buf);
...
uint32_t mlxsw_reg_ppcnt_ppcnt_infiniband_packets_counter_port_llu_rx_icrc_error_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_ppcnt_infiniband_packets_counter_port_llu_rx_icrc_error_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_ppcnt_infiniband_packets_counter_port_tx_parity_error_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_ppcnt_infiniband_packets_counter_port_tx_parity_error_low_get(const char *buf);
...
uint32_t mlxsw_reg_ppcnt_general_receive_discard_external_contain_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_general_receive_discard_external_contain_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_port_receive_poison_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_port_receive_poison_low_get(const char *buf);
...
uint32_t mlxsw_reg_ppcnt_ppcnt_l1_general_counters_l1_total_entries_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_ppcnt_l1_general_counters_l1_total_entries_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_ppcnt_l1_general_counters_l1_total_local_exits_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_ppcnt_l1_general_counters_l1_total_local_exits_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_ppcnt_l1_general_counters_l1_total_exits_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_ppcnt_l1_general_counters_l1_total_exits_low_get(const char *buf);

uint16_t mlxsw_reg_ppcnt_ppcnt_l1_general_counters_relative_high_speed_steady_state_time_get(const char *buf);

uint16_t mlxsw_reg_ppcnt_ppcnt_l1_general_counters_relative_l1_steady_state_time_get(const char *buf);

uint16_t mlxsw_reg_ppcnt_ppcnt_l1_general_counters_relative_other_state_time_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_r_9_16_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_r_9_16_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_r_17_32_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_r_17_32_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_r_33_64_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_r_33_64_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_r_65_127_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_r_65_127_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_r_128_255_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_r_128_255_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_r_256_511_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_r_256_511_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_r_512_1023_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_r_512_1023_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_r_1024_1518_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_r_1024_1518_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_r_1519_2047_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_r_1519_2047_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_r_2048_4095_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_r_2048_4095_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_r_4096_8191_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_r_4096_8191_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_r_mtu_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_r_mtu_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_t_9_16_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_t_9_16_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_t_17_32_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_t_17_32_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_t_33_64_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_t_33_64_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_t_65_127_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_t_65_127_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_t_128_255_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_t_128_255_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_t_256_511_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_t_256_511_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_t_512_1023_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_t_512_1023_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_t_1024_1518_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_t_1024_1518_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_t_1519_2047_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_t_1519_2047_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_t_2048_4095_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_t_2048_4095_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_t_4096_8191_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_t_4096_8191_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_t_mtu_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_cnt_t_mtu_low_get(const char *buf);
 ...
 *
 */
#define MLXSW_PUDE_ID 0x5009
#define MLXSW_PUDE_LEN 0x10

uint8_t mlxsw_reg_pude_swid_get(const char *buf);

void mlxsw_reg_pude_swid_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pude_local_port_get(const char *buf);

void mlxsw_reg_pude_local_port_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pude_lp_msb_get(const char *buf);

void mlxsw_reg_pude_lp_msb_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pude_admin_status_get(const char *buf);

uint8_t mlxsw_reg_pude_oper_status_get(const char *buf);

uint8_t mlxsw_reg_pude_local_reason_opcode_get(const char *buf);

uint8_t mlxsw_reg_pude_logical_state_status_get(const char *buf);

uint8_t mlxsw_reg_pude_physical_state_status_get(const char *buf);
...
void mlxsw_reg_pmmp_apply_im_set(char *buf, uint8_t val);
...
uint8_t mlxsw_reg_pmmp_bit_rate_get(const char *buf);

void mlxsw_reg_pmmp_bit_rate_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pmmp_cable_technology_get(const char *buf);

void mlxsw_reg_pmmp_cable_technology_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pmmp_tengig_ethernet_compliance_code_get(const char *buf);

void mlxsw_reg_pmmp_tengig_ethernet_compliance_code_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pmmp_ext_ethernet_compliance_code_get(const char *buf);

void mlxsw_reg_pmmp_ext_ethernet_compliance_code_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pmmp_ethernet_compliance_code_get(const char *buf);

void mlxsw_reg_pmmp_ethernet_compliance_code_set(char *buf, uint8_t val);
...
uint8_t mlxsw_reg_pmmp_attenuation_53g_get(const char *buf);

void mlxsw_reg_pmmp_attenuation_53g_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pmmp_module_identifier_get(const char *buf);

void mlxsw_reg_pmmp_module_identifier_set(char *buf, uint8_t val);
...
uint8_t mlxsw_reg_pmcr_dir_dp_ctrl_get(const char *buf);

void mlxsw_reg_pmcr_dir_dp_ctrl_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pmcr_dir_tx_dis_ctrl_get(const char *buf);

void mlxsw_reg_pmcr_dir_tx_dis_ctrl_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pmcr_dir_dp_ctrl_cap_get(const char *buf);

uint8_t mlxsw_reg_pmcr_dir_tx_dis_ctrl_cap_get(const char *buf);
...
uint8_t mlxsw_reg_sltp_sltp_7nm_ph_pol_admin_get(const char *buf);

void mlxsw_reg_sltp_sltp_7nm_ph_pol_admin_set(char *buf, uint8_t val);
...
uint8_t mlxsw_reg_sltp_sltp_5nm_ph_pol_admin_get(const char *buf);

void mlxsw_reg_sltp_sltp_5nm_ph_pol_admin_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_sltp_sltp_5nm_drv_amp_get(const char *buf);

void mlxsw_reg_sltp_sltp_5nm_drv_amp_set(char *buf, uint8_t val);

uint16_t mlxsw_reg_sltp_sltp_5nm_ob_bad_stat_get(const char *buf);

uint8_t mlxsw_reg_sltp_sltp_5nm_tap3_get(const char *buf);

void mlxsw_reg_sltp_sltp_5nm_tap3_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_sltp_sltp_5nm_tap2_get(const char *buf);

void mlxsw_reg_sltp_sltp_5nm_tap2_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_sltp_sltp_5nm_tap1_get(const char *buf);

void mlxsw_reg_sltp_sltp_5nm_tap1_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_sltp_sltp_5nm_tap0_get(const char *buf);

void mlxsw_reg_sltp_sltp_5nm_tap0_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_sltp_sltp_5nm_tap7_get(const char *buf);

void mlxsw_reg_sltp_sltp_5nm_tap7_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_sltp_sltp_5nm_tap6_get(const char *buf);

void mlxsw_reg_sltp_sltp_5nm_tap6_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_sltp_sltp_5nm_tap5_get(const char *buf);

void mlxsw_reg_sltp_sltp_5nm_tap5_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_sltp_sltp_5nm_tap4_get(const char *buf);

void mlxsw_reg_sltp_sltp_5nm_tap4_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_sltp_sltp_5nm_tap11_get(const char *buf);

void mlxsw_reg_sltp_sltp_5nm_tap11_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_sltp_sltp_5nm_tap10_get(const char *buf);

void mlxsw_reg_sltp_sltp_5nm_tap10_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_sltp_sltp_5nm_tap9_get(const char *buf);

void mlxsw_reg_sltp_sltp_5nm_tap9_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_sltp_sltp_5nm_tap8_get(const char *buf);

void mlxsw_reg_sltp_sltp_5nm_tap8_set(char *buf, uint8_t val);
...
uint8_t mlxsw_reg_ptasv2_xdr_lt_cap_get(const char *buf);
...
uint8_t mlxsw_reg_ptasv2_lt_neg_support_get(const char *buf);

void mlxsw_reg_ptasv2_lt_neg_support_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_ptasv2_hdr_lt_c2c_en_get(const char *buf);

void mlxsw_reg_ptasv2_hdr_lt_c2c_en_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_ptasv2_ndr_lt_c2c_en_get(const char *buf);

void mlxsw_reg_ptasv2_ndr_lt_c2c_en_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_ptasv2_xdr_lt_c2m_en_get(const char *buf);

void mlxsw_reg_ptasv2_xdr_lt_c2m_en_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_ptasv2_xdr_lt_c2c_en_get(const char *buf);

void mlxsw_reg_ptasv2_xdr_lt_c2c_en_set(char *buf, uint8_t val);
...
uint8_t mlxsw_reg_ptasv2_module_type_bkv_cap_get(const char *buf);

uint8_t mlxsw_reg_ptasv2_lt_timers_override_cap_get(const char *buf);

uint8_t mlxsw_reg_ptasv2_module_type_bkv_admin_get(const char *buf);

void mlxsw_reg_ptasv2_module_type_bkv_admin_set(char *buf, uint8_t val);

uint32_t mlxsw_reg_ptasv2_module_type_bkv_oper_get(const char *buf);
...
uint8_t mlxsw_reg_ptasv2_lt_watchdog_timeout_get(const char *buf);

void mlxsw_reg_ptasv2_lt_watchdog_timeout_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_ptasv2_lt_frame_lock_timeout_get(const char *buf);

void mlxsw_reg_ptasv2_lt_frame_lock_timeout_set(char *buf, uint8_t val);
...
uint32_t mlxsw_reg_pddr_phy_manager_disable_mask_get(const char *buf);
...
uint8_t mlxsw_reg_pddr_pddr_port_events_page_layout_merger_tx_eb_underrun_get(const char *buf);

uint8_t mlxsw_reg_pddr_pddr_port_events_page_layout_bubble_in_pkt_get(const char *buf);
...
uint8_t mlxsw_reg_pddr_mean_est_eff_ber_coef_get(const char *buf);

uint8_t mlxsw_reg_pddr_mean_est_eff_ber_magnitude_get(const char *buf);

uint8_t mlxsw_reg_pddr_min_est_eff_ber_coef_get(const char *buf);

uint8_t mlxsw_reg_pddr_min_est_eff_ber_magnitude_get(const char *buf);

uint8_t mlxsw_reg_pddr_max_est_eff_ber_coef_get(const char *buf);

uint8_t mlxsw_reg_pddr_max_est_eff_ber_magnitude_get(const char *buf);

uint16_t mlxsw_reg_pddr_num_of_est_eff_ber_warnings_get(const char *buf);

uint16_t mlxsw_reg_pddr_num_of_est_eff_ber_alarms_get(const char *buf);
...
uint16_t mlxsw_reg_pddr_pport_second_get(const char *buf);

void mlxsw_reg_pddr_pport_second_set(char *buf, uint16_t val);

uint8_t mlxsw_reg_pddr_second_port_valid_get(const char *buf);

void mlxsw_reg_pddr_second_port_valid_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pddr_trigger_cond_port_get(const char *buf);

void mlxsw_reg_pddr_trigger_cond_port_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pddr_revision_get(const char *buf);

uint32_t mlxsw_reg_pddr_page_size_get(const char *buf);

uint8_t mlxsw_reg_pddr_page_index_get(const char *buf);

void mlxsw_reg_pddr_page_index_set(char *buf, uint8_t val);

uint32_t mlxsw_reg_pddr_tracer_data_entry_get(const char *buf, unsigned short outer_index, unsigned short index);
...
uint8_t mlxsw_reg_pddr_bubble_agreement_get(const char *buf);
 ...
 *
 */
#define MLXSW_PNLPNR_ID 0x50ea
#define MLXSW_PNLPNR_LEN 0x120

uint8_t mlxsw_reg_pnlpnr_local_port_get(const char *buf);

void mlxsw_reg_pnlpnr_local_port_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pnlpnr_lp_msb_get(const char *buf);

void mlxsw_reg_pnlpnr_lp_msb_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pnlpnr_nlpn_v_get(const char *buf);

uint8_t mlxsw_reg_pnlpnr_link_up_get(const char *buf);

uint8_t mlxsw_reg_pnlpnr_nlpn_rev_get(const char *buf);

uint64_t mlxsw_reg_pnlpnr_page_req_get(const char *buf);

void mlxsw_reg_pnlpnr_page_req_set(char *buf, uint64_t val);

uint64_t mlxsw_reg_pnlpnr_page_valid_get(const char *buf);

uint32_t mlxsw_reg_pnlpnr_pages_get(const char *buf, unsigned short outer_index, unsigned short index);
...
uint8_t mlxsw_reg_pprt_msb_lsb_cnt_c_get(const char *buf);

uint8_t mlxsw_reg_pprt_ph_p_c_get(const char *buf);
...
uint8_t mlxsw_reg_pprt_msb_lsb_cnt_get(const char *buf);

void mlxsw_reg_pprt_msb_lsb_cnt_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pprt_ph_p_get(const char *buf);

void mlxsw_reg_pprt_ph_p_set(char *buf, uint8_t val);
...
uint8_t mlxsw_reg_pprt_prbs_hist_fec_int_get(const char *buf);

void mlxsw_reg_pprt_prbs_hist_fec_int_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pprt_prbs_hist_en_get(const char *buf);

void mlxsw_reg_pprt_prbs_hist_en_set(char *buf, uint8_t val);
...
uint8_t mlxsw_reg_pmdr_plane_ind_get(const char *buf);

void mlxsw_reg_pmdr_plane_ind_set(char *buf, uint8_t val);
...
uint8_t mlxsw_reg_pmdr_tile_pport_msb_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lbp_query_msb_get(const char *buf);
...
uint8_t mlxsw_reg_pmdr_pll_cnt_rx_get(const char *buf);
...
uint8_t mlxsw_reg_pmdr_pll_cnt_tx_get(const char *buf);
...
uint8_t mlxsw_reg_pmdr_lane7_ph_tx_msb_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane6_ph_tx_msb_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane5_ph_tx_msb_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane4_ph_tx_msb_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane3_ph_tx_msb_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane2_ph_tx_msb_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane1_ph_tx_msb_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane0_ph_tx_msb_get(const char *buf);

void mlxsw_reg_pmdr_lane0_ph_tx_msb_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pmdr_lane7_ph_rx_msb_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane6_ph_rx_msb_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane5_ph_rx_msb_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane4_ph_rx_msb_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane3_ph_rx_msb_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane2_ph_rx_msb_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane1_ph_rx_msb_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane0_ph_rx_msb_get(const char *buf);

uint8_t mlxsw_reg_pmdr_ph_cluster_tx_cnt_get(const char *buf);

uint8_t mlxsw_reg_pmdr_ph_cluster_rx_cnt_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane7_cluster_tx_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane6_cluster_tx_get(const char *buf);

uint32_t mlxsw_reg_pmdr_lane5_cluster_tx_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane4_cluster_tx_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane3_cluster_tx_get(const char *buf);

uint16_t mlxsw_reg_pmdr_lane2_cluster_tx_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane1_cluster_tx_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane0_cluster_tx_get(const char *buf);

uint8_t mlxsw_reg_pmdr_pll_index_rx_get(const char *buf);

void mlxsw_reg_pmdr_pll_index_rx_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pmdr_lane7_cluster_rx_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane6_cluster_rx_get(const char *buf);

uint32_t mlxsw_reg_pmdr_lane5_cluster_rx_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane4_cluster_rx_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane3_cluster_rx_get(const char *buf);

uint16_t mlxsw_reg_pmdr_lane2_cluster_rx_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane1_cluster_rx_get(const char *buf);

uint8_t mlxsw_reg_pmdr_lane0_cluster_rx_get(const char *buf);
...
uint8_t mlxsw_reg_pphcr_port_type_get(const char *buf);

void mlxsw_reg_pphcr_port_type_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pphcr_plane_ind_get(const char *buf);

void mlxsw_reg_pphcr_plane_ind_set(char *buf, uint8_t val);
 ...
 *
 */
#define MLXSW_PPBME_ID 0x5053
#define MLXSW_PPBME_LEN 0x10

uint8_t mlxsw_reg_ppbme_local_port_get(const char *buf);

void mlxsw_reg_ppbme_local_port_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_ppbme_pnat_get(const char *buf);

void mlxsw_reg_ppbme_pnat_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_ppbme_lp_msb_get(const char *buf);

void mlxsw_reg_ppbme_lp_msb_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_ppbme_monitor_type_get(const char *buf);

uint8_t mlxsw_reg_ppbme_port_type_get(const char *buf);

void mlxsw_reg_ppbme_port_type_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_ppbme_ievent_get(const char *buf);

void mlxsw_reg_ppbme_ievent_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_ppbme_monitor_state_get(const char *buf);

uint8_t mlxsw_reg_ppbme_peer_monitor_state_get(const char *buf);

/* prtl
 * ----
 *
 */
#define MLXSW_PRTL_ID 0x5014
#define MLXSW_PRTL_LEN 0x20

uint8_t mlxsw_reg_prtl_rtt_support_get(const char *buf);

uint8_t mlxsw_reg_prtl_local_port_get(const char *buf);

void mlxsw_reg_prtl_local_port_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_prtl_pnat_get(const char *buf);

void mlxsw_reg_prtl_pnat_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_prtl_lp_msb_get(const char *buf);

void mlxsw_reg_prtl_lp_msb_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_prtl_latency_res_get(const char *buf);

uint8_t mlxsw_reg_prtl_latency_accuracy_get(const char *buf);

uint16_t mlxsw_reg_prtl_local_phy_latency_get(const char *buf);

uint16_t mlxsw_reg_prtl_local_mod_dp_latency_get(const char *buf);

uint32_t mlxsw_reg_prtl_round_trip_latency_get(const char *buf);

/* pemi
 * ----
 *
 */
#define MLXSW_PEMI_ID 0x506e
#define MLXSW_PEMI_LEN 0x100

uint8_t mlxsw_reg_pemi_clr_statistic_get(const char *buf);

void mlxsw_reg_pemi_clr_statistic_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pemi_local_port_get(const char *buf);

void mlxsw_reg_pemi_local_port_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pemi_pnat_get(const char *buf);

void mlxsw_reg_pemi_pnat_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pemi_lp_msb_get(const char *buf);

void mlxsw_reg_pemi_lp_msb_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pemi_module_info_ext_get(const char *buf);

void mlxsw_reg_pemi_module_info_ext_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pemi_status_get(const char *buf);

uint16_t mlxsw_reg_pemi_group_cap_mask_get(const char *buf);

uint8_t mlxsw_reg_pemi_page_select_get(const char *buf);

void mlxsw_reg_pemi_page_select_set(char *buf, uint8_t val);

uint16_t mlxsw_reg_pemi_voltage_get(const char *buf);

uint16_t mlxsw_reg_pemi_rx_power_lane0_get(const char *buf);

uint16_t mlxsw_reg_pemi_rx_power_lane1_get(const char *buf);

uint16_t mlxsw_reg_pemi_rx_power_lane2_get(const char *buf);

uint16_t mlxsw_reg_pemi_rx_power_lane3_get(const char *buf);

uint16_t mlxsw_reg_pemi_rx_power_lane4_get(const char *buf);

uint16_t mlxsw_reg_pemi_rx_power_lane5_get(const char *buf);

uint16_t mlxsw_reg_pemi_rx_power_lane6_get(const char *buf);

uint16_t mlxsw_reg_pemi_rx_power_lane7_get(const char *buf);

uint16_t mlxsw_reg_pemi_tx_power_lane0_get(const char *buf);

uint16_t mlxsw_reg_pemi_tx_power_lane1_get(const char *buf);

uint16_t mlxsw_reg_pemi_tx_power_lane2_get(const char *buf);

uint16_t mlxsw_reg_pemi_tx_power_lane3_get(const char *buf);

uint16_t mlxsw_reg_pemi_tx_power_lane4_get(const char *buf);

uint16_t mlxsw_reg_pemi_tx_power_lane5_get(const char *buf);

uint16_t mlxsw_reg_pemi_tx_power_lane6_get(const char *buf);

uint16_t mlxsw_reg_pemi_tx_power_lane7_get(const char *buf);

uint32_t mlxsw_reg_pemi_tx_bias_lane0_get(const char *buf);

uint32_t mlxsw_reg_pemi_tx_bias_lane1_get(const char *buf);

uint32_t mlxsw_reg_pemi_tx_bias_lane2_get(const char *buf);

uint32_t mlxsw_reg_pemi_tx_bias_lane3_get(const char *buf);

uint32_t mlxsw_reg_pemi_tx_bias_lane4_get(const char *buf);

uint32_t mlxsw_reg_pemi_tx_bias_lane5_get(const char *buf);

uint32_t mlxsw_reg_pemi_tx_bias_lane6_get(const char *buf);

uint32_t mlxsw_reg_pemi_tx_bias_lane7_get(const char *buf);

uint8_t mlxsw_reg_pemi_module_st_get(const char *buf);

uint8_t mlxsw_reg_pemi_dp_st_lane0_get(const char *buf);

uint16_t mlxsw_reg_pemi_dp_st_lane1_get(const char *buf);

uint8_t mlxsw_reg_pemi_dp_st_lane2_get(const char *buf);

uint32_t mlxsw_reg_pemi_dp_st_lane3_get(const char *buf);

uint8_t mlxsw_reg_pemi_dp_st_lane4_get(const char *buf);

uint16_t mlxsw_reg_pemi_dp_st_lane5_get(const char *buf);

uint8_t mlxsw_reg_pemi_dp_st_lane6_get(const char *buf);

uint8_t mlxsw_reg_pemi_dp_st_lane7_get(const char *buf);

uint16_t mlxsw_reg_pemi_snr_media_lane0_get(const char *buf);

uint16_t mlxsw_reg_pemi_snr_media_lane1_get(const char *buf);

uint16_t mlxsw_reg_pemi_snr_media_lane2_get(const char *buf);

uint16_t mlxsw_reg_pemi_snr_media_lane3_get(const char *buf);

uint16_t mlxsw_reg_pemi_snr_media_lane4_get(const char *buf);

uint16_t mlxsw_reg_pemi_snr_media_lane5_get(const char *buf);

uint16_t mlxsw_reg_pemi_snr_media_lane6_get(const char *buf);

uint16_t mlxsw_reg_pemi_snr_media_lane7_get(const char *buf);

uint16_t mlxsw_reg_pemi_snr_host_lane0_get(const char *buf);

uint16_t mlxsw_reg_pemi_snr_host_lane1_get(const char *buf);

uint16_t mlxsw_reg_pemi_snr_host_lane2_get(const char *buf);

uint16_t mlxsw_reg_pemi_snr_host_lane3_get(const char *buf);

uint16_t mlxsw_reg_pemi_snr_host_lane4_get(const char *buf);

uint16_t mlxsw_reg_pemi_snr_host_lane5_get(const char *buf);

uint16_t mlxsw_reg_pemi_snr_host_lane6_get(const char *buf);

uint16_t mlxsw_reg_pemi_snr_host_lane7_get(const char *buf);

uint16_t mlxsw_reg_pemi_laser_age_get(const char *buf);

uint16_t mlxsw_reg_pemi_tec_current_get(const char *buf);

uint16_t mlxsw_reg_pemi_laser_frequency_error_lane0_get(const char *buf);

uint16_t mlxsw_reg_pemi_laser_frequency_error_lane1_get(const char *buf);

uint16_t mlxsw_reg_pemi_laser_frequency_error_lane2_get(const char *buf);

uint16_t mlxsw_reg_pemi_laser_frequency_error_lane3_get(const char *buf);

uint16_t mlxsw_reg_pemi_laser_frequency_error_lane4_get(const char *buf);

uint16_t mlxsw_reg_pemi_laser_frequency_error_lane5_get(const char *buf);

uint16_t mlxsw_reg_pemi_laser_frequency_error_lane6_get(const char *buf);

uint16_t mlxsw_reg_pemi_laser_frequency_error_lane7_get(const char *buf);

uint16_t mlxsw_reg_pemi_cooled_laser_temperature_lane0_get(const char *buf);

uint16_t mlxsw_reg_pemi_cooled_laser_temperature_lane1_get(const char *buf);

uint16_t mlxsw_reg_pemi_cooled_laser_temperature_lane2_get(const char *buf);

uint16_t mlxsw_reg_pemi_cooled_laser_temperature_lane3_get(const char *buf);

uint16_t mlxsw_reg_pemi_cooled_laser_temperature_lane4_get(const char *buf);

uint16_t mlxsw_reg_pemi_cooled_laser_temperature_lane5_get(const char *buf);

uint16_t mlxsw_reg_pemi_cooled_laser_temperature_lane6_get(const char *buf);

uint16_t mlxsw_reg_pemi_cooled_laser_temperature_lane7_get(const char *buf);

uint16_t mlxsw_reg_pemi_pam4_level_transition_media_lane0_get(const char *buf);

uint16_t mlxsw_reg_pemi_pam4_level_transition_media_lane1_get(const char *buf);

uint16_t mlxsw_reg_pemi_pam4_level_transition_media_lane2_get(const char *buf);

uint16_t mlxsw_reg_pemi_pam4_level_transition_media_lane3_get(const char *buf);

uint16_t mlxsw_reg_pemi_pam4_level_transition_media_lane4_get(const char *buf);

uint16_t mlxsw_reg_pemi_pam4_level_transition_media_lane5_get(const char *buf);

uint16_t mlxsw_reg_pemi_pam4_level_transition_media_lane6_get(const char *buf);

uint16_t mlxsw_reg_pemi_pam4_level_transition_media_lane7_get(const char *buf);

uint16_t mlxsw_reg_pemi_pam4_level_transition_host_lane0_get(const char *buf);

uint16_t mlxsw_reg_pemi_pam4_level_transition_host_lane1_get(const char *buf);

uint16_t mlxsw_reg_pemi_pam4_level_transition_host_lane2_get(const char *buf);

uint16_t mlxsw_reg_pemi_pam4_level_transition_host_lane3_get(const char *buf);

uint16_t mlxsw_reg_pemi_pam4_level_transition_host_lane4_get(const char *buf);

uint16_t mlxsw_reg_pemi_pam4_level_transition_host_lane5_get(const char *buf);

uint16_t mlxsw_reg_pemi_pam4_level_transition_host_lane6_get(const char *buf);

uint16_t mlxsw_reg_pemi_pam4_level_transition_host_lane7_get(const char *buf);

uint16_t mlxsw_reg_pemi_pre_fec_ber_min_media_get(const char *buf);

uint16_t mlxsw_reg_pemi_pre_fec_ber_min_host_get(const char *buf);

uint16_t mlxsw_reg_pemi_pre_fec_ber_max_media_get(const char *buf);

uint16_t mlxsw_reg_pemi_pre_fec_ber_max_host_get(const char *buf);

uint16_t mlxsw_reg_pemi_pre_fec_ber_avg_media_get(const char *buf);

uint16_t mlxsw_reg_pemi_pre_fec_ber_avg_host_get(const char *buf);

uint16_t mlxsw_reg_pemi_pre_fec_ber_val_media_get(const char *buf);

uint16_t mlxsw_reg_pemi_pre_fec_ber_val_host_get(const char *buf);

uint16_t mlxsw_reg_pemi_ferc_min_media_get(const char *buf);

uint16_t mlxsw_reg_pemi_ferc_min_host_get(const char *buf);

uint16_t mlxsw_reg_pemi_ferc_max_media_get(const char *buf);

uint16_t mlxsw_reg_pemi_ferc_max_host_get(const char *buf);

uint16_t mlxsw_reg_pemi_ferc_avg_media_get(const char *buf);

uint16_t mlxsw_reg_pemi_ferc_avg_host_get(const char *buf);

uint16_t mlxsw_reg_pemi_ferc_val_media_get(const char *buf);

uint16_t mlxsw_reg_pemi_ferc_val_host_get(const char *buf);

uint16_t mlxsw_reg_pemi_module_temp_get(const char *buf);

uint16_t mlxsw_reg_pemi_uc_temp_get(const char *buf);

uint16_t mlxsw_reg_pemi_lasers0_temp_get(const char *buf);

uint16_t mlxsw_reg_pemi_lasers1_temp_get(const char *buf);

uint16_t mlxsw_reg_pemi_cdr0_temp_get(const char *buf);

uint16_t mlxsw_reg_pemi_cdr1_temp_get(const char *buf);

uint16_t mlxsw_reg_pemi_cdr2_temp_get(const char *buf);

uint16_t mlxsw_reg_pemi_cdr3_temp_get(const char *buf);

uint16_t mlxsw_reg_pemi_module_status_cap_get(const char *buf);

uint16_t mlxsw_reg_pemi_voltage_high_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_voltage_low_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_voltage_high_warning_get(const char *buf);

uint16_t mlxsw_reg_pemi_voltage_low_warning_get(const char *buf);

uint16_t mlxsw_reg_pemi_rx_power_high_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_rx_power_low_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_rx_power_high_warning_get(const char *buf);

uint16_t mlxsw_reg_pemi_rx_power_low_warning_get(const char *buf);

uint16_t mlxsw_reg_pemi_tx_power_high_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_tx_power_low_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_tx_power_high_warning_get(const char *buf);

uint16_t mlxsw_reg_pemi_tx_power_low_warning_get(const char *buf);

uint32_t mlxsw_reg_pemi_tx_bias_high_alarm_get(const char *buf);

uint32_t mlxsw_reg_pemi_tx_bias_low_alarm_get(const char *buf);

uint32_t mlxsw_reg_pemi_tx_bias_high_warning_get(const char *buf);

uint32_t mlxsw_reg_pemi_tx_bias_low_warning_get(const char *buf);

uint16_t mlxsw_reg_pemi_snr_cap_get(const char *buf);

uint16_t mlxsw_reg_pemi_snr_media_low_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_snr_media_low_warning_get(const char *buf);

uint16_t mlxsw_reg_pemi_snr_host_low_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_snr_host_low_warning_get(const char *buf);

uint16_t mlxsw_reg_pemi_laser_monitor_cap_get(const char *buf);

uint16_t mlxsw_reg_pemi_laser_age_high_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_laser_age_high_warning_get(const char *buf);

uint16_t mlxsw_reg_pemi_tec_current_high_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_tec_current_low_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_tec_current_high_warning_get(const char *buf);

uint16_t mlxsw_reg_pemi_tec_current_low_warning_get(const char *buf);

uint16_t mlxsw_reg_pemi_laser_frequency_error_high_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_laser_frequency_error_high_warning_get(const char *buf);

uint16_t mlxsw_reg_pemi_cooled_laser_temp_high_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_cooled_laser_temp_low_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_cooled_laser_temp_high_warning_get(const char *buf);

uint16_t mlxsw_reg_pemi_cooled_laser_temp_low_warning_get(const char *buf);

uint16_t mlxsw_reg_pemi_pam4_level_transition_cap_get(const char *buf);

uint16_t mlxsw_reg_pemi_pam4_level_transition_media_low_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_pam4_level_transition_media_low_warning_get(const char *buf);

uint16_t mlxsw_reg_pemi_pam4_level_transition_host_low_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_pam4_level_transition_host_low_warning_get(const char *buf);

uint16_t mlxsw_reg_pemi_pre_fec_ber_cap_get(const char *buf);

uint16_t mlxsw_reg_pemi_pre_fec_ber_min_high_media_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_pre_fec_ber_min_high_media_warning_get(const char *buf);

uint16_t mlxsw_reg_pemi_pre_fec_ber_min_high_host_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_pre_fec_ber_min_high_host_warning_get(const char *buf);

uint16_t mlxsw_reg_pemi_pre_fec_ber_max_high_media_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_pre_fec_ber_max_high_media_warning_get(const char *buf);

uint16_t mlxsw_reg_pemi_pre_fec_ber_max_high_host_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_pre_fec_ber_max_high_host_warning_get(const char *buf);

uint16_t mlxsw_reg_pemi_pre_fec_ber_avg_high_media_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_pre_fec_ber_avg_high_media_warning_get(const char *buf);

uint16_t mlxsw_reg_pemi_pre_fec_ber_avg_high_host_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_pre_fec_ber_avg_high_host_warning_get(const char *buf);

uint16_t mlxsw_reg_pemi_ferc_cap_get(const char *buf);

uint16_t mlxsw_reg_pemi_temp_cap_get(const char *buf);

uint16_t mlxsw_reg_pemi_temp_high_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_temp_low_alarm_get(const char *buf);

uint16_t mlxsw_reg_pemi_temp_high_warning_get(const char *buf);

uint16_t mlxsw_reg_pemi_temp_low_warning_get(const char *buf);
...
uint8_t mlxsw_reg_pmtu_protocol_get(const char *buf);

void mlxsw_reg_pmtu_protocol_set(char *buf, uint8_t val);
...
uint16_t mlxsw_reg_pbgcr_user_val_get(const char *buf);

void mlxsw_reg_pbgcr_user_val_set(char *buf, uint16_t val);

uint16_t mlxsw_reg_pbgcr_dib_user_value_get(const char *buf);

void mlxsw_reg_pbgcr_dib_user_value_set(char *buf, uint16_t val);
...
uint8_t mlxsw_reg_ppir_lpnf_no_hcd_get(const char *buf);

uint8_t mlxsw_reg_ppir_lpnf_phy_get(const char *buf);

uint8_t mlxsw_reg_ppir_lcnf_pln_get(const char *buf);
...
uint8_t mlxsw_reg_pbwr_dir_get(const char *buf);

void mlxsw_reg_pbwr_dir_set(char *buf, uint8_t val);

uint16_t mlxsw_reg_pbwr_num_rec_get(const char *buf);

void mlxsw_reg_pbwr_num_rec_set(char *buf, uint16_t val);
 ...
 *
 */
#define MLXSW_PCMR_ID 0x5041
#define MLXSW_PCMR_LEN 0xc

uint8_t mlxsw_reg_pcmr_local_port_get(const char *buf);

void mlxsw_reg_pcmr_local_port_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pcmr_lp_msb_get(const char *buf);

void mlxsw_reg_pcmr_lp_msb_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pcmr_tx_ts_over_crc_cap_get(const char *buf);

uint8_t mlxsw_reg_pcmr_tx_fcs_recalc_cap_get(const char *buf);

uint8_t mlxsw_reg_pcmr_rx_fcs_drop_cap_get(const char *buf);

uint8_t mlxsw_reg_pcmr_rx_ts_over_crc_cap_get(const char *buf);

uint8_t mlxsw_reg_pcmr_cp_cap_get(const char *buf);

uint8_t mlxsw_reg_pcmr_fc_cap_get(const char *buf);

uint8_t mlxsw_reg_pcmr_len_cap_get(const char *buf);

uint8_t mlxsw_reg_pcmr_type_cap_get(const char *buf);

uint8_t mlxsw_reg_pcmr_mtu_cap_get(const char *buf);

uint8_t mlxsw_reg_pcmr_sht_cap_get(const char *buf);

uint8_t mlxsw_reg_pcmr_fcs_cap_get(const char *buf);

uint8_t mlxsw_reg_pcmr_pcs_cap_get(const char *buf);

uint8_t mlxsw_reg_pcmr_tx_ts_over_crc_get(const char *buf);

void mlxsw_reg_pcmr_tx_ts_over_crc_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pcmr_tx_fcs_recalc_get(const char *buf);

void mlxsw_reg_pcmr_tx_fcs_recalc_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pcmr_rx_fcs_drop_get(const char *buf);

void mlxsw_reg_pcmr_rx_fcs_drop_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pcmr_rx_ts_over_crc_get(const char *buf);

void mlxsw_reg_pcmr_rx_ts_over_crc_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pcmr_cp_chk_get(const char *buf);

void mlxsw_reg_pcmr_cp_chk_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pcmr_fc_chk_get(const char *buf);

void mlxsw_reg_pcmr_fc_chk_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pcmr_len_chk_get(const char *buf);

void mlxsw_reg_pcmr_len_chk_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pcmr_type_chk_get(const char *buf);

void mlxsw_reg_pcmr_type_chk_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pcmr_mtu_chk_get(const char *buf);

void mlxsw_reg_pcmr_mtu_chk_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pcmr_sht_chk_get(const char *buf);

void mlxsw_reg_pcmr_sht_chk_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pcmr_fcs_chk_get(const char *buf);

void mlxsw_reg_pcmr_fcs_chk_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pcmr_pcs_chk_get(const char *buf);

void mlxsw_reg_pcmr_pcs_chk_set(char *buf, uint8_t val);
...
uint16_t mlxsw_reg_sbsrd_first_entry_index_get(const char *buf);
...
uint8_t mlxsw_reg_pgcr_activity_dis_get(const char *buf);

void mlxsw_reg_pgcr_activity_dis_set(char *buf, uint8_t val);
 ...
 *
 */
#define MLXSW_PAGT_V2_ID 0x3045
#define MLXSW_PAGT_V2_LEN 0x18

uint8_t mlxsw_reg_pagt_v2_id_v_get(const char *buf);

void mlxsw_reg_pagt_v2_id_v_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pagt_v2_n_v_get(const char *buf);

void mlxsw_reg_pagt_v2_n_v_set(char *buf, uint8_t val);

uint16_t mlxsw_reg_pagt_v2_acl_group_element_get(const char *buf);

void mlxsw_reg_pagt_v2_acl_group_element_set(char *buf, uint16_t val);

uint16_t mlxsw_reg_pagt_v2_next_acl_group_element_get(const char *buf);

void mlxsw_reg_pagt_v2_next_acl_group_element_set(char *buf, uint16_t val);

uint8_t mlxsw_reg_pagt_v2_multi_get(const char *buf);

void mlxsw_reg_pagt_v2_multi_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_pagt_v2_commit_get(const char *buf);

void mlxsw_reg_pagt_v2_commit_set(char *buf, uint8_t val);

uint16_t mlxsw_reg_pagt_v2_acl_id_get(const char *buf);

void mlxsw_reg_pagt_v2_acl_id_set(char *buf, uint16_t val);

/* pagtq
 * -----
 *
 */
#define MLXSW_PAGTQ_ID 0x3046
#define MLXSW_PAGTQ_LEN 0x110

uint8_t mlxsw_reg_pagtq_busy_selector_get(const char *buf);

void mlxsw_reg_pagtq_busy_selector_set(char *buf, uint8_t val);

uint32_t mlxsw_reg_pagtq_acl_group_element_busy_bitmap_get(const char *buf, unsigned short outer_index, unsigned short index);
...
uint8_t mlxsw_reg_qtgtc_disabled_get(const char *buf);

void mlxsw_reg_qtgtc_disabled_set(char *buf, uint8_t val);
...
#define MLXSW_RIGR_V2_RIGR_ERIF_LIST_ERIF_ENTRY_BASE_LEN 0x24 /* base length, without records */
#define MLXSW_RIGR_V2_RIGR_ERIF_LIST_ADABE_RESERVED_BASE_LEN 0xa4 /* base length, without records */
...
uint8_t mlxsw_reg_rigr_v2_rigr_erif_list_vrmid_get(const char *buf);

void mlxsw_reg_rigr_v2_rigr_erif_list_vrmid_set(char *buf, uint8_t val);

uint16_t mlxsw_reg_rigr_v2_rigr_erif_list_rmid_index_get(const char *buf);

void mlxsw_reg_rigr_v2_rigr_erif_list_rmid_index_set(char *buf, uint16_t val);

uint8_t mlxsw_reg_rigr_v2_rigr_erif_list_v_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_rigr_v2_rigr_erif_list_v_set(char *buf, unsigned short outer_index, unsigned short index, uint8_t val);

uint16_t mlxsw_reg_rigr_v2_rigr_erif_list_erif_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_rigr_v2_rigr_erif_list_erif_set(char *buf, unsigned short outer_index, unsigned short index, uint16_t val);

uint32_t mlxsw_reg_rigr_v2_rigr_erif_list_adabe_reserved_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_rigr_v2_rigr_erif_list_adabe_reserved_set(char *buf, unsigned short outer_index, unsigned short index, uint32_t val);

uint8_t mlxsw_reg_rigr_v2_rigr_list_bit_vector_vrmid_get(const char *buf);

void mlxsw_reg_rigr_v2_rigr_list_bit_vector_vrmid_set(char *buf, uint8_t val);

uint16_t mlxsw_reg_rigr_v2_rigr_list_bit_vector_rmid_index_get(const char *buf);

void mlxsw_reg_rigr_v2_rigr_list_bit_vector_rmid_index_set(char *buf, uint16_t val);

uint8_t mlxsw_reg_rigr_v2_rigr_list_bit_vector_offset_get(const char *buf);

void mlxsw_reg_rigr_v2_rigr_list_bit_vector_offset_set(char *buf, uint8_t val);

uint64_t mlxsw_reg_rigr_v2_rigr_list_bit_vector_erif_bit_vector_get(const char *buf);

void mlxsw_reg_rigr_v2_rigr_list_bit_vector_erif_bit_vector_set(char *buf, uint64_t val);
...
#define MLXSW_RATRB_ETH_ADJACENCY_DESTINATION_MAC_BASE_LEN 0x2a /* base length, without records */
...
uint8_t mlxsw_reg_ratrb_arn_encap_adjacency_dip_type_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_ratrb_arn_encap_adjacency_dip_type_set(char *buf, unsigned short outer_index, unsigned short index, uint8_t val);

uint8_t mlxsw_reg_ratrb_arn_encap_adjacency_tqos_profile_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_ratrb_arn_encap_adjacency_tqos_profile_set(char *buf, unsigned short outer_index, unsigned short index, uint8_t val);

uint16_t mlxsw_reg_ratrb_arn_encap_adjacency_uirif_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_ratrb_arn_encap_adjacency_uirif_set(char *buf, unsigned short outer_index, unsigned short index, uint16_t val);

uint32_t mlxsw_reg_ratrb_arn_encap_adjacency_ipv4_udip_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_ratrb_arn_encap_adjacency_ipv4_udip_set(char *buf, unsigned short outer_index, unsigned short index, uint32_t val);

uint32_t mlxsw_reg_ratrb_arn_encap_adjacency_ipv6_ptr_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_ratrb_arn_encap_adjacency_ipv6_ptr_set(char *buf, unsigned short outer_index, unsigned short index, uint32_t val);

uint8_t mlxsw_reg_ratrb_arn_encap_adjacency_vnext_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_ratrb_arn_encap_adjacency_vnext_set(char *buf, unsigned short outer_index, unsigned short index, uint8_t val);

uint32_t mlxsw_reg_ratrb_arn_encap_adjacency_next_arn_ptr_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_ratrb_arn_encap_adjacency_next_arn_ptr_set(char *buf, unsigned short outer_index, unsigned short index, uint32_t val);
...
uint32_t mlxsw_reg_rarlu_link_utilization_thr_get(const char *buf);

void mlxsw_reg_rarlu_link_utilization_thr_set(char *buf, uint32_t val);
 ...
 *
 */
#define MLXSW_RARFTBR_ID 0x807a
#define MLXSW_RARFTBR_FLOW_TABLE_RECORDS_BASE_LEN 0x10 /* base length, without records */
#define MLXSW_RARFTBR_FLOW_TABLE_RECORDS_REC_LEN 0x08 /* record length */
#define MLXSW_RARFTBR_FLOW_TABLE_RECORDS_REC_MAX_COUNT 1
#define MLXSW_RARFTBR_LEN 0x18

uint16_t mlxsw_reg_rarftbr_num_rec_get(const char *buf);

void mlxsw_reg_rarftbr_num_rec_set(char *buf, uint16_t val);

uint32_t mlxsw_reg_rarftbr_arft_index_get(const char *buf);

void mlxsw_reg_rarftbr_arft_index_set(char *buf, uint32_t val);

uint8_t mlxsw_reg_rarftbr_ar_prof_id_get(const char *buf, unsigned short outer_index, unsigned short index);

uint8_t mlxsw_reg_rarftbr_lp_msb_get(const char *buf, unsigned short outer_index, unsigned short index);

uint8_t mlxsw_reg_rarftbr_local_port_get(const char *buf, unsigned short outer_index, unsigned short index);

uint8_t mlxsw_reg_rarftbr_arn_state_get(const char *buf, unsigned short outer_index, unsigned short index);
 ...
 *
 */
#define MLXSW_RARTM_ID 0x806b
#define MLXSW_RARTM_MAPPING_BASE_LEN 0x00 /* base length, without records */
#define MLXSW_RARTM_MAPPING_REC_LEN 0x04 /* record length */
#define MLXSW_RARTM_MAPPING_REC_MAX_COUNT 16
#define MLXSW_RARTM_LEN 0x40

uint8_t mlxsw_reg_rartm_en_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_rartm_en_set(char *buf, unsigned short outer_index, unsigned short index, uint8_t val);

uint8_t mlxsw_reg_rartm_ar_tclass_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_rartm_ar_tclass_set(char *buf, unsigned short outer_index, unsigned short index, uint8_t val);
 ...
 *
 */
#define MLXSW_RARNGC_ID 0x8070
#define MLXSW_RARNGC_LEN 0x1c

uint16_t mlxsw_reg_rarngc_udp_dst_port_get(const char *buf);

void mlxsw_reg_rarngc_udp_dst_port_set(char *buf, uint16_t val);

uint16_t mlxsw_reg_rarngc_udp_src_port_get(const char *buf);

void mlxsw_reg_rarngc_udp_src_port_set(char *buf, uint16_t val);

uint8_t mlxsw_reg_rarngc_ip_df_get(const char *buf);

void mlxsw_reg_rarngc_ip_df_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_rarngc_version_get(const char *buf);

void mlxsw_reg_rarngc_version_set(char *buf, uint8_t val);

uint16_t mlxsw_reg_rarngc_switch_id_get(const char *buf);

void mlxsw_reg_rarngc_switch_id_set(char *buf, uint16_t val);

uint8_t mlxsw_reg_rarngc_flh_get(const char *buf);

void mlxsw_reg_rarngc_flh_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_rarngc_flc_get(const char *buf);

void mlxsw_reg_rarngc_flc_set(char *buf, uint8_t val);

uint32_t mlxsw_reg_rarngc_fl_prefix_get(const char *buf);

void mlxsw_reg_rarngc_fl_prefix_set(char *buf, uint32_t val);

uint8_t mlxsw_reg_rarngc_fl_suffix_get(const char *buf);

void mlxsw_reg_rarngc_fl_suffix_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_rarngc_arn_vr_en_get(const char *buf);

void mlxsw_reg_rarngc_arn_vr_en_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_rarngc_prefix_match_type_get(const char *buf);

void mlxsw_reg_rarngc_prefix_match_type_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_rarngc_arn_gen_th_grade_get(const char *buf);

void mlxsw_reg_rarngc_arn_gen_th_grade_set(char *buf, uint8_t val);

uint16_t mlxsw_reg_rarngc_arn_vr_base_get(const char *buf);

void mlxsw_reg_rarngc_arn_vr_base_set(char *buf, uint16_t val);

uint8_t mlxsw_reg_rarngc_tr_en_get(const char *buf);

void mlxsw_reg_rarngc_tr_en_set(char *buf, uint8_t val);

uint16_t mlxsw_reg_rarngc_truncation_size_get(const char *buf);

void mlxsw_reg_rarngc_truncation_size_set(char *buf, uint16_t val);

uint8_t mlxsw_reg_rarngc_not_vld_set_type_get(const char *buf);

void mlxsw_reg_rarngc_not_vld_set_type_set(char *buf, uint8_t val);

uint32_t mlxsw_reg_rarngc_arn_ptr_not_vld_cnt_get(const char *buf);

void mlxsw_reg_rarngc_arn_ptr_not_vld_cnt_set(char *buf, uint32_t val);

uint8_t mlxsw_reg_rarngc_bad_sip_cnt_type_get(const char *buf);

void mlxsw_reg_rarngc_bad_sip_cnt_type_set(char *buf, uint8_t val);

uint32_t mlxsw_reg_rarngc_arn_bad_sip_cnt_get(const char *buf);

void mlxsw_reg_rarngc_arn_bad_sip_cnt_set(char *buf, uint32_t val);

/* rarnpc
 * ------
 *
 */
#define MLXSW_RARNPC_ID 0x8078
#define MLXSW_RARNPC_LEN 0x10

uint8_t mlxsw_reg_rarnpc_local_port_get(const char *buf);

void mlxsw_reg_rarnpc_local_port_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_rarnpc_lp_msb_get(const char *buf);

void mlxsw_reg_rarnpc_lp_msb_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_rarnpc_egress_en_get(const char *buf);

void mlxsw_reg_rarnpc_egress_en_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_rarnpc_ingress_en_get(const char *buf);

void mlxsw_reg_rarnpc_ingress_en_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_rarnpc_shaper_en_get(const char *buf);

void mlxsw_reg_rarnpc_shaper_en_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_rarnpc_clr_cnt_get(const char *buf);

void mlxsw_reg_rarnpc_clr_cnt_set(char *buf, uint8_t val);

uint64_t mlxsw_reg_rarnpc_arn_transmit_cnt_get(const char *buf);

/* rarns
 * -----
 *
 */
#define MLXSW_RARNS_ID 0x8073
#define MLXSW_RARNS_LEN 0x8

uint32_t mlxsw_reg_rarns_arn_gen_min_time_get(const char *buf);

void mlxsw_reg_rarns_arn_gen_min_time_set(char *buf, uint32_t val);

/* rarnpr
 * ------
 *
 */
#define MLXSW_RARNPR_ID 0x8071
#define MLXSW_RARNPR_LEN 0xc

uint8_t mlxsw_reg_rarnpr_elph_get(const char *buf);

void mlxsw_reg_rarnpr_elph_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_rarnpr_arn_gen_en_get(const char *buf);

void mlxsw_reg_rarnpr_arn_gen_en_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_rarnpr_profile_index_get(const char *buf);

void mlxsw_reg_rarnpr_profile_index_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_rarnpr_hold_time_after_change_get(const char *buf);

void mlxsw_reg_rarnpr_hold_time_after_change_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_rarnpr_arn_aging_time_get(const char *buf);

void mlxsw_reg_rarnpr_arn_aging_time_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_rarnpr_penalty_grade_get(const char *buf);

void mlxsw_reg_rarnpr_penalty_grade_set(char *buf, uint8_t val);

/* rarncp
 * ------
 *
 */
#define MLXSW_RARNCP_ID 0x8072
#define MLXSW_RARNCP_LEN 0xc

uint8_t mlxsw_reg_rarncp_local_port_get(const char *buf);

void mlxsw_reg_rarncp_local_port_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_rarncp_lp_msb_get(const char *buf);

void mlxsw_reg_rarncp_lp_msb_set(char *buf, uint8_t val);

uint32_t mlxsw_reg_rarncp_arn_dmac_31_0_get(const char *buf);

void mlxsw_reg_rarncp_arn_dmac_31_0_set(char *buf, uint32_t val);

uint8_t mlxsw_reg_rarncp_arn_dmac_en_get(const char *buf);

void mlxsw_reg_rarncp_arn_dmac_en_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_rarncp_arn_dip_en_get(const char *buf);

void mlxsw_reg_rarncp_arn_dip_en_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_rarncp_arn_en_get(const char *buf);

void mlxsw_reg_rarncp_arn_en_set(char *buf, uint8_t val);

uint16_t mlxsw_reg_rarncp_arn_dmac_47_32_get(const char *buf);

void mlxsw_reg_rarncp_arn_dmac_47_32_set(char *buf, uint16_t val);

/* rarncg
 * ------
 *
 */
#define MLXSW_RARNCG_ID 0x8075
#define MLXSW_RARNCG_LEN 0x20

uint32_t mlxsw_reg_rarncg_arn_dip_ipv4_get(const char *buf);

void mlxsw_reg_rarncg_arn_dip_ipv4_set(char *buf, uint32_t val);

uint32_t mlxsw_reg_rarncg_arn_dip_ipv6_31_0_get(const char *buf);

void mlxsw_reg_rarncg_arn_dip_ipv6_31_0_set(char *buf, uint32_t val);

uint32_t mlxsw_reg_rarncg_arn_dip_ipv6_63_32_get(const char *buf);

void mlxsw_reg_rarncg_arn_dip_ipv6_63_32_set(char *buf, uint32_t val);

uint32_t mlxsw_reg_rarncg_arn_dip_ipv6_95_64_get(const char *buf);

void mlxsw_reg_rarncg_arn_dip_ipv6_95_64_set(char *buf, uint32_t val);

uint32_t mlxsw_reg_rarncg_arn_dip_ipv6_127_96_get(const char *buf);

void mlxsw_reg_rarncg_arn_dip_ipv6_127_96_set(char *buf, uint32_t val);

uint16_t mlxsw_reg_rarncg_arn_udp_dport_get(const char *buf);

void mlxsw_reg_rarncg_arn_udp_dport_set(char *buf, uint16_t val);

uint8_t mlxsw_reg_rarncg_rcv_ok_cnt_type_get(const char *buf);

void mlxsw_reg_rarncg_rcv_ok_cnt_type_set(char *buf, uint8_t val);

uint32_t mlxsw_reg_rarncg_arn_rcv_ok_cnt_get(const char *buf);

void mlxsw_reg_rarncg_arn_rcv_ok_cnt_set(char *buf, uint32_t val);

uint8_t mlxsw_reg_rarncg_rcv_bad_cnt_type_get(const char *buf);

void mlxsw_reg_rarncg_rcv_bad_cnt_type_set(char *buf, uint8_t val);

uint32_t mlxsw_reg_rarncg_arn_rcv_bad_cnt_get(const char *buf);

void mlxsw_reg_rarncg_arn_rcv_bad_cnt_set(char *buf, uint32_t val);
...
uint8_t mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_expected_ip_ver_get(const char *buf);

void mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_expected_ip_ver_set(char *buf, uint8_t val);
...
uint8_t mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_protection_en_get(const char *buf);

void mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_protection_en_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_protection_active_get(const char *buf);

void mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_protection_active_set(char *buf, uint8_t val);

uint32_t mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_protection_nhlfe_ptr_get(const char *buf);

void mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_protection_nhlfe_ptr_set(char *buf, uint32_t val);
...
uint8_t mlxsw_reg_tnpc_learn_enable_v6_get(const char *buf);

void mlxsw_reg_tnpc_learn_enable_v6_set(char *buf, uint8_t val);
...
uint8_t mlxsw_reg_tigcr_ipip_decap_ttl_get(const char *buf);

void mlxsw_reg_tigcr_ipip_decap_ttl_set(char *buf, uint8_t val);
...
uint8_t mlxsw_reg_fpums_bitmap_size_get(const char *buf);

void mlxsw_reg_fpums_bitmap_size_set(char *buf, uint8_t val);
...
#define MLXSW_FSED_SF_PAGE_DUMP_MODE_0_KEY_54B_BASE_LEN 0x18 /* base length, without records */
#define MLXSW_FSED_SF_PAGE_DUMP_MODE_1_RECORD_BASE_LEN 0x08 /* base length, without records */
#define MLXSW_FSED_SF_PAGE_DUMP_MODE_1_KEY_18B_BASE_LEN 0x18 /* base length, without records */
