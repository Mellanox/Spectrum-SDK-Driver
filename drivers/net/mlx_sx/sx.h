...
typedef struct sx_module_independent_params {
    ...
    bool                            last_page_valid; /* Indication last_page holds valid value. */
    uint8_t                         last_page;       /* Last EEPROM accessed page. */
...
int sx_reset_with_mrsr_6_and_pci_toggle(struct sx_dev *dev);
int sx_emergency_reset_with_cr_space(struct sx_dev *dev);
int sx_emergency_reset_with_pci_toggle(struct sx_dev *dev);
