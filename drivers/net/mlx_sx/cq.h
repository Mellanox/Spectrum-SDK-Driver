...
/* kernel 5.10 and later do not have mmiowb() anymore. instead, this function is
 * called implicitly by spinlock_unlock() functions. make sure to wrap every place that called mmiowb()
 * with spinlock.
 */
