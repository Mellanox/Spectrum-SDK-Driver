...
static u64 __perout_conf_real_time(s64 sec)
{
    return (u64)sec << 32;
}
...
static int __ptp_pps_perout_configure(struct sx_priv *priv, struct ptp_clock_request *rq, int on)
{
    ...
    time_stamp = __perout_conf_real_time(sec);
    ...
    mtpps.mtpps_reg.utc_mode = SXD_MTPPS_UTC_MODE_UTC_E;
    mtpps.mtpps_reg.time_stamp = time_stamp;
    mtpps.mtpps_reg.field_select = field_select;
    mtpps.mtpps_reg.out_pulse_duration = 500;
