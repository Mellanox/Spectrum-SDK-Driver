...
static int _access_reg_pddr_data_to_buffer_print(char buffer[], size_t buffer_length, struct ku_pddr_reg * reg_data)
{
    ...
    case SXD_PDDR_PAGE_SELECT_MODULE_INFO_PAGE_E:
        ...
        memset(str_buf, 0, sizeof(str_buf));
        snprintf(str_buf, SXD_PDDR_VENDOR_NAME_NUM + 1, "%s", reg_data->page_data.pddr_module_info.vendor_name);
        ...
        memset(str_buf, 0, sizeof(str_buf));
        snprintf(str_buf, SXD_PDDR_VENDOR_PN_NUM + 1, "%s", reg_data->page_data.pddr_module_info.vendor_pn);
        ...
        memset(str_buf, 0, sizeof(str_buf));
        snprintf(str_buf, SXD_PDDR_VENDOR_SN_NUM + 1, "%s", reg_data->page_data.pddr_module_info.vendor_sn);
