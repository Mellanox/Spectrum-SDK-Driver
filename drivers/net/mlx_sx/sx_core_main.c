...
int sx_core_set_module(struct sx_dev *dev, uint8_t slot_id, uint8_t module_id, uint8_t enable, uint8_t reset)
{
    ...
    reg_data.pmaos_reg.module = local_module_id;
                                  ...
                                  struct sx_module_power_mode_params *params)
{
    ...
    reg_data.mcion_reg.module = local_module_id;
                                   ...
                                   struct sx_temperature_params *params)
{
    ...
    pmaos_reg_data.pmaos_reg.module = local_module_id;
    ...
    mtbr_reg_data.mtbr_reg.base_sensor_index = MODULE_SENSOR_BASE + local_module_id;
    ...
    mtmp_reg_data.mtmp_reg.sensor_index = MODULE_SENSOR_BASE + local_module_id;
