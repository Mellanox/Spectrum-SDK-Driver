...
SX_CORE_IOCTL_ACCESS_REG_HANDLER(MGPCB, ku_access_mgpcb_reg);
...
SX_CORE_IOCTL_ACCESS_REG_HANDLER(MVCR, ku_access_mvcr_reg);
...
SX_CORE_IOCTL_ACCESS_REG_HANDLER(MMAM, ku_access_mmam_reg);
SX_CORE_IOCTL_ACCESS_REG_HANDLER(MCGI, ku_access_mcgi_reg);
SX_CORE_IOCTL_ACCESS_REG_HANDLER(MFCDR, ku_access_mfcdr_reg);
SX_CORE_IOCTL_ACCESS_REG_HANDLER(MSGCR, ku_access_msgcr_reg);
...
SX_CORE_IOCTL_ACCESS_REG_HANDLER(MOPCT, ku_access_mopct_reg);
SX_CORE_IOCTL_ACCESS_REG_HANDLER(MOPCS, ku_access_mopcs_reg);
SX_CORE_IOCTL_ACCESS_REG_HANDLER(MOPGCR, ku_access_mopgcr_reg);
...
SX_CORE_IOCTL_ACCESS_REG_HANDLER(MIFGD, ku_access_mifgd_reg);
...
SX_CORE_IOCTL_ACCESS_REG_HANDLER(IBISSU, ku_access_ibissu_reg);
SX_CORE_IOCTL_ACCESS_REG_HANDLER(PCAM, ku_access_pcam_reg);
SX_CORE_IOCTL_ACCESS_REG_HANDLER(PTYS, ku_access_ptys_reg);
SX_CORE_IOCTL_ACCESS_REG_HANDLER(PAOS, ku_access_paos_reg);
SX_CORE_IOCTL_ACCESS_REG_HANDLER(PLTC, ku_access_pltc_reg);
SX_CORE_IOCTL_ACCESS_REG_HANDLER(PPCNT, ku_access_ppcnt_reg);
SX_CORE_IOCTL_ACCESS_REG_HANDLER(PUDE, ku_access_pude_reg);
...
SX_CORE_IOCTL_ACCESS_REG_HANDLER(PNLPNR, ku_access_pnlpnr_reg);
...
SX_CORE_IOCTL_ACCESS_REG_HANDLER(PRTL, ku_access_prtl_reg);
SX_CORE_IOCTL_ACCESS_REG_HANDLER(PEMI, ku_access_pemi_reg);
...
ioctl_auto_reg_handler_table[CTRL_CMD_ACCESS_REG_MAX - CTRL_CMD_ACCESS_REG_MIN + 1] = {
    ...
    IOCTL_REG_HANDLER(MMAM),
    IOCTL_REG_HANDLER(MCGI),
    IOCTL_REG_HANDLER(MFCDR),
    IOCTL_REG_HANDLER(MSGCR),
    ...
    IOCTL_REG_HANDLER(MOPCT),
    IOCTL_REG_HANDLER(MOPCS),
    IOCTL_REG_HANDLER(MOPGCR),
    IOCTL_REG_HANDLER(MTPSPU),
    IOCTL_REG_HANDLER(MTPCPC),
    IOCTL_REG_HANDLER(MFGD),
    IOCTL_REG_HANDLER(MIFGD),
    ...
    IOCTL_REG_HANDLER(IBISSU),
    IOCTL_REG_HANDLER(PCAM),
    IOCTL_REG_HANDLER(PTYS),
    IOCTL_REG_HANDLER(PAOS),
    IOCTL_REG_HANDLER(PLTC),
    IOCTL_REG_HANDLER(PPCNT),
    IOCTL_REG_HANDLER(PUDE),
    ...
    IOCTL_REG_HANDLER(PRTL),
    IOCTL_REG_HANDLER(PEMI),
