...
* HTGT
***********************************************/
int __HTGT_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_htgt_reg *htgt_reg = (struct ku_htgt_reg*)ku_reg;

    mlxsw_reg_htgt_swid_set(inbox, htgt_reg->swid);
    mlxsw_reg_htgt_type_set(inbox, htgt_reg->type);
    mlxsw_reg_htgt_trap_group_set(inbox, htgt_reg->trap_group);
    mlxsw_reg_htgt_pide_set(inbox, htgt_reg->pide);
    mlxsw_reg_htgt_pid_set(inbox, htgt_reg->pid);
    mlxsw_reg_htgt_mirror_action_set(inbox, htgt_reg->mirror_action);
    mlxsw_reg_htgt_mirror_agent_set(inbox, htgt_reg->mirror_agent);
    mlxsw_reg_htgt_priority_set(inbox, htgt_reg->priority);
    mlxsw_reg_htgt_cpu_tclass_set(inbox, htgt_reg->path.cpu_tclass);
    mlxsw_reg_htgt_rdq_set(inbox, htgt_reg->path.rdq);
    mlxsw_reg_htgt_mirror_probability_rate_set(inbox, htgt_reg->mirror_probability_rate);


    return 0;
}

int __HTGT_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_htgt_reg *htgt_reg = (struct ku_htgt_reg*)ku_reg;

    htgt_reg->swid = mlxsw_reg_htgt_swid_get(outbox);
    htgt_reg->type = mlxsw_reg_htgt_type_get(outbox);
    htgt_reg->trap_group = mlxsw_reg_htgt_trap_group_get(outbox);
    htgt_reg->pide = mlxsw_reg_htgt_pide_get(outbox);
    htgt_reg->pid = mlxsw_reg_htgt_pid_get(outbox);
    htgt_reg->mirror_action = mlxsw_reg_htgt_mirror_action_get(outbox);
    htgt_reg->mirror_agent = mlxsw_reg_htgt_mirror_agent_get(outbox);
    htgt_reg->priority = mlxsw_reg_htgt_priority_get(outbox);
    htgt_reg->path.cpu_tclass = mlxsw_reg_htgt_cpu_tclass_get(outbox);
    htgt_reg->path.rdq = mlxsw_reg_htgt_rdq_get(outbox);
    htgt_reg->mirror_probability_rate = mlxsw_reg_htgt_mirror_probability_rate_get(outbox);


    return 0;
}
EXPORT_SYMBOL(__HTGT_decode);

int sx_ACCESS_REG_HTGT(struct sx_dev *dev, struct ku_access_htgt_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_HTGT_LEN >> 2) + 1;

    if (MLXSW_HTGT_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
int sx_EMAD_ACCESS_REG_HTGT(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_htgt_reg *reg)
{
    u16 reg_len_dword = (MLXSW_HTGT_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_HTGT);

/************************************************
* HPKT
***********************************************/
int __HPKT_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_hpkt_reg *hpkt_reg = (struct ku_hpkt_reg*)ku_reg;

    mlxsw_reg_hpkt_source_set(inbox, hpkt_reg->source);
    mlxsw_reg_hpkt_ack_set(inbox, hpkt_reg->ack);
    mlxsw_reg_hpkt_action_set(inbox, hpkt_reg->action);
    mlxsw_reg_hpkt_trap_group_set(inbox, hpkt_reg->trap_group);
    mlxsw_reg_hpkt_trap_id_set(inbox, hpkt_reg->trap_id);
    mlxsw_reg_hpkt_ctrl_set(inbox, hpkt_reg->ctrl);
    mlxsw_reg_hpkt_tr_prof_set(inbox, hpkt_reg->tr_prof);
    mlxsw_reg_hpkt_tr_en_set(inbox, hpkt_reg->tr_en);


    return 0;
}

int __HPKT_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_hpkt_reg *hpkt_reg = (struct ku_hpkt_reg*)ku_reg;

    hpkt_reg->source = mlxsw_reg_hpkt_source_get(outbox);
    hpkt_reg->ack = mlxsw_reg_hpkt_ack_get(outbox);
    hpkt_reg->action = mlxsw_reg_hpkt_action_get(outbox);
    hpkt_reg->trap_group = mlxsw_reg_hpkt_trap_group_get(outbox);
    hpkt_reg->trap_id = mlxsw_reg_hpkt_trap_id_get(outbox);
    hpkt_reg->ctrl = mlxsw_reg_hpkt_ctrl_get(outbox);
    hpkt_reg->tr_prof = mlxsw_reg_hpkt_tr_prof_get(outbox);
    hpkt_reg->tr_en = mlxsw_reg_hpkt_tr_en_get(outbox);


    return 0;
}
EXPORT_SYMBOL(__HPKT_decode);

int sx_ACCESS_REG_HPKT(struct sx_dev *dev, struct ku_access_hpkt_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_HPKT_LEN >> 2) + 1;

    if (MLXSW_HPKT_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
int sx_EMAD_ACCESS_REG_HPKT(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_hpkt_reg *reg)
{
    u16 reg_len_dword = (MLXSW_HPKT_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_HPKT);
...
int __MSPI_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    mlxsw_reg_mspi_clk_dev_set(inbox, mspi_reg->clk_dev);
...
int __MSPI_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    mspi_reg->clk_dev = mlxsw_reg_mspi_clk_dev_get(outbox);
...
* MGPCB
***********************************************/
int __MGPCB_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_mgpcb_reg *mgpcb_reg = (struct ku_mgpcb_reg*)ku_reg;

    mlxsw_reg_mgpcb_counter_index_base_set(inbox, mgpcb_reg->counter_index_base);
    mlxsw_reg_mgpcb_num_rec_set(inbox, mgpcb_reg->num_rec);
    mlxsw_reg_mgpcb_opcode_set(inbox, mgpcb_reg->opcode);


    return 0;
}

int __MGPCB_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_mgpcb_reg *mgpcb_reg = (struct ku_mgpcb_reg*)ku_reg;
    uint32_t i = 0;

    mgpcb_reg->counter_index_base = mlxsw_reg_mgpcb_counter_index_base_get(outbox);
    mgpcb_reg->num_rec = mlxsw_reg_mgpcb_num_rec_get(outbox);
    mgpcb_reg->opcode = mlxsw_reg_mgpcb_opcode_get(outbox);
    for (i = 0; i < SXD_MGPCB_RECORD_NUM; i++) {
        mgpcb_reg->record[i].byte_counter = mlxsw_reg_mgpcb_byte_counter_get(outbox, 0, i);
        mgpcb_reg->record[i].packet_counter = mlxsw_reg_mgpcb_packet_counter_get(outbox, 0, i);
    }


    return 0;
}
EXPORT_SYMBOL(__MGPCB_decode);

int sx_ACCESS_REG_MGPCB(struct sx_dev *dev, struct ku_access_mgpcb_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_MGPCB_LEN >> 2) + 1;

    if (MLXSW_MGPCB_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
EXPORT_SYMBOL(sx_ACCESS_REG_MGPCB);

int sx_EMAD_ACCESS_REG_MGPCB(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_mgpcb_reg *reg)
{
    u16 reg_len_dword = (MLXSW_MGPCB_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_MGPCB);
...
int __MGPIR_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    mgpir_reg->hw_info.num_of_modules_per_system = mlxsw_reg_mgpir_num_of_modules_per_system_get(outbox);
...
int __MTMP_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    mlxsw_reg_mtmp_temperature_critical_threshold_hi_set(inbox, mtmp_reg->temperature_critical_threshold_hi);
    mlxsw_reg_mtmp_temperature_critical_threshold_low_set(inbox, mtmp_reg->temperature_critical_threshold_low);
...
int __MTMP_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    mtmp_reg->temperature_critical_threshold_hi = mlxsw_reg_mtmp_temperature_critical_threshold_hi_get(outbox);
    mtmp_reg->temperature_critical_threshold_low = mlxsw_reg_mtmp_temperature_critical_threshold_low_get(outbox);
...
* MVCR
***********************************************/
int __MVCR_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_mvcr_reg *mvcr_reg = (struct ku_mvcr_reg*)ku_reg;

    mlxsw_reg_mvcr_i_set(inbox, mvcr_reg->i);
    mlxsw_reg_mvcr_slot_index_set(inbox, mvcr_reg->slot_index);
    mlxsw_reg_mvcr_sensor_index_set(inbox, mvcr_reg->sensor_index);


    return 0;
}

int __MVCR_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_mvcr_reg *mvcr_reg = (struct ku_mvcr_reg*)ku_reg;

    mvcr_reg->i = mlxsw_reg_mvcr_i_get(outbox);
    mvcr_reg->slot_index = mlxsw_reg_mvcr_slot_index_get(outbox);
    mvcr_reg->sensor_index = mlxsw_reg_mvcr_sensor_index_get(outbox);
    mvcr_reg->voltage_sensor_value = mlxsw_reg_mvcr_voltage_sensor_value_get(outbox);
    mvcr_reg->current_sensor_value_msb = mlxsw_reg_mvcr_current_sensor_value_msb_get(outbox);
    mvcr_reg->current_sensor_value = mlxsw_reg_mvcr_current_sensor_value_get(outbox);
    mvcr_reg->sensor_name = mlxsw_reg_mvcr_sensor_name_get(outbox);


    return 0;
}
EXPORT_SYMBOL(__MVCR_decode);

int sx_ACCESS_REG_MVCR(struct sx_dev *dev, struct ku_access_mvcr_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_MVCR_LEN >> 2) + 1;

    if (MLXSW_MVCR_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
EXPORT_SYMBOL(sx_ACCESS_REG_MVCR);

int sx_EMAD_ACCESS_REG_MVCR(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_MVCR);
...
int __MGIR_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    mgir_reg->hw_info.ib_mad_gen = mlxsw_reg_mgir_ib_mad_gen_get(outbox);
    ...
    mgir_reg->hw_info.development = mlxsw_reg_mgir_development_get(outbox);
    mgir_reg->hw_info.chip_type = mlxsw_reg_mgir_chip_type_get(outbox);
    mgir_reg->hw_info.ga = mlxsw_reg_mgir_ga_get(outbox);
    mlxsw_reg_mgir_manufacturing_base_mac_memcpy_from(outbox, (char *)mgir_reg->hw_info.manufacturing_base_mac);
    mgir_reg->hw_info.device_ticks_per_msec = mlxsw_reg_mgir_device_ticks_per_msec_get(outbox);
    ...
    mgir_reg->fw_info.pds = mlxsw_reg_mgir_fw_info_pds_get(outbox);
    mgir_reg->fw_info.issu_able = mlxsw_reg_mgir_fw_info_issu_able_get(outbox);
    mgir_reg->fw_info.life_cycle_msb = mlxsw_reg_mgir_fw_info_life_cycle_msb_get(outbox);
...
int __MINI_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    case SXD_MINI_TYPE_FUSED_OUT_PORTS_E:
        break;
...
int __MINI_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    case SXD_MINI_TYPE_FUSED_OUT_PORTS_E:
        for (i = 0; i < SXD_MINI_MINI_FUSED_OUT_PORTS_FUSED_OUT_PORTS_BITMAP_NUM; i++) {
            mini_reg->data.mini_fused_out_ports.fused_out_ports_bitmap[i] = mlxsw_reg_mini_fused_out_ports_bitmap_get(outbox, 0, i);
        }
        break;
...
* MMAM
***********************************************/
int __MMAM_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_mmam_reg *mmam_reg = (struct ku_mmam_reg*)ku_reg;

    mlxsw_reg_mmam_module_set(inbox, mmam_reg->module);


    return 0;
}

int __MMAM_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_mmam_reg *mmam_reg = (struct ku_mmam_reg*)ku_reg;

    mmam_reg->module = mlxsw_reg_mmam_module_get(outbox);
    mmam_reg->ga = mlxsw_reg_mmam_ga_get(outbox);
    mmam_reg->local_module = mlxsw_reg_mmam_local_module_get(outbox);
    mmam_reg->module_type = mlxsw_reg_mmam_module_type_get(outbox);


    return 0;
}
EXPORT_SYMBOL(__MMAM_decode);

int sx_ACCESS_REG_MMAM(struct sx_dev *dev, struct ku_access_mmam_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_MMAM_LEN >> 2) + 1;

    if (MLXSW_MMAM_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
EXPORT_SYMBOL(sx_ACCESS_REG_MMAM);

int sx_EMAD_ACCESS_REG_MMAM(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_mmam_reg *reg)
{
    u16 reg_len_dword = (MLXSW_MMAM_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_MMAM);

/************************************************
* MCGI
***********************************************/
int __MCGI_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_mcgi_reg *mcgi_reg = (struct ku_mcgi_reg*)ku_reg;
...
int __MCGI_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_mcgi_reg *mcgi_reg = (struct ku_mcgi_reg*)ku_reg;
    uint32_t i = 0;

    mcgi_reg->tray_index = mlxsw_reg_mcgi_tray_index_get(outbox);
    mcgi_reg->chassis_slot_index = mlxsw_reg_mcgi_chassis_slot_index_get(outbox);
    for (i = 0; i < SXD_MCGI_CHASSIS_ID_NUM; i++) {
        mcgi_reg->chassis_id[i] = mlxsw_reg_mcgi_chassis_id_get(outbox, 0, i);
    }
    mcgi_reg->chassis_topology_id = mlxsw_reg_mcgi_chassis_topology_id_get(outbox);


    return 0;
}
EXPORT_SYMBOL(__MCGI_decode);

int sx_ACCESS_REG_MCGI(struct sx_dev *dev, struct ku_access_mcgi_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_MCGI_LEN >> 2) + 1;

    if (MLXSW_MCGI_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
EXPORT_SYMBOL(sx_ACCESS_REG_MCGI);

int sx_EMAD_ACCESS_REG_MCGI(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_mcgi_reg *reg)
{
    u16 reg_len_dword = (MLXSW_MCGI_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_MCGI);

/************************************************
* MFCDR
***********************************************/
int __MFCDR_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_mfcdr_reg *mfcdr_reg = (struct ku_mfcdr_reg*)ku_reg;

    mlxsw_reg_mfcdr_local_port_set(inbox, mfcdr_reg->local_port);
    mlxsw_reg_mfcdr_lp_msb_set(inbox, mfcdr_reg->lp_msb);


    return 0;
}

int __MFCDR_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_mfcdr_reg *mfcdr_reg = (struct ku_mfcdr_reg*)ku_reg;

    mfcdr_reg->local_port = mlxsw_reg_mfcdr_local_port_get(outbox);
    mfcdr_reg->lp_msb = mlxsw_reg_mfcdr_lp_msb_get(outbox);
    mfcdr_reg->status = mlxsw_reg_mfcdr_status_get(outbox);


    return 0;
}
EXPORT_SYMBOL(__MFCDR_decode);

int sx_ACCESS_REG_MFCDR(struct sx_dev *dev, struct ku_access_mfcdr_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_MFCDR_LEN >> 2) + 1;

    if (MLXSW_MFCDR_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
EXPORT_SYMBOL(sx_ACCESS_REG_MFCDR);

int sx_EMAD_ACCESS_REG_MFCDR(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_mfcdr_reg *reg)
{
    u16 reg_len_dword = (MLXSW_MFCDR_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_MFCDR);

/************************************************
* MSGCR
***********************************************/
int __MSGCR_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_msgcr_reg *msgcr_reg = (struct ku_msgcr_reg*)ku_reg;

    mlxsw_reg_msgcr_fake_cable_detect_en_set(inbox, msgcr_reg->fake_cable_detect_en);


    return 0;
}

int __MSGCR_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_msgcr_reg *msgcr_reg = (struct ku_msgcr_reg*)ku_reg;

    msgcr_reg->fake_cable_detect_en = mlxsw_reg_msgcr_fake_cable_detect_en_get(outbox);
    msgcr_reg->support_error_injection = mlxsw_reg_msgcr_support_error_injection_get(outbox);
    msgcr_reg->support_inter_asic_block = mlxsw_reg_msgcr_support_inter_asic_block_get(outbox);
    msgcr_reg->support_perst_gpio = mlxsw_reg_msgcr_support_perst_gpio_get(outbox);


    return 0;
}
EXPORT_SYMBOL(__MSGCR_decode);

int sx_ACCESS_REG_MSGCR(struct sx_dev *dev, struct ku_access_msgcr_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_MSGCR_LEN >> 2) + 1;

    if (MLXSW_MSGCR_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
EXPORT_SYMBOL(sx_ACCESS_REG_MSGCR);

int sx_EMAD_ACCESS_REG_MSGCR(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_msgcr_reg *reg)
{
    u16 reg_len_dword = (MLXSW_MSGCR_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_MSGCR);
...
int __MMCR_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    for (i = 0; i < SXD_MMCR_NEXT_MODULE_CONTROL_NUM; i++) {
        mlxsw_reg_mmcr_next_module_control_set(inbox, 0, i, mmcr_reg->next_module_control[i]);
    }
...
int __MMCR_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    for (i = 0; i < SXD_MMCR_NEXT_MODULE_CONTROL_NUM; i++) {
        mmcr_reg->next_module_control[i] = mlxsw_reg_mmcr_next_module_control_get(outbox, 0, i);
    }
    for (i = 0; i < SXD_MMCR_MODULE_CONTROL_MASK_NUM; i++) {
        mmcr_reg->module_control_mask[i] = mlxsw_reg_mmcr_module_control_mask_get(outbox, 0, i);
    }
    for (i = 0; i < SXD_MMCR_CURR_MODULE_CONTROL_NUM; i++) {
        mmcr_reg->curr_module_control[i] = mlxsw_reg_mmcr_curr_module_control_get(outbox, 0, i);
    }
...
int __MFRI_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    mfri_reg->num_normals = mlxsw_reg_mfri_num_normals_get(outbox);
...
int __MOGCR_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    mlxsw_reg_mogcr_e2e_time_scale_set(inbox, mogcr_reg->e2e_time_scale);
    ...
    mlxsw_reg_mogcr_local_toc_fmt_set(inbox, mogcr_reg->local_toc_fmt);
...
int __MOGCR_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    mogcr_reg->e2e_time_scale = mlxsw_reg_mogcr_e2e_time_scale_get(outbox);
    ...
    mogcr_reg->local_toc_fmt = mlxsw_reg_mogcr_local_toc_fmt_get(outbox);
...
* MPRS
***********************************************/
int __MPRS_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_mprs_reg *mprs_reg = (struct ku_mprs_reg*)ku_reg;

    mlxsw_reg_mprs_en_l4_raw_prs_set(inbox, mprs_reg->en_l4_raw_prs);
    mlxsw_reg_mprs_prs_depth_dis_set(inbox, mprs_reg->prs_depth_dis);
    mlxsw_reg_mprs_ctipl_dis_set(inbox, mprs_reg->ctipl_dis);
    mlxsw_reg_mprs_parsing_depth_set(inbox, mprs_reg->parsing_depth);
    mlxsw_reg_mprs_parsing_en_set(inbox, mprs_reg->parsing_en);
    mlxsw_reg_mprs_ctipl_set(inbox, mprs_reg->ctipl);
    mlxsw_reg_mprs_ctipl_l2_length_set(inbox, mprs_reg->ctipl_l2_length);
    mlxsw_reg_mprs_vxlan_udp_dport_set(inbox, mprs_reg->vxlan_udp_dport);


    return 0;
}

int __MPRS_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_mprs_reg *mprs_reg = (struct ku_mprs_reg*)ku_reg;

    mprs_reg->en_l4_raw_prs = mlxsw_reg_mprs_en_l4_raw_prs_get(outbox);
    mprs_reg->prs_depth_dis = mlxsw_reg_mprs_prs_depth_dis_get(outbox);
    mprs_reg->ctipl_dis = mlxsw_reg_mprs_ctipl_dis_get(outbox);
    mprs_reg->parsing_depth = mlxsw_reg_mprs_parsing_depth_get(outbox);
    mprs_reg->parsing_en = mlxsw_reg_mprs_parsing_en_get(outbox);
    mprs_reg->ctipl = mlxsw_reg_mprs_ctipl_get(outbox);
    mprs_reg->ctipl_l2_length = mlxsw_reg_mprs_ctipl_l2_length_get(outbox);
    mprs_reg->vxlan_udp_dport = mlxsw_reg_mprs_vxlan_udp_dport_get(outbox);


    return 0;
}
EXPORT_SYMBOL(__MPRS_decode);

int sx_ACCESS_REG_MPRS(struct sx_dev *dev, struct ku_access_mprs_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_MPRS_LEN >> 2) + 1;

    if (MLXSW_MPRS_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
int sx_EMAD_ACCESS_REG_MPRS(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_mprs_reg *reg)
{
    u16 reg_len_dword = (MLXSW_MPRS_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_MPRS);

/************************************************
* MONI
***********************************************/
int __MONI_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_moni_reg *moni_reg = (struct ku_moni_reg*)ku_reg;

    mlxsw_reg_moni_local_port_set(inbox, moni_reg->local_port);
    mlxsw_reg_moni_lp_msb_set(inbox, moni_reg->lp_msb);
    mlxsw_reg_moni_en_set(inbox, moni_reg->en);


    return 0;
}

int __MONI_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_moni_reg *moni_reg = (struct ku_moni_reg*)ku_reg;

    moni_reg->local_port = mlxsw_reg_moni_local_port_get(outbox);
    moni_reg->lp_msb = mlxsw_reg_moni_lp_msb_get(outbox);
    moni_reg->en = mlxsw_reg_moni_en_get(outbox);


    return 0;
}
EXPORT_SYMBOL(__MONI_decode);

int sx_ACCESS_REG_MONI(struct sx_dev *dev, struct ku_access_moni_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_MONI_LEN >> 2) + 1;

    if (MLXSW_MONI_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
int sx_EMAD_ACCESS_REG_MONI(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_moni_reg *reg)
{
    u16 reg_len_dword = (MLXSW_MONI_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_MONI);
...
int __MOCS_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    mlxsw_reg_mocs_iter_mode_set(inbox, mocs_reg->iter_mode);
    mlxsw_reg_mocs_min_iter_time_set(inbox, mocs_reg->min_iter_time);
    mlxsw_reg_mocs_num_of_iter_set(inbox, mocs_reg->num_of_iter);
    mlxsw_reg_mocs_metadata_set(inbox, mocs_reg->metadata);
    mlxsw_reg_mocs_iter_md_op_set(inbox, mocs_reg->iter_md_op);
    switch (mocs_reg->type) {
    case SXD_MOCS_TYPE_PPCNT_SES0_E:
        break;

    case SXD_MOCS_TYPE_PPCNT_SES1_E:
        for (i = 0; i < SXD_MOCS_MOCS_PPCNT_PORT_MASK_NUM; i++) {
            mlxsw_reg_mocs_mocs_ppcnt_port_mask_set(inbox, 0, i, mocs_reg->entry.mocs_ppcnt.port_mask[i]);
        }
        for (i = 0; i < SXD_MOCS_MOCS_PPCNT_GRP_MASK_NUM; i++) {
        ...
        for (i = 0; i < SXD_MOCS_MOCS_PPCNT_GRP_PRF_NUM; i++) {
    ...
    case SXD_MOCS_TYPE_PBSR_E:
        for (i = 0; i < SXD_MOCS_MOCS_PBSR_PORT_MASK_NUM; i++) {
    ...
    case SXD_MOCS_TYPE_CEER_E:
        for (i = 0; i < SXD_MOCS_MOCS_CEER_PORT_MASK_NUM; i++) {
    ...
    case SXD_MOCS_TYPE_USACN_E:
        for (i = 0; i < SXD_MOCS_MOCS_USACN_PORT_MASK_NUM; i++) {
    ...
    case SXD_MOCS_TYPE_UTCC_E:
        for (i = 0; i < SXD_MOCS_MOCS_UTCC_PORT_MASK_NUM; i++) {
    ...
    case SXD_MOCS_TYPE_UPCNT_E:
        for (i = 0; i < SXD_MOCS_MOCS_UPCNT_PORT_MASK_NUM; i++) {
    ...
    case SXD_MOCS_TYPE_MOFRB_E:
        for (i = 0; i < SXD_MOCS_MOCS_MOFRB_FLOW_ESTIMATOR_RECORD_NUM; i++) {
    ...
    case SXD_MOCS_TYPE_MOFTD_E:
        mlxsw_reg_mocs_user_cookie_set(inbox, mocs_reg->entry.mocs_moftd.user_cookie);
        break;

    case SXD_MOCS_TYPE_RARFTBR_E:
        mlxsw_reg_mocs_num_job_set(inbox, mocs_reg->entry.mocs_rarftbr.num_job);
        for (i = 0; i < mocs_reg->entry.mocs_rarftbr.num_job; i++) {
            mlxsw_reg_mocs_num_rec_log_set(inbox, 0, i, mocs_reg->entry.mocs_rarftbr.job[i].num_rec_log);
            mlxsw_reg_mocs_arft_index_set(inbox, 0, i, mocs_reg->entry.mocs_rarftbr.job[i].arft_index);
        }
        break;

    case SXD_MOCS_TYPE_PPCNT_V2_SES0_E:
        break;

    case SXD_MOCS_TYPE_PPCNT_V2_SES1_E:
        for (i = 0; i < SXD_MOCS_MOCS_PPCNT_V2_GRP_MASK_NUM; i++) {
            mlxsw_reg_mocs_mocs_ppcnt_v2_grp_mask_set(inbox, 0, i, mocs_reg->entry.mocs_ppcnt_v2.grp_mask[i]);
        }
        mlxsw_reg_mocs_mocs_ppcnt_v2_tc_mask_set(inbox, mocs_reg->entry.mocs_ppcnt_v2.tc_mask);
        mlxsw_reg_mocs_mocs_ppcnt_v2_prio_mask_set(inbox, mocs_reg->entry.mocs_ppcnt_v2.prio_mask);
        mlxsw_reg_mocs_mocs_ppcnt_v2_rx_buffer_mask_set(inbox, mocs_reg->entry.mocs_ppcnt_v2.rx_buffer_mask);
        for (i = 0; i < SXD_MOCS_MOCS_PPCNT_V2_GRP_PRF_NUM; i++) {
            mlxsw_reg_mocs_mocs_ppcnt_v2_grp_prf_set(inbox, 0, i, mocs_reg->entry.mocs_ppcnt_v2.grp_prf[i]);
        }
        mlxsw_reg_mocs_mocs_ppcnt_v2_port_bitmap_size_set(inbox, mocs_reg->entry.mocs_ppcnt_v2.port_bitmap_size);
        for (i = 0; i < mocs_reg->entry.mocs_ppcnt_v2.port_bitmap_size; i++) {
            mlxsw_reg_mocs_mocs_ppcnt_v2_port_mask_set(inbox, 0, i, mocs_reg->entry.mocs_ppcnt_v2.port_mask[i]);
        }
        break;

    case SXD_MOCS_TYPE_PBSR_V2_E:
        mlxsw_reg_mocs_mocs_pbsr_v2_bitmap_size_set(inbox, mocs_reg->entry.mocs_pbsr_v2.bitmap_size);
        for (i = 0; i < mocs_reg->entry.mocs_pbsr_v2.bitmap_size; i++) {
            mlxsw_reg_mocs_mocs_pbsr_v2_port_mask_set(inbox, 0, i, mocs_reg->entry.mocs_pbsr_v2.port_mask[i]);
        }
        break;
...
int __MOCS_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    mocs_reg->iter_mode = mlxsw_reg_mocs_iter_mode_get(outbox);
    mocs_reg->min_iter_time = mlxsw_reg_mocs_min_iter_time_get(outbox);
    mocs_reg->num_of_iter = mlxsw_reg_mocs_num_of_iter_get(outbox);
    mocs_reg->metadata = mlxsw_reg_mocs_metadata_get(outbox);
    mocs_reg->iter_md_op = mlxsw_reg_mocs_iter_md_op_get(outbox);
    switch (mocs_reg->type) {
    case SXD_MOCS_TYPE_PPCNT_SES0_E:
        break;
    ...
    case SXD_MOCS_TYPE_MOFTD_E:
        mocs_reg->entry.mocs_moftd.user_cookie = mlxsw_reg_mocs_user_cookie_get(outbox);
        break;

    case SXD_MOCS_TYPE_RARFTBR_E:
        mocs_reg->entry.mocs_rarftbr.num_job = mlxsw_reg_mocs_num_job_get(outbox);
        for (i = 0; i < mocs_reg->entry.mocs_rarftbr.num_job; i++) {
            mocs_reg->entry.mocs_rarftbr.job[i].num_rec_log = mlxsw_reg_mocs_num_rec_log_get(outbox, 0, i);
            mocs_reg->entry.mocs_rarftbr.job[i].arft_index = mlxsw_reg_mocs_arft_index_get(outbox, 0, i);
        }
        break;
    ...
    case SXD_MOCS_TYPE_PPCNT_V2_SES1_E:
        for (i = 0; i < SXD_MOCS_MOCS_PPCNT_V2_GRP_MASK_NUM; i++) {
            mocs_reg->entry.mocs_ppcnt_v2.grp_mask[i] = mlxsw_reg_mocs_mocs_ppcnt_v2_grp_mask_get(outbox, 0, i);
        }
        mocs_reg->entry.mocs_ppcnt_v2.tc_mask = mlxsw_reg_mocs_mocs_ppcnt_v2_tc_mask_get(outbox);
        mocs_reg->entry.mocs_ppcnt_v2.prio_mask = mlxsw_reg_mocs_mocs_ppcnt_v2_prio_mask_get(outbox);
        mocs_reg->entry.mocs_ppcnt_v2.rx_buffer_mask = mlxsw_reg_mocs_mocs_ppcnt_v2_rx_buffer_mask_get(outbox);
        for (i = 0; i < SXD_MOCS_MOCS_PPCNT_V2_GRP_PRF_NUM; i++) {
            mocs_reg->entry.mocs_ppcnt_v2.grp_prf[i] = mlxsw_reg_mocs_mocs_ppcnt_v2_grp_prf_get(outbox, 0, i);
        }
        mocs_reg->entry.mocs_ppcnt_v2.port_bitmap_size = mlxsw_reg_mocs_mocs_ppcnt_v2_port_bitmap_size_get(outbox);
        for (i = 0; i < mocs_reg->entry.mocs_ppcnt_v2.port_bitmap_size; i++) {
            mocs_reg->entry.mocs_ppcnt_v2.port_mask[i] = mlxsw_reg_mocs_mocs_ppcnt_v2_port_mask_get(outbox, 0, i);
        }
        break;

    case SXD_MOCS_TYPE_PBSR_V2_E:
        mocs_reg->entry.mocs_pbsr_v2.bitmap_size = mlxsw_reg_mocs_mocs_pbsr_v2_bitmap_size_get(outbox);
        for (i = 0; i < mocs_reg->entry.mocs_pbsr_v2.bitmap_size; i++) {
            mocs_reg->entry.mocs_pbsr_v2.port_mask[i] = mlxsw_reg_mocs_mocs_pbsr_v2_port_mask_get(outbox, 0, i);
        }
        break;
...
* MOPCT
***********************************************/
int __MOPCT_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_mopct_reg *mopct_reg = (struct ku_mopct_reg*)ku_reg;
    uint32_t i = 0;

    mlxsw_reg_mopct_cnt_grp_id_set(inbox, mopct_reg->cnt_grp_id);
    mlxsw_reg_mopct_entry_index_set(inbox, mopct_reg->entry_index);
    mlxsw_reg_mopct_num_active_counters_set(inbox, mopct_reg->num_active_counters);
    mlxsw_reg_mopct_op_set(inbox, mopct_reg->op);
    mlxsw_reg_mopct_hw_unit_id_set(inbox, mopct_reg->hw_unit_id);
    mlxsw_reg_mopct_force_set(inbox, mopct_reg->force);
    for (i = 0; i < SXD_MOPCT_ENABLED_COUNTERS_NUM; i++) {
        mlxsw_reg_mopct_enabled_counters_set(inbox, 0, i, mopct_reg->enabled_counters[i]);
    }
...
int __MOPCT_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_mopct_reg *mopct_reg = (struct ku_mopct_reg*)ku_reg;
    uint32_t i = 0;

    mopct_reg->cnt_grp_id = mlxsw_reg_mopct_cnt_grp_id_get(outbox);
    mopct_reg->entry_index = mlxsw_reg_mopct_entry_index_get(outbox);
    mopct_reg->num_active_counters = mlxsw_reg_mopct_num_active_counters_get(outbox);
    mopct_reg->op = mlxsw_reg_mopct_op_get(outbox);
    mopct_reg->hw_unit_id = mlxsw_reg_mopct_hw_unit_id_get(outbox);
    mopct_reg->force = mlxsw_reg_mopct_force_get(outbox);
    for (i = 0; i < SXD_MOPCT_ENABLED_COUNTERS_NUM; i++) {
        mopct_reg->enabled_counters[i] = mlxsw_reg_mopct_enabled_counters_get(outbox, 0, i);
    }


    return 0;
}
EXPORT_SYMBOL(__MOPCT_decode);

int sx_ACCESS_REG_MOPCT(struct sx_dev *dev, struct ku_access_mopct_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_MOPCT_LEN >> 2) + 1;

    if (MLXSW_MOPCT_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
EXPORT_SYMBOL(sx_ACCESS_REG_MOPCT);

int sx_EMAD_ACCESS_REG_MOPCT(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_mopct_reg *reg)
{
    u16 reg_len_dword = (MLXSW_MOPCT_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_MOPCT);

/************************************************
* MOPCS
***********************************************/
int __MOPCS_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_mopcs_reg *mopcs_reg = (struct ku_mopcs_reg*)ku_reg;

    mlxsw_reg_mopcs_local_port_set(inbox, mopcs_reg->local_port);
    mlxsw_reg_mopcs_lp_msb_set(inbox, mopcs_reg->lp_msb);


    return 0;
}

int __MOPCS_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_mopcs_reg *mopcs_reg = (struct ku_mopcs_reg*)ku_reg;

    mopcs_reg->local_port = mlxsw_reg_mopcs_local_port_get(outbox);
    mopcs_reg->lp_msb = mlxsw_reg_mopcs_lp_msb_get(outbox);
    mopcs_reg->dcp_index = mlxsw_reg_mopcs_dcp_index_get(outbox);
    mopcs_reg->kvc_index = mlxsw_reg_mopcs_kvc_index_get(outbox);
    mopcs_reg->plu_index = mlxsw_reg_mopcs_plu_index_get(outbox);
    mopcs_reg->dcm_index = mlxsw_reg_mopcs_dcm_index_get(outbox);
    mopcs_reg->ptb_index = mlxsw_reg_mopcs_ptb_index_get(outbox);
    mopcs_reg->llu_index = mlxsw_reg_mopcs_llu_index_get(outbox);
    mopcs_reg->tile_index = mlxsw_reg_mopcs_tile_index_get(outbox);
    mopcs_reg->tile_plt_index = mlxsw_reg_mopcs_tile_plt_index_get(outbox);
    mopcs_reg->dcp_sub_index = mlxsw_reg_mopcs_dcp_sub_index_get(outbox);
    mopcs_reg->dcm_sub_index = mlxsw_reg_mopcs_dcm_sub_index_get(outbox);
    mopcs_reg->ptb_sub_index = mlxsw_reg_mopcs_ptb_sub_index_get(outbox);
    mopcs_reg->llu_sub_index = mlxsw_reg_mopcs_llu_sub_index_get(outbox);


    return 0;
}
EXPORT_SYMBOL(__MOPCS_decode);

int sx_ACCESS_REG_MOPCS(struct sx_dev *dev, struct ku_access_mopcs_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_MOPCS_LEN >> 2) + 1;

    if (MLXSW_MOPCS_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
EXPORT_SYMBOL(sx_ACCESS_REG_MOPCS);

int sx_EMAD_ACCESS_REG_MOPCS(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_mopcs_reg *reg)
{
    u16 reg_len_dword = (MLXSW_MOPCS_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_MOPCS);

/************************************************
* MOPGCR
***********************************************/
int __MOPGCR_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_mopgcr_reg *mopgcr_reg = (struct ku_mopgcr_reg*)ku_reg;

    mlxsw_reg_mopgcr_perf_cnt_interval_set(inbox, mopgcr_reg->perf_cnt_interval);


    return 0;
}

int __MOPGCR_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_mopgcr_reg *mopgcr_reg = (struct ku_mopgcr_reg*)ku_reg;

    mopgcr_reg->perf_cnt_interval = mlxsw_reg_mopgcr_perf_cnt_interval_get(outbox);


    return 0;
}
EXPORT_SYMBOL(__MOPGCR_decode);

int sx_ACCESS_REG_MOPGCR(struct sx_dev *dev, struct ku_access_mopgcr_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_MOPGCR_LEN >> 2) + 1;

    if (MLXSW_MOPGCR_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
EXPORT_SYMBOL(sx_ACCESS_REG_MOPGCR);

int sx_EMAD_ACCESS_REG_MOPGCR(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_mopgcr_reg *reg)
{
    u16 reg_len_dword = (MLXSW_MOPGCR_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_MOPGCR);
...
int __MTPCPC_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    mlxsw_reg_mtpcpc_egr_phbw_set(inbox, mtpcpc_reg->egr_phbw);
    ...
    mlxsw_reg_mtpcpc_ptp_pkey_set(inbox, mtpcpc_reg->ptp_pkey);
...
int __MTPCPC_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    mtpcpc_reg->egr_phbw = mlxsw_reg_mtpcpc_egr_phbw_get(outbox);
    ...
    mtpcpc_reg->ptp_pkey = mlxsw_reg_mtpcpc_ptp_pkey_get(outbox);
...
int __MFGD_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    mlxsw_reg_mfgd_immediate_interface_release_on_timeout_set(inbox, mfgd_reg->immediate_interface_release_on_timeout);
...
int __MFGD_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    mfgd_reg->immediate_interface_release_on_timeout = mlxsw_reg_mfgd_immediate_interface_release_on_timeout_get(outbox);
...
* MIFGD
***********************************************/
int __MIFGD_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_mifgd_reg *mifgd_reg = (struct ku_mifgd_reg*)ku_reg;

    mlxsw_reg_mifgd_rif_cache_add_flow_disable_set(inbox, mifgd_reg->rif_cache_add_flow_disable);
    mlxsw_reg_mifgd_rif_cache_update_flow_disable_set(inbox, mifgd_reg->rif_cache_update_flow_disable);
    mlxsw_reg_mifgd_rif_cache_phase_update_set(inbox, mifgd_reg->rif_cache_phase_update);
    mlxsw_reg_mifgd_rif_cache_phase_set(inbox, mifgd_reg->rif_cache_phase);
    mlxsw_reg_mifgd_trigger_emad_pipeline_jam_set(inbox, mifgd_reg->trigger_emad_pipeline_jam);
    mlxsw_reg_mifgd_trigger_stack_ovf_set(inbox, mifgd_reg->trigger_stack_ovf);
    mlxsw_reg_mifgd_caches_flush_set(inbox, mifgd_reg->caches_flush);
    mlxsw_reg_mifgd_code_cache_cnt_disable_set(inbox, mifgd_reg->code_cache_cnt_disable);
    mlxsw_reg_mifgd_tcr_debug_enable_set(inbox, mifgd_reg->tcr_debug_enable);
    mlxsw_reg_mifgd_caches_enable_set(inbox, mifgd_reg->caches_enable);
    mlxsw_reg_mifgd_port_init_single_cpu_set(inbox, mifgd_reg->port_init_single_cpu);
    mlxsw_reg_mifgd_restore_acl_group_elements_set(inbox, mifgd_reg->restore_acl_group_elements);
    mlxsw_reg_mifgd_enable_invalid_fatal_cause_event_set(inbox, mifgd_reg->enable_invalid_fatal_cause_event);
    mlxsw_reg_mifgd_atcam_bf_enable_set(inbox, mifgd_reg->atcam_bf_enable);
    mlxsw_reg_mifgd_blocks_egress_enable_set(inbox, mifgd_reg->blocks_egress_enable);


    return 0;
}

int __MIFGD_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_mifgd_reg *mifgd_reg = (struct ku_mifgd_reg*)ku_reg;

    mifgd_reg->rif_cache_add_flow_disable = mlxsw_reg_mifgd_rif_cache_add_flow_disable_get(outbox);
    mifgd_reg->rif_cache_update_flow_disable = mlxsw_reg_mifgd_rif_cache_update_flow_disable_get(outbox);
    mifgd_reg->rif_cache_phase_update = mlxsw_reg_mifgd_rif_cache_phase_update_get(outbox);
    mifgd_reg->rif_cache_phase = mlxsw_reg_mifgd_rif_cache_phase_get(outbox);
    mifgd_reg->caches_flush = mlxsw_reg_mifgd_caches_flush_get(outbox);
    mifgd_reg->code_cache_cnt_disable = mlxsw_reg_mifgd_code_cache_cnt_disable_get(outbox);
    mifgd_reg->caches_enable = mlxsw_reg_mifgd_caches_enable_get(outbox);
    mifgd_reg->enable_invalid_fatal_cause_event = mlxsw_reg_mifgd_enable_invalid_fatal_cause_event_get(outbox);
    mifgd_reg->atcam_bf_enable = mlxsw_reg_mifgd_atcam_bf_enable_get(outbox);
    mifgd_reg->blocks_egress_enable = mlxsw_reg_mifgd_blocks_egress_enable_get(outbox);
    mifgd_reg->fw_init_total_time = mlxsw_reg_mifgd_fw_init_total_time_get(outbox);
    mifgd_reg->fw_init_open_ports_time = mlxsw_reg_mifgd_fw_init_open_ports_time_get(outbox);
    mifgd_reg->boot_time = mlxsw_reg_mifgd_boot_time_get(outbox);
    mifgd_reg->init_tiles_time = mlxsw_reg_mifgd_init_tiles_time_get(outbox);
    mifgd_reg->init_phy_power_time = mlxsw_reg_mifgd_init_phy_power_time_get(outbox);
    mifgd_reg->init_usr_algo_time = mlxsw_reg_mifgd_init_usr_algo_time_get(outbox);
    mifgd_reg->init_gearbox_time = mlxsw_reg_mifgd_init_gearbox_time_get(outbox);
    mifgd_reg->boot_mode = mlxsw_reg_mifgd_boot_mode_get(outbox);


    return 0;
}
EXPORT_SYMBOL(__MIFGD_decode);

int sx_ACCESS_REG_MIFGD(struct sx_dev *dev, struct ku_access_mifgd_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_MIFGD_LEN >> 2) + 1;

    if (MLXSW_MIFGD_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
EXPORT_SYMBOL(sx_ACCESS_REG_MIFGD);

int sx_EMAD_ACCESS_REG_MIFGD(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_mifgd_reg *reg)
{
    u16 reg_len_dword = (MLXSW_MIFGD_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_MIFGD);
...
int __MFDE_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    case SXD_MFDE_EVENT_ID_CRSPACE_TIMEOUT_E:
        ...
        mfde_reg->event_params.crspace_timeout.tile_v = mlxsw_reg_mfde_crspace_timeout_tile_v_get(outbox);
        mfde_reg->event_params.crspace_timeout.tile_index = mlxsw_reg_mfde_crspace_timeout_tile_index_get(outbox);
    ...
    case SXD_MFDE_EVENT_ID_FW_ASSERT_E:
        ...
        for (i = 0; i < SXD_MFDE_FW_ASSERT_ASSERT_STRING_NUM; i++) {
    ...
    case SXD_MFDE_EVENT_ID_RISCV_EXCEPTION_E:
        mfde_reg->event_params.riscv_exception.mepc = mlxsw_reg_mfde_mepc_get(outbox);
        mfde_reg->event_params.riscv_exception.mcause = mlxsw_reg_mfde_mcause_get(outbox);
        mfde_reg->event_params.riscv_exception.mtval = mlxsw_reg_mfde_mtval_get(outbox);
        break;
...
int __SPZR_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    mlxsw_reg_spzr_v_key_h_set(inbox, spzr_reg->v_key_h);
    mlxsw_reg_spzr_v_key_l_set(inbox, spzr_reg->v_key_l);
...
int __SPZR_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    spzr_reg->v_key_h = mlxsw_reg_spzr_v_key_h_get(outbox);
    spzr_reg->v_key_l = mlxsw_reg_spzr_v_key_l_get(outbox);
    ...
    spzr_reg->infrastructure_ip_type = mlxsw_reg_spzr_infrastructure_ip_type_get(outbox);
    spzr_reg->infrastructure_ip = mlxsw_reg_spzr_infrastructure_ip_get(outbox);
...
* IBISSU
***********************************************/
int __IBISSU_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_ibissu_reg *ibissu_reg = (struct ku_ibissu_reg*)ku_reg;

    mlxsw_reg_ibissu_req_to_sm_set(inbox, ibissu_reg->req_to_sm);


    return 0;
}

int __IBISSU_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_ibissu_reg *ibissu_reg = (struct ku_ibissu_reg*)ku_reg;

    ibissu_reg->sm_approve = mlxsw_reg_ibissu_sm_approve_get(outbox);
    ibissu_reg->req_to_sm = mlxsw_reg_ibissu_req_to_sm_get(outbox);


    return 0;
}
EXPORT_SYMBOL(__IBISSU_decode);

int sx_ACCESS_REG_IBISSU(struct sx_dev *dev, struct ku_access_ibissu_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_IBISSU_LEN >> 2) + 1;

    if (MLXSW_IBISSU_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
EXPORT_SYMBOL(sx_ACCESS_REG_IBISSU);

int sx_EMAD_ACCESS_REG_IBISSU(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_ibissu_reg *reg)
{
    u16 reg_len_dword = (MLXSW_IBISSU_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_IBISSU);

/************************************************
* PCAM
***********************************************/
int __PCAM_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_pcam_reg *pcam_reg = (struct ku_pcam_reg*)ku_reg;

    mlxsw_reg_pcam_feature_group_set(inbox, pcam_reg->feature_group);
    mlxsw_reg_pcam_pl_op_set(inbox, pcam_reg->pl_op);
    mlxsw_reg_pcam_access_reg_group_set(inbox, pcam_reg->access_reg_group);


    return 0;
}

int __PCAM_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_pcam_reg *pcam_reg = (struct ku_pcam_reg*)ku_reg;
    uint32_t i = 0;

    pcam_reg->feature_group = mlxsw_reg_pcam_feature_group_get(outbox);
    pcam_reg->pl_op = mlxsw_reg_pcam_pl_op_get(outbox);
    pcam_reg->access_reg_group = mlxsw_reg_pcam_access_reg_group_get(outbox);
    for (i = 0; i < SXD_PCAM_PORT_ACCESS_REG_CAP_MASK_NUM; i++) {
        pcam_reg->port_access_reg_cap_mask[i] = mlxsw_reg_pcam_port_access_reg_cap_mask_get(outbox, 0, i);
    }
    for (i = 0; i < SXD_PCAM_FEATURE_CAP_MASK_NUM; i++) {
        pcam_reg->feature_cap_mask[i] = mlxsw_reg_pcam_feature_cap_mask_get(outbox, 0, i);
    }


    return 0;
}
EXPORT_SYMBOL(__PCAM_decode);

int sx_ACCESS_REG_PCAM(struct sx_dev *dev, struct ku_access_pcam_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_PCAM_LEN >> 2) + 1;

    if (MLXSW_PCAM_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
EXPORT_SYMBOL(sx_ACCESS_REG_PCAM);

int sx_EMAD_ACCESS_REG_PCAM(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_pcam_reg *reg)
{
    u16 reg_len_dword = (MLXSW_PCAM_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_PCAM);
...
int __PTYS_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    mlxsw_reg_ptys_dis_optic_neg_admin_set(inbox, ptys_reg->dis_optic_neg_admin);
    ...
    case SXD_PTYS_PROTO_MASK_NVLINK_E:
        break;
...
int __PTYS_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    ptys_reg->dis_optic_neg_admin = mlxsw_reg_ptys_dis_optic_neg_admin_get(outbox);
    ...
    switch (ptys_reg->proto_mask) {
    case SXD_PTYS_PROTO_MASK_INFINIBAND_E:
        ptys_reg->ext_ib_proto_cap.ptys_ext_proto_ib.ext_proto_ib = mlxsw_reg_ptys_ext_ib_proto_cap_ptys_ext_proto_ib_ext_proto_ib_get(outbox);
        break;

    case SXD_PTYS_PROTO_MASK_NVLINK_E:
        ptys_reg->ext_ib_proto_cap.ptys_ext_proto_nvlink.ext_proto_nvlink = mlxsw_reg_ptys_ext_ib_proto_cap_ext_proto_nvlink_get(outbox);
        break;
    ...
    switch (ptys_reg->proto_mask) {
    case SXD_PTYS_PROTO_MASK_INFINIBAND_E:
        ptys_reg->ext_ib_proto_admin.ptys_ext_proto_ib.ext_proto_ib = mlxsw_reg_ptys_ext_ib_proto_admin_ptys_ext_proto_ib_ext_proto_ib_get(outbox);
        break;

    case SXD_PTYS_PROTO_MASK_NVLINK_E:
        ptys_reg->ext_ib_proto_admin.ptys_ext_proto_nvlink.ext_proto_nvlink = mlxsw_reg_ptys_ext_ib_proto_admin_ext_proto_nvlink_get(outbox);
        break;
    ...
    switch (ptys_reg->proto_mask) {
    case SXD_PTYS_PROTO_MASK_INFINIBAND_E:
        ptys_reg->ext_ib_proto_oper.ptys_ext_proto_ib.ext_proto_ib = mlxsw_reg_ptys_ext_ib_proto_oper_ptys_ext_proto_ib_ext_proto_ib_get(outbox);
        break;

    case SXD_PTYS_PROTO_MASK_NVLINK_E:
        ptys_reg->ext_ib_proto_oper.ptys_ext_proto_nvlink.ext_proto_nvlink = mlxsw_reg_ptys_ext_ib_proto_oper_ext_proto_nvlink_get(outbox);
        break;
...
* PLTC
***********************************************/
int __PLTC_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_pltc_reg *pltc_reg = (struct ku_pltc_reg*)ku_reg;

    mlxsw_reg_pltc_local_port_set(inbox, pltc_reg->local_port);
    mlxsw_reg_pltc_pnat_set(inbox, pltc_reg->pnat);
    mlxsw_reg_pltc_lp_msb_set(inbox, pltc_reg->lp_msb);
    mlxsw_reg_pltc_lane_mask_set(inbox, pltc_reg->lane_mask);
    mlxsw_reg_pltc_gray_rx_admin_set(inbox, pltc_reg->gray_rx_admin);
    mlxsw_reg_pltc_gray_tx_admin_set(inbox, pltc_reg->gray_tx_admin);
    mlxsw_reg_pltc_local_rx_precoding_admin_set(inbox, pltc_reg->local_rx_precoding_admin);
    mlxsw_reg_pltc_local_tx_precoding_admin_set(inbox, pltc_reg->local_tx_precoding_admin);


    return 0;
}

int __PLTC_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_pltc_reg *pltc_reg = (struct ku_pltc_reg*)ku_reg;

    pltc_reg->local_port = mlxsw_reg_pltc_local_port_get(outbox);
    pltc_reg->pnat = mlxsw_reg_pltc_pnat_get(outbox);
    pltc_reg->lp_msb = mlxsw_reg_pltc_lp_msb_get(outbox);
    pltc_reg->lane_mask = mlxsw_reg_pltc_lane_mask_get(outbox);
    pltc_reg->gray_rx_cap = mlxsw_reg_pltc_gray_rx_cap_get(outbox);
    pltc_reg->gray_tx_cap = mlxsw_reg_pltc_gray_tx_cap_get(outbox);
    pltc_reg->ph_pol_rx_cap = mlxsw_reg_pltc_ph_pol_rx_cap_get(outbox);
    pltc_reg->ph_pol_tx_cap = mlxsw_reg_pltc_ph_pol_tx_cap_get(outbox);
    pltc_reg->precoding_cap_mask = mlxsw_reg_pltc_precoding_cap_mask_get(outbox);
    pltc_reg->gray_rx_admin = mlxsw_reg_pltc_gray_rx_admin_get(outbox);
    pltc_reg->gray_tx_admin = mlxsw_reg_pltc_gray_tx_admin_get(outbox);
    pltc_reg->ph_pol_rx_admin = mlxsw_reg_pltc_ph_pol_rx_admin_get(outbox);
    pltc_reg->ph_pol_tx_admin = mlxsw_reg_pltc_ph_pol_tx_admin_get(outbox);
    pltc_reg->local_rx_precoding_admin = mlxsw_reg_pltc_local_rx_precoding_admin_get(outbox);
    pltc_reg->local_tx_precoding_admin = mlxsw_reg_pltc_local_tx_precoding_admin_get(outbox);
    pltc_reg->gray_rx_oper = mlxsw_reg_pltc_gray_rx_oper_get(outbox);
    pltc_reg->gray_tx_oper = mlxsw_reg_pltc_gray_tx_oper_get(outbox);
    pltc_reg->local_rx_precoding_oper = mlxsw_reg_pltc_local_rx_precoding_oper_get(outbox);
    pltc_reg->local_tx_precoding_oper = mlxsw_reg_pltc_local_tx_precoding_oper_get(outbox);


    return 0;
}
EXPORT_SYMBOL(__PLTC_decode);

int sx_ACCESS_REG_PLTC(struct sx_dev *dev, struct ku_access_pltc_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_PLTC_LEN >> 2) + 1;

    if (MLXSW_PLTC_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
EXPORT_SYMBOL(sx_ACCESS_REG_PLTC);

int sx_EMAD_ACCESS_REG_PLTC(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_pltc_reg *reg)
{
    u16 reg_len_dword = (MLXSW_PLTC_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_PLTC);
...
int __PPCNT_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    mlxsw_reg_ppcnt_counters_cap_set(inbox, ppcnt_reg->counters_cap);
    mlxsw_reg_ppcnt_plane_ind_set(inbox, ppcnt_reg->plane_ind);
...
int __PPCNT_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    ppcnt_reg->counters_cap = mlxsw_reg_ppcnt_counters_cap_get(outbox);
    ppcnt_reg->plane_ind = mlxsw_reg_ppcnt_plane_ind_get(outbox);
    ...
    case SXD_PPCNT_GRP_ETHERNET_DISCARD_COUNTERS_E:
        ...
        ppcnt_reg->counter_set.eth_discard_cntrs_grp.egress_link_down_high = mlxsw_reg_ppcnt_egress_link_down_high_get(outbox);
        ppcnt_reg->counter_set.eth_discard_cntrs_grp.egress_link_down_low = mlxsw_reg_ppcnt_egress_link_down_low_get(outbox);
    ...
    case SXD_PPCNT_GRP_PHYSICAL_LAYER_COUNTERS_E:
        ...
        ppcnt_reg->counter_set.phys_layer_cntrs.rs_fec_total_blocks_high = mlxsw_reg_ppcnt_phys_layer_cntrs_rs_fec_total_blocks_high_get(outbox);
        ppcnt_reg->counter_set.phys_layer_cntrs.rs_fec_total_blocks_low = mlxsw_reg_ppcnt_phys_layer_cntrs_rs_fec_total_blocks_low_get(outbox);
        break;
    ...
    case SXD_PPCNT_GRP_PHYSICAL_LAYER_STATISTICAL_COUNTERS_E:
        ...
        ppcnt_reg->counter_set.phys_layer_stat_cntrs.fc_zero_hist = mlxsw_reg_ppcnt_phys_layer_stat_cntrs_fc_zero_hist_get(outbox);
        ...
        ppcnt_reg->counter_set.phys_layer_stat_cntrs.estimated_effective_ber_magnitude = mlxsw_reg_ppcnt_phys_layer_stat_cntrs_estimated_effective_ber_magnitude_get(outbox);
        ppcnt_reg->counter_set.phys_layer_stat_cntrs.estimated_effective_ber_coef_float = mlxsw_reg_ppcnt_phys_layer_stat_cntrs_estimated_effective_ber_coef_float_get(outbox);
        ppcnt_reg->counter_set.phys_layer_stat_cntrs.estimated_effective_ber_coef = mlxsw_reg_ppcnt_phys_layer_stat_cntrs_estimated_effective_ber_coef_get(outbox);
    ...
    case SXD_PPCNT_GRP_RS_FEC_HISTOGRAM_GROUP_E:
        for (i = 0; i < SXD_PPCNT_PPCNT_RS_FEC_HISTOGRAMS_COUNTERS_HIST_NUM; i++) {
    ...
    case SXD_PPCNT_GRP_INFINIBAND_PKTS_COUNTERS_E:
        ...
        ppcnt_reg->counter_set.ppcnt_infiniband_packets_counter.port_llu_rx_icrc_error_high = mlxsw_reg_ppcnt_ppcnt_infiniband_packets_counter_port_llu_rx_icrc_error_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packets_counter.port_llu_rx_icrc_error_low = mlxsw_reg_ppcnt_ppcnt_infiniband_packets_counter_port_llu_rx_icrc_error_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packets_counter.port_tx_parity_error_high = mlxsw_reg_ppcnt_ppcnt_infiniband_packets_counter_port_tx_parity_error_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packets_counter.port_tx_parity_error_low = mlxsw_reg_ppcnt_ppcnt_infiniband_packets_counter_port_tx_parity_error_low_get(outbox);
        break;
    ...
    case SXD_PPCNT_GRP_INFINIBAND_GENERAL_COUNTERS_E:
        ...
        ppcnt_reg->counter_set.ppcnt_infiniband_general_counter.general_receive_discard_external_contain_high = mlxsw_reg_ppcnt_general_receive_discard_external_contain_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_general_counter.general_receive_discard_external_contain_low = mlxsw_reg_ppcnt_general_receive_discard_external_contain_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_general_counter.port_receive_poison_high = mlxsw_reg_ppcnt_port_receive_poison_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_general_counter.port_receive_poison_low = mlxsw_reg_ppcnt_port_receive_poison_low_get(outbox);
        break;
    ...
    case SXD_PPCNT_GRP_L1_GENERAL_COUNTERS_E:
        ...
        ppcnt_reg->counter_set.ppcnt_l1_general_counters.l1_total_entries_high = mlxsw_reg_ppcnt_ppcnt_l1_general_counters_l1_total_entries_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_l1_general_counters.l1_total_entries_low = mlxsw_reg_ppcnt_ppcnt_l1_general_counters_l1_total_entries_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_l1_general_counters.l1_total_local_exits_high = mlxsw_reg_ppcnt_ppcnt_l1_general_counters_l1_total_local_exits_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_l1_general_counters.l1_total_local_exits_low = mlxsw_reg_ppcnt_ppcnt_l1_general_counters_l1_total_local_exits_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_l1_general_counters.l1_total_exits_high = mlxsw_reg_ppcnt_ppcnt_l1_general_counters_l1_total_exits_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_l1_general_counters.l1_total_exits_low = mlxsw_reg_ppcnt_ppcnt_l1_general_counters_l1_total_exits_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_l1_general_counters.relative_high_speed_steady_state_time = mlxsw_reg_ppcnt_ppcnt_l1_general_counters_relative_high_speed_steady_state_time_get(outbox);
        ppcnt_reg->counter_set.ppcnt_l1_general_counters.relative_l1_steady_state_time = mlxsw_reg_ppcnt_ppcnt_l1_general_counters_relative_l1_steady_state_time_get(outbox);
        ppcnt_reg->counter_set.ppcnt_l1_general_counters.relative_other_state_time = mlxsw_reg_ppcnt_ppcnt_l1_general_counters_relative_other_state_time_get(outbox);
        break;

    case SXD_PPCNT_GRP_INFINIBAND_PACKET_SIZE_HISTOGRAM_E:
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_r_9_16_high = mlxsw_reg_ppcnt_cnt_r_9_16_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_r_9_16_low = mlxsw_reg_ppcnt_cnt_r_9_16_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_r_17_32_high = mlxsw_reg_ppcnt_cnt_r_17_32_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_r_17_32_low = mlxsw_reg_ppcnt_cnt_r_17_32_low_get(outbox);
        ...
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_r_65_127_high = mlxsw_reg_ppcnt_cnt_r_65_127_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_r_65_127_low = mlxsw_reg_ppcnt_cnt_r_65_127_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_r_128_255_high = mlxsw_reg_ppcnt_cnt_r_128_255_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_r_128_255_low = mlxsw_reg_ppcnt_cnt_r_128_255_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_r_256_511_high = mlxsw_reg_ppcnt_cnt_r_256_511_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_r_256_511_low = mlxsw_reg_ppcnt_cnt_r_256_511_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_r_512_1023_high = mlxsw_reg_ppcnt_cnt_r_512_1023_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_r_512_1023_low = mlxsw_reg_ppcnt_cnt_r_512_1023_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_r_1024_1518_high = mlxsw_reg_ppcnt_cnt_r_1024_1518_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_r_1024_1518_low = mlxsw_reg_ppcnt_cnt_r_1024_1518_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_r_1519_2047_high = mlxsw_reg_ppcnt_cnt_r_1519_2047_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_r_1519_2047_low = mlxsw_reg_ppcnt_cnt_r_1519_2047_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_r_2048_4095_high = mlxsw_reg_ppcnt_cnt_r_2048_4095_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_r_2048_4095_low = mlxsw_reg_ppcnt_cnt_r_2048_4095_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_r_4096_8191_high = mlxsw_reg_ppcnt_cnt_r_4096_8191_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_r_4096_8191_low = mlxsw_reg_ppcnt_cnt_r_4096_8191_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_r_mtu_high = mlxsw_reg_ppcnt_cnt_r_mtu_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_r_mtu_low = mlxsw_reg_ppcnt_cnt_r_mtu_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_t_9_16_high = mlxsw_reg_ppcnt_cnt_t_9_16_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_t_9_16_low = mlxsw_reg_ppcnt_cnt_t_9_16_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_t_17_32_high = mlxsw_reg_ppcnt_cnt_t_17_32_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_t_17_32_low = mlxsw_reg_ppcnt_cnt_t_17_32_low_get(outbox);
        ...
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_t_65_127_high = mlxsw_reg_ppcnt_cnt_t_65_127_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_t_65_127_low = mlxsw_reg_ppcnt_cnt_t_65_127_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_t_128_255_high = mlxsw_reg_ppcnt_cnt_t_128_255_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_t_128_255_low = mlxsw_reg_ppcnt_cnt_t_128_255_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_t_256_511_high = mlxsw_reg_ppcnt_cnt_t_256_511_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_t_256_511_low = mlxsw_reg_ppcnt_cnt_t_256_511_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_t_512_1023_high = mlxsw_reg_ppcnt_cnt_t_512_1023_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_t_512_1023_low = mlxsw_reg_ppcnt_cnt_t_512_1023_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_t_1024_1518_high = mlxsw_reg_ppcnt_cnt_t_1024_1518_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_t_1024_1518_low = mlxsw_reg_ppcnt_cnt_t_1024_1518_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_t_1519_2047_high = mlxsw_reg_ppcnt_cnt_t_1519_2047_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_t_1519_2047_low = mlxsw_reg_ppcnt_cnt_t_1519_2047_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_t_2048_4095_high = mlxsw_reg_ppcnt_cnt_t_2048_4095_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_t_2048_4095_low = mlxsw_reg_ppcnt_cnt_t_2048_4095_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_t_4096_8191_high = mlxsw_reg_ppcnt_cnt_t_4096_8191_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_t_4096_8191_low = mlxsw_reg_ppcnt_cnt_t_4096_8191_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_t_mtu_high = mlxsw_reg_ppcnt_cnt_t_mtu_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_infiniband_packet_histograms.cnt_t_mtu_low = mlxsw_reg_ppcnt_cnt_t_mtu_low_get(outbox);
        break;
...
* PUDE
***********************************************/
int __PUDE_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_pude_reg *pude_reg = (struct ku_pude_reg*)ku_reg;

    mlxsw_reg_pude_swid_set(inbox, pude_reg->swid);
    mlxsw_reg_pude_local_port_set(inbox, pude_reg->local_port);
    mlxsw_reg_pude_lp_msb_set(inbox, pude_reg->lp_msb);


    return 0;
}

int __PUDE_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_pude_reg *pude_reg = (struct ku_pude_reg*)ku_reg;

    pude_reg->swid = mlxsw_reg_pude_swid_get(outbox);
    pude_reg->local_port = mlxsw_reg_pude_local_port_get(outbox);
    pude_reg->lp_msb = mlxsw_reg_pude_lp_msb_get(outbox);
    pude_reg->admin_status = mlxsw_reg_pude_admin_status_get(outbox);
    pude_reg->oper_status = mlxsw_reg_pude_oper_status_get(outbox);
    pude_reg->local_reason_opcode = mlxsw_reg_pude_local_reason_opcode_get(outbox);
    pude_reg->logical_state_status = mlxsw_reg_pude_logical_state_status_get(outbox);
    pude_reg->physical_state_status = mlxsw_reg_pude_physical_state_status_get(outbox);


    return 0;
}
EXPORT_SYMBOL(__PUDE_decode);

int sx_ACCESS_REG_PUDE(struct sx_dev *dev, struct ku_access_pude_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_PUDE_LEN >> 2) + 1;

    if (MLXSW_PUDE_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
EXPORT_SYMBOL(sx_ACCESS_REG_PUDE);

int sx_EMAD_ACCESS_REG_PUDE(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_pude_reg *reg)
{
    u16 reg_len_dword = (MLXSW_PUDE_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_PUDE);
...
int __PMMP_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    mlxsw_reg_pmmp_apply_im_set(inbox, pmmp_reg->apply_im);
    ...
    case SXD_PMMP_EEPROM_OVERRIDE_OVERRIDE_CABLE_PROTOCOLS_AND_TECHNOLOGY_FOR_SFP_E:
        mlxsw_reg_pmmp_bit_rate_set(inbox, pmmp_reg->sfp_cable_protocol_technology.pmmp_sfp_protocol_bytes_override.bit_rate);
        mlxsw_reg_pmmp_cable_technology_set(inbox, pmmp_reg->sfp_cable_protocol_technology.pmmp_sfp_protocol_bytes_override.cable_technology);
        mlxsw_reg_pmmp_tengig_ethernet_compliance_code_set(inbox, pmmp_reg->sfp_cable_protocol_technology.pmmp_sfp_protocol_bytes_override.tengig_ethernet_compliance_code);
        mlxsw_reg_pmmp_ext_ethernet_compliance_code_set(inbox, pmmp_reg->sfp_cable_protocol_technology.pmmp_sfp_protocol_bytes_override.ext_ethernet_compliance_code);
        mlxsw_reg_pmmp_ethernet_compliance_code_set(inbox, pmmp_reg->sfp_cable_protocol_technology.pmmp_sfp_protocol_bytes_override.ethernet_compliance_code);
        break;
    ...
    mlxsw_reg_pmmp_attenuation_53g_set(inbox, pmmp_reg->attenuation_53g);
    mlxsw_reg_pmmp_module_identifier_set(inbox, pmmp_reg->module_identifier);
...
int __PMMP_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    case SXD_PMMP_EEPROM_OVERRIDE_OVERRIDE_CABLE_PROTOCOLS_AND_TECHNOLOGY_FOR_SFP_E:
        pmmp_reg->sfp_cable_protocol_technology.pmmp_sfp_protocol_bytes_override.bit_rate = mlxsw_reg_pmmp_bit_rate_get(outbox);
        pmmp_reg->sfp_cable_protocol_technology.pmmp_sfp_protocol_bytes_override.cable_technology = mlxsw_reg_pmmp_cable_technology_get(outbox);
        pmmp_reg->sfp_cable_protocol_technology.pmmp_sfp_protocol_bytes_override.tengig_ethernet_compliance_code = mlxsw_reg_pmmp_tengig_ethernet_compliance_code_get(outbox);
        pmmp_reg->sfp_cable_protocol_technology.pmmp_sfp_protocol_bytes_override.ext_ethernet_compliance_code = mlxsw_reg_pmmp_ext_ethernet_compliance_code_get(outbox);
        pmmp_reg->sfp_cable_protocol_technology.pmmp_sfp_protocol_bytes_override.ethernet_compliance_code = mlxsw_reg_pmmp_ethernet_compliance_code_get(outbox);
        break;
    ...
    pmmp_reg->attenuation_53g = mlxsw_reg_pmmp_attenuation_53g_get(outbox);
    pmmp_reg->module_identifier = mlxsw_reg_pmmp_module_identifier_get(outbox);
...
int __PMCR_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    mlxsw_reg_pmcr_dir_dp_ctrl_set(inbox, pmcr_reg->dir_dp_ctrl);
    mlxsw_reg_pmcr_dir_tx_dis_ctrl_set(inbox, pmcr_reg->dir_tx_dis_ctrl);
...
int __PMCR_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    pmcr_reg->dir_dp_ctrl = mlxsw_reg_pmcr_dir_dp_ctrl_get(outbox);
    pmcr_reg->dir_tx_dis_ctrl = mlxsw_reg_pmcr_dir_tx_dis_ctrl_get(outbox);
    pmcr_reg->dir_dp_ctrl_cap = mlxsw_reg_pmcr_dir_dp_ctrl_cap_get(outbox);
    pmcr_reg->dir_tx_dis_ctrl_cap = mlxsw_reg_pmcr_dir_tx_dis_ctrl_cap_get(outbox);
...
int __SLTP_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    if ((sltp_reg->port_type == SXD_SLTP_PORT_TYPE_NEAREND_PORT_E || sltp_reg->port_type == SXD_SLTP_PORT_TYPE_FAREND_PORT_E) && (sltp_reg->version == SXD_SLTP_VERSION_PROD_28NM_E)) {
        ...
        for (i = 0; i < SXD_SLTP_SLTP_GEARBOX_INNER_EYE_NUM; i++) {
    ...
    if ((sltp_reg->port_type == SXD_SLTP_PORT_TYPE_NETWORK_PORT_E || sltp_reg->port_type == SXD_SLTP_PORT_TYPE_INTERNAL_IC_LR_PORT_E) && (sltp_reg->version == SXD_SLTP_VERSION_PROD_7NM_E) && (sltp_reg->conf_mod == SXD_SLTP_CONF_MOD_TX_LINEAR_E)) {
        ...
        mlxsw_reg_sltp_sltp_7nm_ph_pol_admin_set(inbox, sltp_reg->page_data.sltp_7nm.ph_pol_admin);
    }

    if ((sltp_reg->port_type == SXD_SLTP_PORT_TYPE_NETWORK_PORT_E || sltp_reg->port_type == SXD_SLTP_PORT_TYPE_INTERNAL_IC_LR_PORT_E) && (sltp_reg->version == SXD_SLTP_VERSION_PROD_7NM_E) && (sltp_reg->conf_mod == SXD_SLTP_CONF_MOD_TX_LUT_E)) {
    ...
    if ((sltp_reg->port_type == SXD_SLTP_PORT_TYPE_NETWORK_PORT_E || sltp_reg->port_type == SXD_SLTP_PORT_TYPE_INTERNAL_IC_LR_PORT_E) && (sltp_reg->version == SXD_SLTP_VERSION_PROD_5NM_E)) {
        mlxsw_reg_sltp_sltp_5nm_ph_pol_admin_set(inbox, sltp_reg->page_data.sltp_5nm.ph_pol_admin);
        mlxsw_reg_sltp_sltp_5nm_drv_amp_set(inbox, sltp_reg->page_data.sltp_5nm.drv_amp);
        mlxsw_reg_sltp_sltp_5nm_tap3_set(inbox, sltp_reg->page_data.sltp_5nm.tap3);
        mlxsw_reg_sltp_sltp_5nm_tap2_set(inbox, sltp_reg->page_data.sltp_5nm.tap2);
        mlxsw_reg_sltp_sltp_5nm_tap1_set(inbox, sltp_reg->page_data.sltp_5nm.tap1);
        mlxsw_reg_sltp_sltp_5nm_tap0_set(inbox, sltp_reg->page_data.sltp_5nm.tap0);
        mlxsw_reg_sltp_sltp_5nm_tap7_set(inbox, sltp_reg->page_data.sltp_5nm.tap7);
        mlxsw_reg_sltp_sltp_5nm_tap6_set(inbox, sltp_reg->page_data.sltp_5nm.tap6);
        mlxsw_reg_sltp_sltp_5nm_tap5_set(inbox, sltp_reg->page_data.sltp_5nm.tap5);
        mlxsw_reg_sltp_sltp_5nm_tap4_set(inbox, sltp_reg->page_data.sltp_5nm.tap4);
        mlxsw_reg_sltp_sltp_5nm_tap11_set(inbox, sltp_reg->page_data.sltp_5nm.tap11);
        mlxsw_reg_sltp_sltp_5nm_tap10_set(inbox, sltp_reg->page_data.sltp_5nm.tap10);
        mlxsw_reg_sltp_sltp_5nm_tap9_set(inbox, sltp_reg->page_data.sltp_5nm.tap9);
        mlxsw_reg_sltp_sltp_5nm_tap8_set(inbox, sltp_reg->page_data.sltp_5nm.tap8);
    }
...
int __SLTP_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    if ((sltp_reg->port_type == SXD_SLTP_PORT_TYPE_NETWORK_PORT_E || sltp_reg->port_type == SXD_SLTP_PORT_TYPE_INTERNAL_IC_LR_PORT_E) && (sltp_reg->version == SXD_SLTP_VERSION_PROD_7NM_E) && (sltp_reg->conf_mod == SXD_SLTP_CONF_MOD_TX_LINEAR_E)) {
        ...
        sltp_reg->page_data.sltp_7nm.ph_pol_admin = mlxsw_reg_sltp_sltp_7nm_ph_pol_admin_get(outbox);
    }
    ...
    if ((sltp_reg->port_type == SXD_SLTP_PORT_TYPE_NETWORK_PORT_E || sltp_reg->port_type == SXD_SLTP_PORT_TYPE_INTERNAL_IC_LR_PORT_E) && (sltp_reg->version == SXD_SLTP_VERSION_PROD_5NM_E)) {
        sltp_reg->page_data.sltp_5nm.ph_pol_admin = mlxsw_reg_sltp_sltp_5nm_ph_pol_admin_get(outbox);
        sltp_reg->page_data.sltp_5nm.drv_amp = mlxsw_reg_sltp_sltp_5nm_drv_amp_get(outbox);
        sltp_reg->page_data.sltp_5nm.ob_bad_stat = mlxsw_reg_sltp_sltp_5nm_ob_bad_stat_get(outbox);
        sltp_reg->page_data.sltp_5nm.tap3 = mlxsw_reg_sltp_sltp_5nm_tap3_get(outbox);
        sltp_reg->page_data.sltp_5nm.tap2 = mlxsw_reg_sltp_sltp_5nm_tap2_get(outbox);
        sltp_reg->page_data.sltp_5nm.tap1 = mlxsw_reg_sltp_sltp_5nm_tap1_get(outbox);
        sltp_reg->page_data.sltp_5nm.tap0 = mlxsw_reg_sltp_sltp_5nm_tap0_get(outbox);
        sltp_reg->page_data.sltp_5nm.tap7 = mlxsw_reg_sltp_sltp_5nm_tap7_get(outbox);
        sltp_reg->page_data.sltp_5nm.tap6 = mlxsw_reg_sltp_sltp_5nm_tap6_get(outbox);
        sltp_reg->page_data.sltp_5nm.tap5 = mlxsw_reg_sltp_sltp_5nm_tap5_get(outbox);
        sltp_reg->page_data.sltp_5nm.tap4 = mlxsw_reg_sltp_sltp_5nm_tap4_get(outbox);
        sltp_reg->page_data.sltp_5nm.tap11 = mlxsw_reg_sltp_sltp_5nm_tap11_get(outbox);
        sltp_reg->page_data.sltp_5nm.tap10 = mlxsw_reg_sltp_sltp_5nm_tap10_get(outbox);
        sltp_reg->page_data.sltp_5nm.tap9 = mlxsw_reg_sltp_sltp_5nm_tap9_get(outbox);
        sltp_reg->page_data.sltp_5nm.tap8 = mlxsw_reg_sltp_sltp_5nm_tap8_get(outbox);
    }
...
int __PDDR_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    case SXD_PDDR_PAGE_SELECT_PORT_EVENTS_PAGE_E:
        for (i = 0; i < SXD_PDDR_PDDR_PORT_EVENTS_PAGE_LAYOUT_CLR_MASK_NUM; i++) {
    ...
    case SXD_PDDR_PAGE_SELECT_DEVICE_EVENTS_PAGE_E:
        for (i = 0; i < SXD_PDDR_PDDR_DEVICE_EVENTS_PAGE_CLR_MASK_NUM; i++) {
    ...
    case SXD_PDDR_PAGE_SELECT_LINK_DOWN_INFO_BUFFER_E:
        ...
        for (i = 0; i < SXD_PDDR_PDDR_LINK_DOWN_INFO_BUFFER_PAGE_LINK_DOWN_TRACER_NUM; i++) {
            for (j = 0; j < SXD_PDDR_PDDR_LINK_DOWN_INFO_BUFFER_PAGE_ARRAY512_AUTO_NUM; j++) {
    ...
    case SXD_PDDR_PAGE_SELECT_PHY_DEBUG_PAGE_E:
        ...
        mlxsw_reg_pddr_pport_second_set(inbox, pddr_reg->page_data.pddr_phy_debug_page.pport_second);
        mlxsw_reg_pddr_second_port_valid_set(inbox, pddr_reg->page_data.pddr_phy_debug_page.second_port_valid);
        mlxsw_reg_pddr_trigger_cond_port_set(inbox, pddr_reg->page_data.pddr_phy_debug_page.trigger_cond_port);
        mlxsw_reg_pddr_page_index_set(inbox, pddr_reg->page_data.pddr_phy_debug_page.page_index);
        break;
...
int __PDDR_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    case SXD_PDDR_PAGE_SELECT_PHY_INFO_PAGE_E:
        ...
        pddr_reg->page_data.pddr_phy_info_page.phy_manager_disable_mask = mlxsw_reg_pddr_phy_manager_disable_mask_get(outbox);
        ...
        for (i = 0; i < SXD_PDDR_PDDR_PHY_INFO_PAGE_TX_TUNING_STAGES_LANE_NUM; i++) {
    ...
    case SXD_PDDR_PAGE_SELECT_MODULE_INFO_PAGE_E:
        ...
        pddr_reg->page_data.pddr_module_info.cable_attenuation_53g = mlxsw_reg_pddr_cable_attenuation_53g_get(outbox);
        ...
        pddr_reg->page_data.pddr_module_info.cdr_vendor = mlxsw_reg_pddr_cdr_vendor_get(outbox);
    ...
    case SXD_PDDR_PAGE_SELECT_PORT_EVENTS_PAGE_E:
        ...
        pddr_reg->page_data.pddr_port_events_page_layout.merger_tx_eb_underrun = mlxsw_reg_pddr_pddr_port_events_page_layout_merger_tx_eb_underrun_get(outbox);
        pddr_reg->page_data.pddr_port_events_page_layout.bubble_in_pkt = mlxsw_reg_pddr_pddr_port_events_page_layout_bubble_in_pkt_get(outbox);
    ...
    case SXD_PDDR_PAGE_SELECT_LINK_DOWN_INFO_E:
        ...
        pddr_reg->page_data.pddr_link_down_info_page.mean_est_eff_ber_coef = mlxsw_reg_pddr_mean_est_eff_ber_coef_get(outbox);
        pddr_reg->page_data.pddr_link_down_info_page.mean_est_eff_ber_magnitude = mlxsw_reg_pddr_mean_est_eff_ber_magnitude_get(outbox);
        pddr_reg->page_data.pddr_link_down_info_page.min_est_eff_ber_coef = mlxsw_reg_pddr_min_est_eff_ber_coef_get(outbox);
        pddr_reg->page_data.pddr_link_down_info_page.min_est_eff_ber_magnitude = mlxsw_reg_pddr_min_est_eff_ber_magnitude_get(outbox);
        pddr_reg->page_data.pddr_link_down_info_page.max_est_eff_ber_coef = mlxsw_reg_pddr_max_est_eff_ber_coef_get(outbox);
        pddr_reg->page_data.pddr_link_down_info_page.max_est_eff_ber_magnitude = mlxsw_reg_pddr_max_est_eff_ber_magnitude_get(outbox);
        pddr_reg->page_data.pddr_link_down_info_page.num_of_est_eff_ber_warnings = mlxsw_reg_pddr_num_of_est_eff_ber_warnings_get(outbox);
        pddr_reg->page_data.pddr_link_down_info_page.num_of_est_eff_ber_alarms = mlxsw_reg_pddr_num_of_est_eff_ber_alarms_get(outbox);
        break;
    ...
    case SXD_PDDR_PAGE_SELECT_LINK_PARTNER_INFO_PAGE_E:
        ...
        pddr_reg->page_data.pddr_link_partner_info.bubble_agreement = mlxsw_reg_pddr_bubble_agreement_get(outbox);
    ...
    case SXD_PDDR_PAGE_SELECT_PHY_ISR_TRACKING_INFO_PAGE_E:
        ...
        for (i = 0; i < SXD_PDDR_PDDR_PHY_ISR_TRACKING_INFO_PAGE_MAX_TIME_ISR_NUM; i++) {
    ...
    case SXD_PDDR_PAGE_SELECT_PHY_DEBUG_PAGE_E:
        ...
        pddr_reg->page_data.pddr_phy_debug_page.pport_second = mlxsw_reg_pddr_pport_second_get(outbox);
        pddr_reg->page_data.pddr_phy_debug_page.second_port_valid = mlxsw_reg_pddr_second_port_valid_get(outbox);
        pddr_reg->page_data.pddr_phy_debug_page.trigger_cond_port = mlxsw_reg_pddr_trigger_cond_port_get(outbox);
        pddr_reg->page_data.pddr_phy_debug_page.revision = mlxsw_reg_pddr_revision_get(outbox);
        pddr_reg->page_data.pddr_phy_debug_page.page_size = mlxsw_reg_pddr_page_size_get(outbox);
        pddr_reg->page_data.pddr_phy_debug_page.page_index = mlxsw_reg_pddr_page_index_get(outbox);
        for (i = 0; i < SXD_PDDR_PDDR_PHY_DEBUG_PAGE_TRACER_DATA_ENTRY_NUM; i++) {
            pddr_reg->page_data.pddr_phy_debug_page.tracer_data_entry[i] = mlxsw_reg_pddr_tracer_data_entry_get(outbox, 0, i);
        }
        break;
...
* PNLPNR
***********************************************/
int __PNLPNR_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_pnlpnr_reg *pnlpnr_reg = (struct ku_pnlpnr_reg*)ku_reg;

    mlxsw_reg_pnlpnr_local_port_set(inbox, pnlpnr_reg->local_port);
    mlxsw_reg_pnlpnr_lp_msb_set(inbox, pnlpnr_reg->lp_msb);
    mlxsw_reg_pnlpnr_page_req_set(inbox, pnlpnr_reg->page_req);


    return 0;
}

int __PNLPNR_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_pnlpnr_reg *pnlpnr_reg = (struct ku_pnlpnr_reg*)ku_reg;
    uint32_t i = 0;

    pnlpnr_reg->local_port = mlxsw_reg_pnlpnr_local_port_get(outbox);
    pnlpnr_reg->lp_msb = mlxsw_reg_pnlpnr_lp_msb_get(outbox);
    pnlpnr_reg->nlpn_v = mlxsw_reg_pnlpnr_nlpn_v_get(outbox);
    pnlpnr_reg->link_up = mlxsw_reg_pnlpnr_link_up_get(outbox);
    pnlpnr_reg->nlpn_rev = mlxsw_reg_pnlpnr_nlpn_rev_get(outbox);
    pnlpnr_reg->page_req = mlxsw_reg_pnlpnr_page_req_get(outbox);
    pnlpnr_reg->page_valid = mlxsw_reg_pnlpnr_page_valid_get(outbox);
    for (i = 0; i < SXD_PNLPNR_PAGES_NUM; i++) {
        pnlpnr_reg->pages[i] = mlxsw_reg_pnlpnr_pages_get(outbox, 0, i);
    }


    return 0;
}
EXPORT_SYMBOL(__PNLPNR_decode);

int sx_ACCESS_REG_PNLPNR(struct sx_dev *dev, struct ku_access_pnlpnr_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_PNLPNR_LEN >> 2) + 1;

    if (MLXSW_PNLPNR_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
EXPORT_SYMBOL(sx_ACCESS_REG_PNLPNR);

int sx_EMAD_ACCESS_REG_PNLPNR(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_pnlpnr_reg *reg)
{
    u16 reg_len_dword = (MLXSW_PNLPNR_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_PNLPNR);
...
int __PMDR_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    mlxsw_reg_pmdr_plane_ind_set(inbox, pmdr_reg->plane_ind);
    mlxsw_reg_pmdr_lp_msb_set(inbox, pmdr_reg->lp_msb);
    mlxsw_reg_pmdr_lane0_ph_tx_msb_set(inbox, pmdr_reg->lane0_ph_tx_msb);
    mlxsw_reg_pmdr_pll_index_rx_set(inbox, pmdr_reg->pll_index_rx);
...
int __PMDR_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    pmdr_reg->plane_ind = mlxsw_reg_pmdr_plane_ind_get(outbox);
    ...
    pmdr_reg->tile_pport_msb = mlxsw_reg_pmdr_tile_pport_msb_get(outbox);
    pmdr_reg->lbp_query_msb = mlxsw_reg_pmdr_lbp_query_msb_get(outbox);
    ...
    pmdr_reg->pll_cnt_rx = mlxsw_reg_pmdr_pll_cnt_rx_get(outbox);
    ...
    pmdr_reg->pll_cnt_tx = mlxsw_reg_pmdr_pll_cnt_tx_get(outbox);
    ...
    pmdr_reg->lane7_ph_tx_msb = mlxsw_reg_pmdr_lane7_ph_tx_msb_get(outbox);
    pmdr_reg->lane6_ph_tx_msb = mlxsw_reg_pmdr_lane6_ph_tx_msb_get(outbox);
    pmdr_reg->lane5_ph_tx_msb = mlxsw_reg_pmdr_lane5_ph_tx_msb_get(outbox);
    pmdr_reg->lane4_ph_tx_msb = mlxsw_reg_pmdr_lane4_ph_tx_msb_get(outbox);
    pmdr_reg->lane3_ph_tx_msb = mlxsw_reg_pmdr_lane3_ph_tx_msb_get(outbox);
    pmdr_reg->lane2_ph_tx_msb = mlxsw_reg_pmdr_lane2_ph_tx_msb_get(outbox);
    pmdr_reg->lane1_ph_tx_msb = mlxsw_reg_pmdr_lane1_ph_tx_msb_get(outbox);
    pmdr_reg->lane0_ph_tx_msb = mlxsw_reg_pmdr_lane0_ph_tx_msb_get(outbox);
    pmdr_reg->lane7_ph_rx_msb = mlxsw_reg_pmdr_lane7_ph_rx_msb_get(outbox);
    pmdr_reg->lane6_ph_rx_msb = mlxsw_reg_pmdr_lane6_ph_rx_msb_get(outbox);
    pmdr_reg->lane5_ph_rx_msb = mlxsw_reg_pmdr_lane5_ph_rx_msb_get(outbox);
    pmdr_reg->lane4_ph_rx_msb = mlxsw_reg_pmdr_lane4_ph_rx_msb_get(outbox);
    pmdr_reg->lane3_ph_rx_msb = mlxsw_reg_pmdr_lane3_ph_rx_msb_get(outbox);
    pmdr_reg->lane2_ph_rx_msb = mlxsw_reg_pmdr_lane2_ph_rx_msb_get(outbox);
    pmdr_reg->lane1_ph_rx_msb = mlxsw_reg_pmdr_lane1_ph_rx_msb_get(outbox);
    pmdr_reg->lane0_ph_rx_msb = mlxsw_reg_pmdr_lane0_ph_rx_msb_get(outbox);
    pmdr_reg->ph_cluster_tx_cnt = mlxsw_reg_pmdr_ph_cluster_tx_cnt_get(outbox);
    pmdr_reg->ph_cluster_rx_cnt = mlxsw_reg_pmdr_ph_cluster_rx_cnt_get(outbox);
    pmdr_reg->lane7_cluster_tx = mlxsw_reg_pmdr_lane7_cluster_tx_get(outbox);
    pmdr_reg->lane6_cluster_tx = mlxsw_reg_pmdr_lane6_cluster_tx_get(outbox);
    pmdr_reg->lane5_cluster_tx = mlxsw_reg_pmdr_lane5_cluster_tx_get(outbox);
    pmdr_reg->lane4_cluster_tx = mlxsw_reg_pmdr_lane4_cluster_tx_get(outbox);
    pmdr_reg->lane3_cluster_tx = mlxsw_reg_pmdr_lane3_cluster_tx_get(outbox);
    pmdr_reg->lane2_cluster_tx = mlxsw_reg_pmdr_lane2_cluster_tx_get(outbox);
    pmdr_reg->lane1_cluster_tx = mlxsw_reg_pmdr_lane1_cluster_tx_get(outbox);
    pmdr_reg->lane0_cluster_tx = mlxsw_reg_pmdr_lane0_cluster_tx_get(outbox);
    pmdr_reg->pll_index_rx = mlxsw_reg_pmdr_pll_index_rx_get(outbox);
    pmdr_reg->lane7_cluster_rx = mlxsw_reg_pmdr_lane7_cluster_rx_get(outbox);
    pmdr_reg->lane6_cluster_rx = mlxsw_reg_pmdr_lane6_cluster_rx_get(outbox);
    pmdr_reg->lane5_cluster_rx = mlxsw_reg_pmdr_lane5_cluster_rx_get(outbox);
    pmdr_reg->lane4_cluster_rx = mlxsw_reg_pmdr_lane4_cluster_rx_get(outbox);
    pmdr_reg->lane3_cluster_rx = mlxsw_reg_pmdr_lane3_cluster_rx_get(outbox);
    pmdr_reg->lane2_cluster_rx = mlxsw_reg_pmdr_lane2_cluster_rx_get(outbox);
    pmdr_reg->lane1_cluster_rx = mlxsw_reg_pmdr_lane1_cluster_rx_get(outbox);
    pmdr_reg->lane0_cluster_rx = mlxsw_reg_pmdr_lane0_cluster_rx_get(outbox);
...
int __PPHCR_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    mlxsw_reg_pphcr_port_type_set(inbox, pphcr_reg->port_type);
    mlxsw_reg_pphcr_plane_ind_set(inbox, pphcr_reg->plane_ind);
...
int __PPHCR_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    pphcr_reg->port_type = mlxsw_reg_pphcr_port_type_get(outbox);
    pphcr_reg->plane_ind = mlxsw_reg_pphcr_plane_ind_get(outbox);
...
* PPBME
***********************************************/
int __PPBME_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_ppbme_reg *ppbme_reg = (struct ku_ppbme_reg*)ku_reg;

    mlxsw_reg_ppbme_local_port_set(inbox, ppbme_reg->local_port);
    mlxsw_reg_ppbme_pnat_set(inbox, ppbme_reg->pnat);
    mlxsw_reg_ppbme_lp_msb_set(inbox, ppbme_reg->lp_msb);
    mlxsw_reg_ppbme_port_type_set(inbox, ppbme_reg->port_type);
    mlxsw_reg_ppbme_ievent_set(inbox, ppbme_reg->ievent);


    return 0;
}

int __PPBME_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_ppbme_reg *ppbme_reg = (struct ku_ppbme_reg*)ku_reg;

    ppbme_reg->local_port = mlxsw_reg_ppbme_local_port_get(outbox);
    ppbme_reg->pnat = mlxsw_reg_ppbme_pnat_get(outbox);
    ppbme_reg->lp_msb = mlxsw_reg_ppbme_lp_msb_get(outbox);
    ppbme_reg->monitor_type = mlxsw_reg_ppbme_monitor_type_get(outbox);
    ppbme_reg->port_type = mlxsw_reg_ppbme_port_type_get(outbox);
    ppbme_reg->ievent = mlxsw_reg_ppbme_ievent_get(outbox);
    ppbme_reg->monitor_state = mlxsw_reg_ppbme_monitor_state_get(outbox);
    ppbme_reg->peer_monitor_state = mlxsw_reg_ppbme_peer_monitor_state_get(outbox);


    return 0;
}
EXPORT_SYMBOL(__PPBME_decode);

int sx_ACCESS_REG_PPBME(struct sx_dev *dev, struct ku_access_ppbme_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_PPBME_LEN >> 2) + 1;

    if (MLXSW_PPBME_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
int sx_EMAD_ACCESS_REG_PPBME(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_ppbme_reg *reg)
{
    u16 reg_len_dword = (MLXSW_PPBME_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_PPBME);

/************************************************
* PRTL
***********************************************/
int __PRTL_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_prtl_reg *prtl_reg = (struct ku_prtl_reg*)ku_reg;

    mlxsw_reg_prtl_local_port_set(inbox, prtl_reg->local_port);
    mlxsw_reg_prtl_pnat_set(inbox, prtl_reg->pnat);
    mlxsw_reg_prtl_lp_msb_set(inbox, prtl_reg->lp_msb);


    return 0;
}

int __PRTL_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_prtl_reg *prtl_reg = (struct ku_prtl_reg*)ku_reg;

    prtl_reg->rtt_support = mlxsw_reg_prtl_rtt_support_get(outbox);
    prtl_reg->local_port = mlxsw_reg_prtl_local_port_get(outbox);
    prtl_reg->pnat = mlxsw_reg_prtl_pnat_get(outbox);
    prtl_reg->lp_msb = mlxsw_reg_prtl_lp_msb_get(outbox);
    prtl_reg->latency_res = mlxsw_reg_prtl_latency_res_get(outbox);
    prtl_reg->latency_accuracy = mlxsw_reg_prtl_latency_accuracy_get(outbox);
    prtl_reg->local_phy_latency = mlxsw_reg_prtl_local_phy_latency_get(outbox);
    prtl_reg->local_mod_dp_latency = mlxsw_reg_prtl_local_mod_dp_latency_get(outbox);
    prtl_reg->round_trip_latency = mlxsw_reg_prtl_round_trip_latency_get(outbox);


    return 0;
}
EXPORT_SYMBOL(__PRTL_decode);

int sx_ACCESS_REG_PRTL(struct sx_dev *dev, struct ku_access_prtl_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_PRTL_LEN >> 2) + 1;

    if (MLXSW_PRTL_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
EXPORT_SYMBOL(sx_ACCESS_REG_PRTL);

int sx_EMAD_ACCESS_REG_PRTL(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_prtl_reg *reg)
{
    u16 reg_len_dword = (MLXSW_PRTL_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_PRTL);

/************************************************
* PEMI
***********************************************/
int __PEMI_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_pemi_reg *pemi_reg = (struct ku_pemi_reg*)ku_reg;

    mlxsw_reg_pemi_clr_statistic_set(inbox, pemi_reg->clr_statistic);
    mlxsw_reg_pemi_local_port_set(inbox, pemi_reg->local_port);
    mlxsw_reg_pemi_pnat_set(inbox, pemi_reg->pnat);
    mlxsw_reg_pemi_lp_msb_set(inbox, pemi_reg->lp_msb);
    mlxsw_reg_pemi_module_info_ext_set(inbox, pemi_reg->module_info_ext);
    mlxsw_reg_pemi_page_select_set(inbox, pemi_reg->page_select);
    switch (pemi_reg->page_select) {
    case SXD_PEMI_PAGE_SELECT_MODULE_STATUS_SAMPLES_E:
        break;

    case SXD_PEMI_PAGE_SELECT_SNR_SAMPLES_E:
        break;

    case SXD_PEMI_PAGE_SELECT_LASER_MONITORS_SAMPLES_E:
        break;

    case SXD_PEMI_PAGE_SELECT_PAM4_LEVEL_TRANSITION_SAMPLES_E:
        break;

    case SXD_PEMI_PAGE_SELECT_PRE_FEC_BER_SAMPLES_E:
        break;

    case SXD_PEMI_PAGE_SELECT_FERC_SAMPLES_E:
        break;

    case SXD_PEMI_PAGE_SELECT_TEMPERATURE_SAMPLES_E:
        break;

    case SXD_PEMI_PAGE_SELECT_MODULE_STATUS_PROPERTIES_E:
        break;

    case SXD_PEMI_PAGE_SELECT_SNR_PROPERTIES_E:
        break;

    case SXD_PEMI_PAGE_SELECT_LASER_MONITORS_PROPERTIES_E:
        break;

    case SXD_PEMI_PAGE_SELECT_PAM4_LEVEL_TRANSITION_PROPERTIES_E:
        break;

    case SXD_PEMI_PAGE_SELECT_PRE_FEC_BER_PROPERTIES_E:
        break;

    case SXD_PEMI_PAGE_SELECT_FERC_PROPERTIES_E:
        break;

    case SXD_PEMI_PAGE_SELECT_TEMPERATURE_PROPERTIES_E:
        break;
...
int __PEMI_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_pemi_reg *pemi_reg = (struct ku_pemi_reg*)ku_reg;

    pemi_reg->clr_statistic = mlxsw_reg_pemi_clr_statistic_get(outbox);
    pemi_reg->local_port = mlxsw_reg_pemi_local_port_get(outbox);
    pemi_reg->pnat = mlxsw_reg_pemi_pnat_get(outbox);
    pemi_reg->lp_msb = mlxsw_reg_pemi_lp_msb_get(outbox);
    pemi_reg->module_info_ext = mlxsw_reg_pemi_module_info_ext_get(outbox);
    pemi_reg->status = mlxsw_reg_pemi_status_get(outbox);
    pemi_reg->group_cap_mask = mlxsw_reg_pemi_group_cap_mask_get(outbox);
    pemi_reg->page_select = mlxsw_reg_pemi_page_select_get(outbox);
    switch (pemi_reg->page_select) {
    case SXD_PEMI_PAGE_SELECT_MODULE_STATUS_SAMPLES_E:
        pemi_reg->page_data.pemi_module_status_samples.voltage = mlxsw_reg_pemi_voltage_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.rx_power_lane0 = mlxsw_reg_pemi_rx_power_lane0_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.rx_power_lane1 = mlxsw_reg_pemi_rx_power_lane1_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.rx_power_lane2 = mlxsw_reg_pemi_rx_power_lane2_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.rx_power_lane3 = mlxsw_reg_pemi_rx_power_lane3_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.rx_power_lane4 = mlxsw_reg_pemi_rx_power_lane4_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.rx_power_lane5 = mlxsw_reg_pemi_rx_power_lane5_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.rx_power_lane6 = mlxsw_reg_pemi_rx_power_lane6_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.rx_power_lane7 = mlxsw_reg_pemi_rx_power_lane7_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.tx_power_lane0 = mlxsw_reg_pemi_tx_power_lane0_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.tx_power_lane1 = mlxsw_reg_pemi_tx_power_lane1_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.tx_power_lane2 = mlxsw_reg_pemi_tx_power_lane2_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.tx_power_lane3 = mlxsw_reg_pemi_tx_power_lane3_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.tx_power_lane4 = mlxsw_reg_pemi_tx_power_lane4_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.tx_power_lane5 = mlxsw_reg_pemi_tx_power_lane5_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.tx_power_lane6 = mlxsw_reg_pemi_tx_power_lane6_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.tx_power_lane7 = mlxsw_reg_pemi_tx_power_lane7_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.tx_bias_lane0 = mlxsw_reg_pemi_tx_bias_lane0_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.tx_bias_lane1 = mlxsw_reg_pemi_tx_bias_lane1_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.tx_bias_lane2 = mlxsw_reg_pemi_tx_bias_lane2_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.tx_bias_lane3 = mlxsw_reg_pemi_tx_bias_lane3_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.tx_bias_lane4 = mlxsw_reg_pemi_tx_bias_lane4_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.tx_bias_lane5 = mlxsw_reg_pemi_tx_bias_lane5_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.tx_bias_lane6 = mlxsw_reg_pemi_tx_bias_lane6_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.tx_bias_lane7 = mlxsw_reg_pemi_tx_bias_lane7_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.module_st = mlxsw_reg_pemi_module_st_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.dp_st_lane0 = mlxsw_reg_pemi_dp_st_lane0_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.dp_st_lane1 = mlxsw_reg_pemi_dp_st_lane1_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.dp_st_lane2 = mlxsw_reg_pemi_dp_st_lane2_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.dp_st_lane3 = mlxsw_reg_pemi_dp_st_lane3_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.dp_st_lane4 = mlxsw_reg_pemi_dp_st_lane4_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.dp_st_lane5 = mlxsw_reg_pemi_dp_st_lane5_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.dp_st_lane6 = mlxsw_reg_pemi_dp_st_lane6_get(outbox);
        pemi_reg->page_data.pemi_module_status_samples.dp_st_lane7 = mlxsw_reg_pemi_dp_st_lane7_get(outbox);
        break;

    case SXD_PEMI_PAGE_SELECT_SNR_SAMPLES_E:
        pemi_reg->page_data.pemi_snr_samples.snr_media_lane0 = mlxsw_reg_pemi_snr_media_lane0_get(outbox);
        pemi_reg->page_data.pemi_snr_samples.snr_media_lane1 = mlxsw_reg_pemi_snr_media_lane1_get(outbox);
        pemi_reg->page_data.pemi_snr_samples.snr_media_lane2 = mlxsw_reg_pemi_snr_media_lane2_get(outbox);
        pemi_reg->page_data.pemi_snr_samples.snr_media_lane3 = mlxsw_reg_pemi_snr_media_lane3_get(outbox);
        pemi_reg->page_data.pemi_snr_samples.snr_media_lane4 = mlxsw_reg_pemi_snr_media_lane4_get(outbox);
        pemi_reg->page_data.pemi_snr_samples.snr_media_lane5 = mlxsw_reg_pemi_snr_media_lane5_get(outbox);
        pemi_reg->page_data.pemi_snr_samples.snr_media_lane6 = mlxsw_reg_pemi_snr_media_lane6_get(outbox);
        pemi_reg->page_data.pemi_snr_samples.snr_media_lane7 = mlxsw_reg_pemi_snr_media_lane7_get(outbox);
        pemi_reg->page_data.pemi_snr_samples.snr_host_lane0 = mlxsw_reg_pemi_snr_host_lane0_get(outbox);
        pemi_reg->page_data.pemi_snr_samples.snr_host_lane1 = mlxsw_reg_pemi_snr_host_lane1_get(outbox);
        pemi_reg->page_data.pemi_snr_samples.snr_host_lane2 = mlxsw_reg_pemi_snr_host_lane2_get(outbox);
        pemi_reg->page_data.pemi_snr_samples.snr_host_lane3 = mlxsw_reg_pemi_snr_host_lane3_get(outbox);
        pemi_reg->page_data.pemi_snr_samples.snr_host_lane4 = mlxsw_reg_pemi_snr_host_lane4_get(outbox);
        pemi_reg->page_data.pemi_snr_samples.snr_host_lane5 = mlxsw_reg_pemi_snr_host_lane5_get(outbox);
        pemi_reg->page_data.pemi_snr_samples.snr_host_lane6 = mlxsw_reg_pemi_snr_host_lane6_get(outbox);
        pemi_reg->page_data.pemi_snr_samples.snr_host_lane7 = mlxsw_reg_pemi_snr_host_lane7_get(outbox);
        break;

    case SXD_PEMI_PAGE_SELECT_LASER_MONITORS_SAMPLES_E:
        pemi_reg->page_data.pemi_laser_monitors_samples.laser_age = mlxsw_reg_pemi_laser_age_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_samples.tec_current = mlxsw_reg_pemi_tec_current_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_samples.laser_frequency_error_lane0 = mlxsw_reg_pemi_laser_frequency_error_lane0_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_samples.laser_frequency_error_lane1 = mlxsw_reg_pemi_laser_frequency_error_lane1_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_samples.laser_frequency_error_lane2 = mlxsw_reg_pemi_laser_frequency_error_lane2_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_samples.laser_frequency_error_lane3 = mlxsw_reg_pemi_laser_frequency_error_lane3_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_samples.laser_frequency_error_lane4 = mlxsw_reg_pemi_laser_frequency_error_lane4_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_samples.laser_frequency_error_lane5 = mlxsw_reg_pemi_laser_frequency_error_lane5_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_samples.laser_frequency_error_lane6 = mlxsw_reg_pemi_laser_frequency_error_lane6_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_samples.laser_frequency_error_lane7 = mlxsw_reg_pemi_laser_frequency_error_lane7_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_samples.cooled_laser_temperature_lane0 = mlxsw_reg_pemi_cooled_laser_temperature_lane0_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_samples.cooled_laser_temperature_lane1 = mlxsw_reg_pemi_cooled_laser_temperature_lane1_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_samples.cooled_laser_temperature_lane2 = mlxsw_reg_pemi_cooled_laser_temperature_lane2_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_samples.cooled_laser_temperature_lane3 = mlxsw_reg_pemi_cooled_laser_temperature_lane3_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_samples.cooled_laser_temperature_lane4 = mlxsw_reg_pemi_cooled_laser_temperature_lane4_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_samples.cooled_laser_temperature_lane5 = mlxsw_reg_pemi_cooled_laser_temperature_lane5_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_samples.cooled_laser_temperature_lane6 = mlxsw_reg_pemi_cooled_laser_temperature_lane6_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_samples.cooled_laser_temperature_lane7 = mlxsw_reg_pemi_cooled_laser_temperature_lane7_get(outbox);
        break;

    case SXD_PEMI_PAGE_SELECT_PAM4_LEVEL_TRANSITION_SAMPLES_E:
        pemi_reg->page_data.pemi_pam4_level_transition_samples.pam4_level_transition_media_lane0 = mlxsw_reg_pemi_pam4_level_transition_media_lane0_get(outbox);
        pemi_reg->page_data.pemi_pam4_level_transition_samples.pam4_level_transition_media_lane1 = mlxsw_reg_pemi_pam4_level_transition_media_lane1_get(outbox);
        pemi_reg->page_data.pemi_pam4_level_transition_samples.pam4_level_transition_media_lane2 = mlxsw_reg_pemi_pam4_level_transition_media_lane2_get(outbox);
        pemi_reg->page_data.pemi_pam4_level_transition_samples.pam4_level_transition_media_lane3 = mlxsw_reg_pemi_pam4_level_transition_media_lane3_get(outbox);
        pemi_reg->page_data.pemi_pam4_level_transition_samples.pam4_level_transition_media_lane4 = mlxsw_reg_pemi_pam4_level_transition_media_lane4_get(outbox);
        pemi_reg->page_data.pemi_pam4_level_transition_samples.pam4_level_transition_media_lane5 = mlxsw_reg_pemi_pam4_level_transition_media_lane5_get(outbox);
        pemi_reg->page_data.pemi_pam4_level_transition_samples.pam4_level_transition_media_lane6 = mlxsw_reg_pemi_pam4_level_transition_media_lane6_get(outbox);
        pemi_reg->page_data.pemi_pam4_level_transition_samples.pam4_level_transition_media_lane7 = mlxsw_reg_pemi_pam4_level_transition_media_lane7_get(outbox);
        pemi_reg->page_data.pemi_pam4_level_transition_samples.pam4_level_transition_host_lane0 = mlxsw_reg_pemi_pam4_level_transition_host_lane0_get(outbox);
        pemi_reg->page_data.pemi_pam4_level_transition_samples.pam4_level_transition_host_lane1 = mlxsw_reg_pemi_pam4_level_transition_host_lane1_get(outbox);
        pemi_reg->page_data.pemi_pam4_level_transition_samples.pam4_level_transition_host_lane2 = mlxsw_reg_pemi_pam4_level_transition_host_lane2_get(outbox);
        pemi_reg->page_data.pemi_pam4_level_transition_samples.pam4_level_transition_host_lane3 = mlxsw_reg_pemi_pam4_level_transition_host_lane3_get(outbox);
        pemi_reg->page_data.pemi_pam4_level_transition_samples.pam4_level_transition_host_lane4 = mlxsw_reg_pemi_pam4_level_transition_host_lane4_get(outbox);
        pemi_reg->page_data.pemi_pam4_level_transition_samples.pam4_level_transition_host_lane5 = mlxsw_reg_pemi_pam4_level_transition_host_lane5_get(outbox);
        pemi_reg->page_data.pemi_pam4_level_transition_samples.pam4_level_transition_host_lane6 = mlxsw_reg_pemi_pam4_level_transition_host_lane6_get(outbox);
        pemi_reg->page_data.pemi_pam4_level_transition_samples.pam4_level_transition_host_lane7 = mlxsw_reg_pemi_pam4_level_transition_host_lane7_get(outbox);
        break;

    case SXD_PEMI_PAGE_SELECT_PRE_FEC_BER_SAMPLES_E:
        pemi_reg->page_data.pemi_pre_fec_ber_samples.pre_fec_ber_min_media = mlxsw_reg_pemi_pre_fec_ber_min_media_get(outbox);
        pemi_reg->page_data.pemi_pre_fec_ber_samples.pre_fec_ber_min_host = mlxsw_reg_pemi_pre_fec_ber_min_host_get(outbox);
        pemi_reg->page_data.pemi_pre_fec_ber_samples.pre_fec_ber_max_media = mlxsw_reg_pemi_pre_fec_ber_max_media_get(outbox);
        pemi_reg->page_data.pemi_pre_fec_ber_samples.pre_fec_ber_max_host = mlxsw_reg_pemi_pre_fec_ber_max_host_get(outbox);
        pemi_reg->page_data.pemi_pre_fec_ber_samples.pre_fec_ber_avg_media = mlxsw_reg_pemi_pre_fec_ber_avg_media_get(outbox);
        pemi_reg->page_data.pemi_pre_fec_ber_samples.pre_fec_ber_avg_host = mlxsw_reg_pemi_pre_fec_ber_avg_host_get(outbox);
        pemi_reg->page_data.pemi_pre_fec_ber_samples.pre_fec_ber_val_media = mlxsw_reg_pemi_pre_fec_ber_val_media_get(outbox);
        pemi_reg->page_data.pemi_pre_fec_ber_samples.pre_fec_ber_val_host = mlxsw_reg_pemi_pre_fec_ber_val_host_get(outbox);
        break;

    case SXD_PEMI_PAGE_SELECT_FERC_SAMPLES_E:
        pemi_reg->page_data.pemi_ferc_samples.ferc_min_media = mlxsw_reg_pemi_ferc_min_media_get(outbox);
        pemi_reg->page_data.pemi_ferc_samples.ferc_min_host = mlxsw_reg_pemi_ferc_min_host_get(outbox);
        pemi_reg->page_data.pemi_ferc_samples.ferc_max_media = mlxsw_reg_pemi_ferc_max_media_get(outbox);
        pemi_reg->page_data.pemi_ferc_samples.ferc_max_host = mlxsw_reg_pemi_ferc_max_host_get(outbox);
        pemi_reg->page_data.pemi_ferc_samples.ferc_avg_media = mlxsw_reg_pemi_ferc_avg_media_get(outbox);
        pemi_reg->page_data.pemi_ferc_samples.ferc_avg_host = mlxsw_reg_pemi_ferc_avg_host_get(outbox);
        pemi_reg->page_data.pemi_ferc_samples.ferc_val_media = mlxsw_reg_pemi_ferc_val_media_get(outbox);
        pemi_reg->page_data.pemi_ferc_samples.ferc_val_host = mlxsw_reg_pemi_ferc_val_host_get(outbox);
        break;

    case SXD_PEMI_PAGE_SELECT_TEMPERATURE_SAMPLES_E:
        pemi_reg->page_data.pemi_temperature_samples.module_temp = mlxsw_reg_pemi_module_temp_get(outbox);
        pemi_reg->page_data.pemi_temperature_samples.uc_temp = mlxsw_reg_pemi_uc_temp_get(outbox);
        pemi_reg->page_data.pemi_temperature_samples.lasers0_temp = mlxsw_reg_pemi_lasers0_temp_get(outbox);
        pemi_reg->page_data.pemi_temperature_samples.lasers1_temp = mlxsw_reg_pemi_lasers1_temp_get(outbox);
        pemi_reg->page_data.pemi_temperature_samples.cdr0_temp = mlxsw_reg_pemi_cdr0_temp_get(outbox);
        pemi_reg->page_data.pemi_temperature_samples.cdr1_temp = mlxsw_reg_pemi_cdr1_temp_get(outbox);
        pemi_reg->page_data.pemi_temperature_samples.cdr2_temp = mlxsw_reg_pemi_cdr2_temp_get(outbox);
        pemi_reg->page_data.pemi_temperature_samples.cdr3_temp = mlxsw_reg_pemi_cdr3_temp_get(outbox);
        break;

    case SXD_PEMI_PAGE_SELECT_MODULE_STATUS_PROPERTIES_E:
        pemi_reg->page_data.pemi_module_status_properties.module_status_cap = mlxsw_reg_pemi_module_status_cap_get(outbox);
        pemi_reg->page_data.pemi_module_status_properties.voltage_high_alarm = mlxsw_reg_pemi_voltage_high_alarm_get(outbox);
        pemi_reg->page_data.pemi_module_status_properties.voltage_low_alarm = mlxsw_reg_pemi_voltage_low_alarm_get(outbox);
        pemi_reg->page_data.pemi_module_status_properties.voltage_high_warning = mlxsw_reg_pemi_voltage_high_warning_get(outbox);
        pemi_reg->page_data.pemi_module_status_properties.voltage_low_warning = mlxsw_reg_pemi_voltage_low_warning_get(outbox);
        pemi_reg->page_data.pemi_module_status_properties.rx_power_high_alarm = mlxsw_reg_pemi_rx_power_high_alarm_get(outbox);
        pemi_reg->page_data.pemi_module_status_properties.rx_power_low_alarm = mlxsw_reg_pemi_rx_power_low_alarm_get(outbox);
        pemi_reg->page_data.pemi_module_status_properties.rx_power_high_warning = mlxsw_reg_pemi_rx_power_high_warning_get(outbox);
        pemi_reg->page_data.pemi_module_status_properties.rx_power_low_warning = mlxsw_reg_pemi_rx_power_low_warning_get(outbox);
        pemi_reg->page_data.pemi_module_status_properties.tx_power_high_alarm = mlxsw_reg_pemi_tx_power_high_alarm_get(outbox);
        pemi_reg->page_data.pemi_module_status_properties.tx_power_low_alarm = mlxsw_reg_pemi_tx_power_low_alarm_get(outbox);
        pemi_reg->page_data.pemi_module_status_properties.tx_power_high_warning = mlxsw_reg_pemi_tx_power_high_warning_get(outbox);
        pemi_reg->page_data.pemi_module_status_properties.tx_power_low_warning = mlxsw_reg_pemi_tx_power_low_warning_get(outbox);
        pemi_reg->page_data.pemi_module_status_properties.tx_bias_high_alarm = mlxsw_reg_pemi_tx_bias_high_alarm_get(outbox);
        pemi_reg->page_data.pemi_module_status_properties.tx_bias_low_alarm = mlxsw_reg_pemi_tx_bias_low_alarm_get(outbox);
        pemi_reg->page_data.pemi_module_status_properties.tx_bias_high_warning = mlxsw_reg_pemi_tx_bias_high_warning_get(outbox);
        pemi_reg->page_data.pemi_module_status_properties.tx_bias_low_warning = mlxsw_reg_pemi_tx_bias_low_warning_get(outbox);
        break;

    case SXD_PEMI_PAGE_SELECT_SNR_PROPERTIES_E:
        pemi_reg->page_data.pemi_snr_properties.snr_cap = mlxsw_reg_pemi_snr_cap_get(outbox);
        pemi_reg->page_data.pemi_snr_properties.snr_media_low_alarm = mlxsw_reg_pemi_snr_media_low_alarm_get(outbox);
        pemi_reg->page_data.pemi_snr_properties.snr_media_low_warning = mlxsw_reg_pemi_snr_media_low_warning_get(outbox);
        pemi_reg->page_data.pemi_snr_properties.snr_host_low_alarm = mlxsw_reg_pemi_snr_host_low_alarm_get(outbox);
        pemi_reg->page_data.pemi_snr_properties.snr_host_low_warning = mlxsw_reg_pemi_snr_host_low_warning_get(outbox);
        break;

    case SXD_PEMI_PAGE_SELECT_LASER_MONITORS_PROPERTIES_E:
        pemi_reg->page_data.pemi_laser_monitors_properties.laser_monitor_cap = mlxsw_reg_pemi_laser_monitor_cap_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_properties.laser_age_high_alarm = mlxsw_reg_pemi_laser_age_high_alarm_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_properties.laser_age_high_warning = mlxsw_reg_pemi_laser_age_high_warning_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_properties.tec_current_high_alarm = mlxsw_reg_pemi_tec_current_high_alarm_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_properties.tec_current_low_alarm = mlxsw_reg_pemi_tec_current_low_alarm_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_properties.tec_current_high_warning = mlxsw_reg_pemi_tec_current_high_warning_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_properties.tec_current_low_warning = mlxsw_reg_pemi_tec_current_low_warning_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_properties.laser_frequency_error_high_alarm = mlxsw_reg_pemi_laser_frequency_error_high_alarm_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_properties.laser_frequency_error_high_warning = mlxsw_reg_pemi_laser_frequency_error_high_warning_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_properties.cooled_laser_temp_high_alarm = mlxsw_reg_pemi_cooled_laser_temp_high_alarm_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_properties.cooled_laser_temp_low_alarm = mlxsw_reg_pemi_cooled_laser_temp_low_alarm_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_properties.cooled_laser_temp_high_warning = mlxsw_reg_pemi_cooled_laser_temp_high_warning_get(outbox);
        pemi_reg->page_data.pemi_laser_monitors_properties.cooled_laser_temp_low_warning = mlxsw_reg_pemi_cooled_laser_temp_low_warning_get(outbox);
        break;

    case SXD_PEMI_PAGE_SELECT_PAM4_LEVEL_TRANSITION_PROPERTIES_E:
        pemi_reg->page_data.pemi_pam4_level_transition_properties.pam4_level_transition_cap = mlxsw_reg_pemi_pam4_level_transition_cap_get(outbox);
        pemi_reg->page_data.pemi_pam4_level_transition_properties.pam4_level_transition_media_low_alarm = mlxsw_reg_pemi_pam4_level_transition_media_low_alarm_get(outbox);
        pemi_reg->page_data.pemi_pam4_level_transition_properties.pam4_level_transition_media_low_warning = mlxsw_reg_pemi_pam4_level_transition_media_low_warning_get(outbox);
        pemi_reg->page_data.pemi_pam4_level_transition_properties.pam4_level_transition_host_low_alarm = mlxsw_reg_pemi_pam4_level_transition_host_low_alarm_get(outbox);
        pemi_reg->page_data.pemi_pam4_level_transition_properties.pam4_level_transition_host_low_warning = mlxsw_reg_pemi_pam4_level_transition_host_low_warning_get(outbox);
        break;

    case SXD_PEMI_PAGE_SELECT_PRE_FEC_BER_PROPERTIES_E:
        pemi_reg->page_data.pemi_pre_fec_ber_properties.pre_fec_ber_cap = mlxsw_reg_pemi_pre_fec_ber_cap_get(outbox);
        pemi_reg->page_data.pemi_pre_fec_ber_properties.pre_fec_ber_min_high_media_alarm = mlxsw_reg_pemi_pre_fec_ber_min_high_media_alarm_get(outbox);
        pemi_reg->page_data.pemi_pre_fec_ber_properties.pre_fec_ber_min_high_media_warning = mlxsw_reg_pemi_pre_fec_ber_min_high_media_warning_get(outbox);
        pemi_reg->page_data.pemi_pre_fec_ber_properties.pre_fec_ber_min_high_host_alarm = mlxsw_reg_pemi_pre_fec_ber_min_high_host_alarm_get(outbox);
        pemi_reg->page_data.pemi_pre_fec_ber_properties.pre_fec_ber_min_high_host_warning = mlxsw_reg_pemi_pre_fec_ber_min_high_host_warning_get(outbox);
        pemi_reg->page_data.pemi_pre_fec_ber_properties.pre_fec_ber_max_high_media_alarm = mlxsw_reg_pemi_pre_fec_ber_max_high_media_alarm_get(outbox);
        pemi_reg->page_data.pemi_pre_fec_ber_properties.pre_fec_ber_max_high_media_warning = mlxsw_reg_pemi_pre_fec_ber_max_high_media_warning_get(outbox);
        pemi_reg->page_data.pemi_pre_fec_ber_properties.pre_fec_ber_max_high_host_alarm = mlxsw_reg_pemi_pre_fec_ber_max_high_host_alarm_get(outbox);
        pemi_reg->page_data.pemi_pre_fec_ber_properties.pre_fec_ber_max_high_host_warning = mlxsw_reg_pemi_pre_fec_ber_max_high_host_warning_get(outbox);
        pemi_reg->page_data.pemi_pre_fec_ber_properties.pre_fec_ber_avg_high_media_alarm = mlxsw_reg_pemi_pre_fec_ber_avg_high_media_alarm_get(outbox);
        pemi_reg->page_data.pemi_pre_fec_ber_properties.pre_fec_ber_avg_high_media_warning = mlxsw_reg_pemi_pre_fec_ber_avg_high_media_warning_get(outbox);
        pemi_reg->page_data.pemi_pre_fec_ber_properties.pre_fec_ber_avg_high_host_alarm = mlxsw_reg_pemi_pre_fec_ber_avg_high_host_alarm_get(outbox);
        pemi_reg->page_data.pemi_pre_fec_ber_properties.pre_fec_ber_avg_high_host_warning = mlxsw_reg_pemi_pre_fec_ber_avg_high_host_warning_get(outbox);
        break;

    case SXD_PEMI_PAGE_SELECT_FERC_PROPERTIES_E:
        pemi_reg->page_data.pemi_ferc_properties.ferc_cap = mlxsw_reg_pemi_ferc_cap_get(outbox);
        break;

    case SXD_PEMI_PAGE_SELECT_TEMPERATURE_PROPERTIES_E:
        pemi_reg->page_data.pemi_temperature_properties.temp_cap = mlxsw_reg_pemi_temp_cap_get(outbox);
        pemi_reg->page_data.pemi_temperature_properties.temp_high_alarm = mlxsw_reg_pemi_temp_high_alarm_get(outbox);
        pemi_reg->page_data.pemi_temperature_properties.temp_low_alarm = mlxsw_reg_pemi_temp_low_alarm_get(outbox);
        pemi_reg->page_data.pemi_temperature_properties.temp_high_warning = mlxsw_reg_pemi_temp_high_warning_get(outbox);
        pemi_reg->page_data.pemi_temperature_properties.temp_low_warning = mlxsw_reg_pemi_temp_low_warning_get(outbox);
        break;
...
EXPORT_SYMBOL(__PEMI_decode);

int sx_ACCESS_REG_PEMI(struct sx_dev *dev, struct ku_access_pemi_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_PEMI_LEN >> 2) + 1;

    if (MLXSW_PEMI_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
EXPORT_SYMBOL(sx_ACCESS_REG_PEMI);

int sx_EMAD_ACCESS_REG_PEMI(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_pemi_reg *reg)
{
    u16 reg_len_dword = (MLXSW_PEMI_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_PEMI);
...
int __PMTU_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    mlxsw_reg_pmtu_protocol_set(inbox, pmtu_reg->protocol);
...
int __PMTU_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    pmtu_reg->protocol = mlxsw_reg_pmtu_protocol_get(outbox);
...
int __PPIR_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    ppir_reg->lpnf_no_hcd = mlxsw_reg_ppir_lpnf_no_hcd_get(outbox);
    ppir_reg->lpnf_phy = mlxsw_reg_ppir_lpnf_phy_get(outbox);
    ppir_reg->lcnf_pln = mlxsw_reg_ppir_lcnf_pln_get(outbox);
...
* PCMR
***********************************************/
int __PCMR_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_pcmr_reg *pcmr_reg = (struct ku_pcmr_reg*)ku_reg;

    mlxsw_reg_pcmr_local_port_set(inbox, pcmr_reg->local_port);
    mlxsw_reg_pcmr_lp_msb_set(inbox, pcmr_reg->lp_msb);
    mlxsw_reg_pcmr_tx_ts_over_crc_set(inbox, pcmr_reg->tx_ts_over_crc);
    mlxsw_reg_pcmr_tx_fcs_recalc_set(inbox, pcmr_reg->tx_fcs_recalc);
    mlxsw_reg_pcmr_rx_fcs_drop_set(inbox, pcmr_reg->rx_fcs_drop);
    mlxsw_reg_pcmr_rx_ts_over_crc_set(inbox, pcmr_reg->rx_ts_over_crc);
    mlxsw_reg_pcmr_cp_chk_set(inbox, pcmr_reg->cp_chk);
    mlxsw_reg_pcmr_fc_chk_set(inbox, pcmr_reg->fc_chk);
    mlxsw_reg_pcmr_len_chk_set(inbox, pcmr_reg->len_chk);
    mlxsw_reg_pcmr_type_chk_set(inbox, pcmr_reg->type_chk);
    mlxsw_reg_pcmr_mtu_chk_set(inbox, pcmr_reg->mtu_chk);
    mlxsw_reg_pcmr_sht_chk_set(inbox, pcmr_reg->sht_chk);
    mlxsw_reg_pcmr_fcs_chk_set(inbox, pcmr_reg->fcs_chk);
    mlxsw_reg_pcmr_pcs_chk_set(inbox, pcmr_reg->pcs_chk);


    return 0;
}

int __PCMR_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_pcmr_reg *pcmr_reg = (struct ku_pcmr_reg*)ku_reg;

    pcmr_reg->local_port = mlxsw_reg_pcmr_local_port_get(outbox);
    pcmr_reg->lp_msb = mlxsw_reg_pcmr_lp_msb_get(outbox);
    pcmr_reg->tx_ts_over_crc_cap = mlxsw_reg_pcmr_tx_ts_over_crc_cap_get(outbox);
    pcmr_reg->tx_fcs_recalc_cap = mlxsw_reg_pcmr_tx_fcs_recalc_cap_get(outbox);
    pcmr_reg->rx_fcs_drop_cap = mlxsw_reg_pcmr_rx_fcs_drop_cap_get(outbox);
    pcmr_reg->rx_ts_over_crc_cap = mlxsw_reg_pcmr_rx_ts_over_crc_cap_get(outbox);
    pcmr_reg->cp_cap = mlxsw_reg_pcmr_cp_cap_get(outbox);
    pcmr_reg->fc_cap = mlxsw_reg_pcmr_fc_cap_get(outbox);
    pcmr_reg->len_cap = mlxsw_reg_pcmr_len_cap_get(outbox);
    pcmr_reg->type_cap = mlxsw_reg_pcmr_type_cap_get(outbox);
    pcmr_reg->mtu_cap = mlxsw_reg_pcmr_mtu_cap_get(outbox);
    pcmr_reg->sht_cap = mlxsw_reg_pcmr_sht_cap_get(outbox);
    pcmr_reg->fcs_cap = mlxsw_reg_pcmr_fcs_cap_get(outbox);
    pcmr_reg->pcs_cap = mlxsw_reg_pcmr_pcs_cap_get(outbox);
    pcmr_reg->tx_ts_over_crc = mlxsw_reg_pcmr_tx_ts_over_crc_get(outbox);
    pcmr_reg->tx_fcs_recalc = mlxsw_reg_pcmr_tx_fcs_recalc_get(outbox);
    pcmr_reg->rx_fcs_drop = mlxsw_reg_pcmr_rx_fcs_drop_get(outbox);
    pcmr_reg->rx_ts_over_crc = mlxsw_reg_pcmr_rx_ts_over_crc_get(outbox);
    pcmr_reg->cp_chk = mlxsw_reg_pcmr_cp_chk_get(outbox);
    pcmr_reg->fc_chk = mlxsw_reg_pcmr_fc_chk_get(outbox);
    pcmr_reg->len_chk = mlxsw_reg_pcmr_len_chk_get(outbox);
    pcmr_reg->type_chk = mlxsw_reg_pcmr_type_chk_get(outbox);
    pcmr_reg->mtu_chk = mlxsw_reg_pcmr_mtu_chk_get(outbox);
    pcmr_reg->sht_chk = mlxsw_reg_pcmr_sht_chk_get(outbox);
    pcmr_reg->fcs_chk = mlxsw_reg_pcmr_fcs_chk_get(outbox);
    pcmr_reg->pcs_chk = mlxsw_reg_pcmr_pcs_chk_get(outbox);


    return 0;
}
EXPORT_SYMBOL(__PCMR_decode);

int sx_ACCESS_REG_PCMR(struct sx_dev *dev, struct ku_access_pcmr_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_PCMR_LEN >> 2) + 1;

    if (MLXSW_PCMR_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
int sx_EMAD_ACCESS_REG_PCMR(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_PCMR);
...
int __SBSRD_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    sbsrd_reg->first_entry_index = mlxsw_reg_sbsrd_first_entry_index_get(outbox);
...
int __CEER_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    case SXD_CEER_EXTRA_DATA_TYPE_TUNNEL_E:
        ...
        for (i = 0; i < SXD_CEER_CEER_EXTRA_FIELDS_INNER_SIP_NUM; i++) {
            ceer_reg->extra_data.ceer_extra_fields.inner_sip[i] = mlxsw_reg_ceer_inner_sip_get(outbox, 0, i);
        }
        for (i = 0; i < SXD_CEER_CEER_EXTRA_FIELDS_INNER_DIP_NUM; i++) {
...
int __FSED_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    for (i = 0; i < SXD_FSED_SF_DUMP_PAGE_NUM; i++) {
        ...
        case SXD_FSED_MODE_MODE_1_E:
            for (j = 0; j < SXD_FSED_SF_PAGE_DUMP_MODE_1_RECORD_NUM; j++) {
