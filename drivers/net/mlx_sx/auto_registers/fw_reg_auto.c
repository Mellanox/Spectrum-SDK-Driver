...
int __MINI_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    case SXD_MINI_TYPE_FUSED_OUT_PORTS_E:
        for (i = 0; i < SXD_MINI_FUSED_OUT_PORTS_BITMAP_NUM; i++) {
...
int __MCGI_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    mcgi_reg->cfiv = mlxsw_reg_mcgi_cfiv_get(outbox);
...
int __MSGCR_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    mlxsw_reg_msgcr_error_injection_en_set(inbox, msgcr_reg->error_injection_en);
...
int __MSGCR_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    msgcr_reg->error_injection_en = mlxsw_reg_msgcr_error_injection_en_get(outbox);
...
int __PTYS_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    mlxsw_reg_ptys_ext_ib_proto_admin_set(inbox, ptys_reg->ext_ib_proto_admin);
...
int __PTYS_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    ptys_reg->ext_ib_proto_cap = mlxsw_reg_ptys_ext_ib_proto_cap_get(outbox);
    ptys_reg->ext_ib_proto_admin = mlxsw_reg_ptys_ext_ib_proto_admin_get(outbox);
    ptys_reg->ext_ib_proto_oper = mlxsw_reg_ptys_ext_ib_proto_oper_get(outbox);
...
int __PDDR_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    case SXD_PDDR_PAGE_SELECT_PHY_DEBUG_PAGE_E:
        ...
        for (i = 0; i < SXD_PDDR_TRACER_DATA_ENTRY_NUM; i++) {
...
int __PEMI_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    case SXD_PEMI_PAGE_SELECT_TEMPERATURE_SAMPLES_E:
        ...
        pemi_reg->page_data.pemi_temperature_samples.lasers_temp = mlxsw_reg_pemi_lasers_temp_get(outbox);
