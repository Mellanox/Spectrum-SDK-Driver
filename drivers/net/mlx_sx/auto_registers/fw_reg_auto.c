...
int __MGIR_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    mgir_reg->hw_info.cfiv = mlxsw_reg_mgir_cfiv_get(outbox);
    mgir_reg->hw_info.chassis_module_id = mlxsw_reg_mgir_chassis_module_id_get(outbox);
    mgir_reg->hw_info.chassis_slot_index = mlxsw_reg_mgir_chassis_slot_index_get(outbox);
...
int __MSGCR_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    mlxsw_reg_msgcr_lport_1_valid_set(inbox, msgcr_reg->lport_1_valid);
    mlxsw_reg_msgcr_inter_asic_block_fmm_lport_1_set(inbox, msgcr_reg->inter_asic_block_fmm_lport_1);
    mlxsw_reg_msgcr_lport_0_valid_set(inbox, msgcr_reg->lport_0_valid);
    mlxsw_reg_msgcr_inter_asic_block_fmm_lport_0_set(inbox, msgcr_reg->inter_asic_block_fmm_lport_0);
...
int __MSGCR_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    msgcr_reg->lport_1_valid = mlxsw_reg_msgcr_lport_1_valid_get(outbox);
    msgcr_reg->inter_asic_block_fmm_lport_1 = mlxsw_reg_msgcr_inter_asic_block_fmm_lport_1_get(outbox);
    msgcr_reg->lport_0_valid = mlxsw_reg_msgcr_lport_0_valid_get(outbox);
    msgcr_reg->inter_asic_block_fmm_lport_0 = mlxsw_reg_msgcr_inter_asic_block_fmm_lport_0_get(outbox);
...
* MOFTD
***********************************************/
int __MOFTD_encode(u8 *inbox, void *ku_reg, void *context)
{
...
int __MOFTD_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    moftd_reg->entry = mlxsw_reg_moftd_entry_get(outbox);


    return 0;
}
EXPORT_SYMBOL(__MOFTD_decode);

int sx_ACCESS_REG_MOFTD(struct sx_dev *dev, struct ku_access_moftd_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_MOFTD_LEN >> 2) + 1;

    if (MLXSW_MOFTD_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
EXPORT_SYMBOL(sx_ACCESS_REG_MOFTD);

int sx_EMAD_ACCESS_REG_MOFTD(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_moftd_reg *reg)
{
    u16 reg_len_dword = (MLXSW_MOFTD_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_MOFTD);
