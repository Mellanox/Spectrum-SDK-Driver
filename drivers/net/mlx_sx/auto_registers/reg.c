 ...
 * Access: RO
 */
MLXSW_ITEM8(reg, mcc, component_specific_err_code, 0x1f, 0, 8);
 ...
 * Access: RO
 */
MLXSW_ITEM8(reg, mgir, cfiv, 0xc, 7, 1);

/* chassis_module_id
 * Access: RO
 */
MLXSW_ITEM8(reg, mgir, chassis_module_id, 0xd, 0, 8);

/* chassis_slot_index
 * Access: RO
 */
MLXSW_ITEM8(reg, mgir, chassis_slot_index, 0xf, 0, 8);
 ...
 * Access: RW
 */
MLXSW_ITEM8(reg, msgcr, lport_1_valid, 0x8, 7, 1);

/* inter_asic_block_fmm_lport_1
 * Access: RW
 */
MLXSW_ITEM16(reg, msgcr, inter_asic_block_fmm_lport_1, 0x8, 0, 10);

/* lport_0_valid
 * Access: RW
 */
MLXSW_ITEM8(reg, msgcr, lport_0_valid, 0xa, 7, 1);

/* inter_asic_block_fmm_lport_0
 * Access: RW
 */
MLXSW_ITEM16(reg, msgcr, inter_asic_block_fmm_lport_0, 0xa, 0, 10);
 ...
 * Access: RO
 */
MLXSW_ITEM32(reg, moftd, entry, 0x20, 0, 32);
 ...
 * Access: RO
 */
MLXSW_ITEM8(reg, ppcnt, phys_layer_stat_cntrs_fc_zero_hist, 0x69, 0, 4);
