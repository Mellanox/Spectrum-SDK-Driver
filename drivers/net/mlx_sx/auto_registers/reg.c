 ...
 * Access: RW
 */
MLXSW_ITEM8(reg, htec, ver_new, 0x27, 0, 4);
 ...
 * Access: RW
 */
MLXSW_ITEM8(reg, htec, ver_agg, 0x2b, 0, 4);
 ...
 * Access: RO
 */
MLXSW_ITEM8(reg, mcgi, cfiv, 0x0, 7, 1);
 ...
 * Access: RW
 */
MLXSW_ITEM8(reg, msgcr, error_injection_en, 0x2, 0, 1);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, moftc, port_bitmask, 0x80, 0, 32, 4, 0, 4, 0);

/* port_bitmask_actual
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, moftc, port_bitmask_actual, 0xc0, 0, 32, 4, 0, 4, 0);
 ...
 * Access: RO
 */
MLXSW_ITEM32(reg, ptys, ext_ib_proto_cap, 0x38, 0, 32);

/* ext_ib_proto_admin
 * Access: RW
 */
MLXSW_ITEM32(reg, ptys, ext_ib_proto_admin, 0x3c, 0, 32);

/* ext_ib_proto_oper
 * Access: RO
 */
MLXSW_ITEM32(reg, ptys, ext_ib_proto_oper, 0x40, 0, 32);
 ...
 * Access: RO
 */
MLXSW_ITEM16(reg, pemi, tx_bias_lane0, 0x2c, 0, 16);

/* tx_bias_lane1
 * Access: RO
 */
MLXSW_ITEM16(reg, pemi, tx_bias_lane1, 0x2e, 0, 16);

/* tx_bias_lane2
 * Access: RO
 */
MLXSW_ITEM16(reg, pemi, tx_bias_lane2, 0x30, 0, 16);

/* tx_bias_lane3
 * Access: RO
 */
MLXSW_ITEM16(reg, pemi, tx_bias_lane3, 0x32, 0, 16);

/* tx_bias_lane4
 * Access: RO
 */
MLXSW_ITEM16(reg, pemi, tx_bias_lane4, 0x34, 0, 16);

/* tx_bias_lane5
 * Access: RO
 */
MLXSW_ITEM16(reg, pemi, tx_bias_lane5, 0x36, 0, 16);

/* tx_bias_lane6
 * Access: RO
 */
MLXSW_ITEM16(reg, pemi, tx_bias_lane6, 0x38, 0, 16);

/* tx_bias_lane7
 * Access: RO
 */
MLXSW_ITEM16(reg, pemi, tx_bias_lane7, 0x3a, 0, 16);

/* module_st
 * Access: RO
 */
MLXSW_ITEM8(reg, pemi, module_st, 0x3c, 5, 3);

/* dp_st_lane0
 * Access: RO
 */
MLXSW_ITEM8(reg, pemi, dp_st_lane0, 0x3c, 1, 4);

/* dp_st_lane1
 * Access: RO
 */
MLXSW_ITEM16(reg, pemi, dp_st_lane1, 0x3c, 5, 4);

/* dp_st_lane2
 * Access: RO
 */
MLXSW_ITEM8(reg, pemi, dp_st_lane2, 0x3d, 1, 4);

/* dp_st_lane3
 * Access: RO
 */
MLXSW_ITEM32(reg, pemi, dp_st_lane3, 0x3c, 13, 4);

/* dp_st_lane4
 * Access: RO
 */
MLXSW_ITEM8(reg, pemi, dp_st_lane4, 0x3e, 1, 4);

/* dp_st_lane5
 * Access: RO
 */
MLXSW_ITEM16(reg, pemi, dp_st_lane5, 0x3e, 5, 4);

/* dp_st_lane6
 * Access: RO
 */
MLXSW_ITEM8(reg, pemi, dp_st_lane6, 0x3f, 1, 4);

/* dp_st_lane7
 * Access: RO
 */
MLXSW_ITEM8(reg, pemi, dp_st_lane7, 0x40, 4, 4);
 ...
 * Access: RO
 */
MLXSW_ITEM16(reg, pemi, lasers_temp, 0xc, 0, 16);
 ...
 * Access: RO
 */
MLXSW_ITEM16(reg, pemi, tx_bias_high_alarm, 0x24, 0, 16);

/* tx_bias_low_alarm
 * Access: RO
 */
MLXSW_ITEM16(reg, pemi, tx_bias_low_alarm, 0x26, 0, 16);

/* tx_bias_high_warning
 * Access: RO
 */
MLXSW_ITEM16(reg, pemi, tx_bias_high_warning, 0x28, 0, 16);

/* tx_bias_low_warning
 * Access: RO
 */
MLXSW_ITEM16(reg, pemi, tx_bias_low_warning, 0x2a, 0, 16);
 ...
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, rigr_v2, rigr_erif_list_v, MLXSW_RIGR_V2_ERIF_ENTRY_BASE_LEN, 7, 1, MLXSW_RIGR_V2_ERIF_ENTRY_REC_LEN, 0, 1, 0);

/* rigr_erif_list_erif
 * Access: RW
 */
MLXSW_ITEM16_INDEXED(reg, rigr_v2, rigr_erif_list_erif, MLXSW_RIGR_V2_ERIF_ENTRY_BASE_LEN + 2, 0, 16, MLXSW_RIGR_V2_ERIF_ENTRY_REC_LEN, 0, 2, 0);
