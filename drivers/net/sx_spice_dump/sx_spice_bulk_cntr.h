...
#define MAX_PERF_CNTR_GROUP_NUM         256
#define SPICE_BULK_CNTR_MOPCE_MIN_LBUFF 1000 /* 0 bytes*/
...
typedef struct spice_bulk_cntr_tr_ctx {
    ...
    bool                          is_skb_inproc;
    bool                          is_mocs_done;
    size_t                        perf_cntr_groups_max;
    size_t                        perf_cntr_groups_left;
    bool                          perf_cntr_group_id_to_set_map[MAX_PERF_CNTR_GROUP_NUM];
