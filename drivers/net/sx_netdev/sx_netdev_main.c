...
#if ((LINUX_VERSION_CODE >= KERNEL_VERSION(4, 19, 0)) && (LINUX_VERSION_CODE < KERNEL_VERSION(5, 17,  \
                                                                                              0))) || \
...
static int sx_netdev_port_split(struct devlink         *devlink,
                                ...
                                unsigned int            count,
                                struct netlink_ext_ack *extack)
#endif/* KERNEL_VERSION(5, 10, 0) <= LINUX_VERSION_CODE < KERNEL_VERSION(5, 18, 0) */
{
